window.__m8 = 'A';//'a615,'; //a863,a866,';      //'a1418,a1435,a860,a909,a916,a1218,a1382,a1088,a1255,a1330,a1236,a1255,a1406,a944,a917,a866,a863,a857,a738,a733,a630,a498,a493,a254,a615,';
window.__m6 = '';
window.__superDebugger = 1;
window.__monitorEvent = false;
//window.__printKey = false;
window.__begin = !0;
window.__evals = {all:'if(arguments.callee.toString().match(/[jJ][sS][bB]ridge/)){console.log(__currentKey)}'};
window.__E=true;
window.__Record = {};
  ...
  if ((isCorrectEvent() || window.__m8.indexOf('A') !== -1 || window.__m8.indexOf(matchs[1] + '*,') !== -1 || window.__m8.indexOf(k + ',') !== -1) && (window.__m6.indexOf(matchs[1] + '*,') === -1 && window.__m6.indexOf(k + ',') === -1)) {
    switch (window.__superDebugger) {
      ...
      case 7:
        ...
        __socket.go({platform:'mobile'}, 'YY.sendSubsectionToPc(`'+ C__A__L.toString() +'`);');
        break;
    }
  }
  return !1;
...
/*! TenVideoPlayer_V2 - v2.0.0 - 2017-01-23 11:35:54
 * Copyright (c) 2017
...
//a229<
          if (__begin&&__YY__.S("a229", arguments)) {if(__E){eval(__YY__.gE("a229"));}else{debugger;}}
...
//a267<
    ...
    }(b), tvp = {}, tvp.lastModify = "2017-01-23 11:35:54", tvp.ts = tvp.lastModify.replace(/\D/g, ""), tvp.ver = "$V2.0Build9239$", tvp.dataset = {openLazy: !0}, tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668", "undefined" == typeof window.DEBUG && (window.DEBUG = 1), window.FILEPATH = "//192.168.1.199/tencentvideo_v1/tvp/js/", "http:" === location.protocol ? window.FILEPATH = "http:" + window.FILEPATH : window.FILEPATH = "https:" + window.FILEPATH, top != window)try {
...
//a366<
      ...
      return d = h % e, void 0 == b && (b = 0), c = 0 == b ? ["http://192.168.1.199/", d, "/", a, "_160_90_3.jpg"].join("") : ["http://192.168.1.199/", d, "/", a, "_", "160_90_", b, "_1.jpg"].join("")
...
//a378<
      ...
      return "//192.168.1.199/tencentvideo_v1/vstyle/mobile/v2/style/"
    }, get_js_path: function () {
//a379<
      if (__begin&&__YY__.S("a379", arguments)) {if(__E){eval(__YY__.gE("a379"));}else{debugger;}}
      return "//192.168.1.199/tencentvideo_v1/tvp/"
    }, get_request_url: function (a) {
//a380<
      if (__begin&&__YY__.S("a380", arguments)) {if(__E){eval(__YY__.gE("a380"));}else{debugger;}}
      var b = {
        getinfo: ["http://192.168.1.199/getinfo", "https://192.168.1.199/getinfo"],
        edugetvinfo: ["http://192.168.1.199/edugetvinfo", "https://192.168.1.199/p/sv.video/edugetvinfo"],
        mvgetinfo: ["http://192.168.1.199/mvgetinfo", "https://192.168.1.199/p/sv.video/mvgetinfo"],
        getinfoInews: ["http://192.168.1.199/getinfo?callback=?&", "https://192.168.1.199/p/h5wx.video/getinfo?callback=?&"],
        getvinfo: ["http://192.168.1.199/getvinfo", "https://192.168.1.199/getvinfo"],
        getkey: ["http://192.168.1.199/getkey", "https://192.168.1.199/getkey"],
        mvgetkey: ["http://192.168.1.199/mvgetkey", "https://192.168.1.199/p/sv.video/mvgetkey"],
        getkeyInews: ["http://192.168.1.199/getkey?callback=?&", "https://192.168.1.199/p/h5wx.video/getkey?callback=?&"],
        limit_conf: ["http://192.168.1.199/iframe/limit_conf.js", "https://192.168.1.199/iframe/limit_conf.js"],
        zb: ["http://192.168.1.199", "https://192.168.1.199/p/info.zb/video/"],
        swf_root: ["http://192.168.1.199/tencentvideo_v1/player/", "https://192.168.1.199/tencentvideo_v1/player/"],
        rmd_mobile: ["http://192.168.1.199/fcgi-bin/rmd_mobile", "https://192.168.1.199/fcgi-bin/rmd_mobile"],
        like: ["http://192.168.1.199/fcgi-bin/like", "https://192.168.1.199/fcgi-bin/like"],
        dataout_ex: ["http://192.168.1.199/fcgi-bin/dlib/dataout_ex", "https://192.168.1.199/p/sns.video/fcgi-bin/dlib/dataout_ex"],
        get_dtype: ["http://192.168.1.199/getdtype", "https://192.168.1.199/getdtype"]
      };
...
//a382<
      ...
      var a = "192.168.1.199" === location.host, b = tvp.$;
...
//a384<
      ...
      return !tvp.$.browser.MQQClient || "192.168.1.199" !== window.location.hostname && "192.168.1.199" !== window.location.hostname ? !1 : !0
...
//a391<
      ...
      if (!f) {
        ...
        k && -1 === c.inArray(k, ["192.168.1.199", "192.168.1.199", "192.168.1.199"]) && (f = k.replace(/\./g, "_"))
      }
...
//a399<
    ...
    return "192.168.1.199" == document.location.host && (h = !0), {
      getOcx: function (b) {
//a400<
        ...
        if (tvp.$.browser.ie)try {
          ...
          h && !g && (g = !0) && (f.src = "http://192.168.1.199/collect?sIp=&iQQ=" + tvp.common.getUin() + "&sBiz=IE&sOp=" + encodeURIComponent(navigator.userAgent) + "&iSta=0&iTy=2432&iFlow=&sUrl=" + encodeURIComponent(location.toString()) + "&sRef=" + encodeURIComponent(document.referrer) + "&sMsg=" + encodeURIComponent(i.message) + "&sStep=" + encodeURIComponent(e) + "&_=" + Math.random())
        ...
        return parseInt(d, 10) || h && !g && (g = !0) && (f.src = "http://192.168.1.199/collect?sIp=&iQQ=" + tvp.common.getUin() + "&sBiz=" + (tvp.$.browser.ie ? "IE" : "NOIE") + "&sOp=" + encodeURIComponent(navigator.userAgent) + "&iSta=0&iTy=2432&iFlow=&sUrl=" + encodeURIComponent(location.toString()) + "&sRef=" + encodeURIComponent(document.referrer) + "&sMsg=" + d + "&sStep=" + encodeURIComponent(e) + "&_=" + Math.random()), d = a(d)
      }, getFlash: function () {
//a401<
        ...
        if (tvp.$.browser.ie)try {
          ...
          h && !g && (g = !0) && (f.src = "http://192.168.1.199/collect?sIp=&iQQ=" + tvp.common.getUin() + "&sBiz=IE&sOp=" + encodeURIComponent(navigator.userAgent) + "&iSta=1&iTy=2432&iFlow=&sUrl=" + encodeURIComponent(location.toString()) + "&sRef=" + encodeURIComponent(document.referrer) + "&sMsg=" + encodeURIComponent(l.message) + "&sStep=" + encodeURIComponent(a) + "&_=" + Math.random())
        } else tvp.$.isUndefined(j.plugins) || "object" != typeof j.plugins[i] || (a = "no IE begin", c = j.plugins[i].description, a = "plugins[S].description", c && (tvp.$.isUndefined(j.mimeTypes) || !j.mimeTypes[k] || j.mimeTypes[k].enabledPlugin) ? (a = "parse description", c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), d[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), d[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), d[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0) : a = "no mimeTypes or disable");
        return e = d.join("."), parseInt(e, 10) || h && !g && (g = !0) && (f.src = "http://192.168.1.199/collect?sIp=&iQQ=" + tvp.common.getUin() + "&sBiz=" + (tvp.$.browser.ie ? "IE" : "NOIE") + "&sOp=" + encodeURIComponent(navigator.userAgent) + "&iSta=1&iTy=2432&iFlow=&sUrl=" + encodeURIComponent(location.toString()) + "&sRef=" + encodeURIComponent(document.referrer) + "&sMsg=" + e + "&sStep=" + encodeURIComponent(a) + "&_=" + Math.random()), e
...
//a403<
    ...
    var c = {
      qqlive: {
        text1: "\u817e\u8baf\u89c6\u9891\u5ba2\u6237\u7aef",
        text2: "\u53ef\u89c2\u770b\u66f4\u591a\u89c6\u9891",
        md5Cgi: "http://192.168.1.199/commdatav2?cmd=39&otype=json&confid=${id}",
        md5Cgi_https: "https://192.168.1.199/p/mcgi.v/commdatav2?cmd=39&otype=json&confid=${id}",
        payUrl: "http://192.168.1.199/weixin/detail/${index}/${cid}.html",
        scheme: "tenvideo2://",
        logoClass: "",
        ...
        aphoneDownloadUrl: "http://192.168.1.199/commdatav2?cmd=4&confid=140&platform=aphone",
    ...
    a.app = {
      config: {
        ...
        mqqApiUrl: "//192.168.1.199/browser_lightapp/QQBrowserApi/getCryptext/browser_interface_getCryptext.js"
...
//a434<
            ...
            a && a.key && a.ver && a.platform ? g.resolve({key: a.key, ver: a.ver, platform: a.platform}) : g.resolve(0)
          }, function () {
//a435<
...
//a468<
            if (__begin&&__YY__.S("a468", arguments)) {if(__E){eval(__YY__.gE("a468"));}else{debugger;}}
            g.resolve(e.buildResult(a, d, b))
          }); else try {
            h.addEventListener("WeixinJSBridgeReady", function () {
//a469<
              if (__begin&&__YY__.S("a469", arguments)) {if(__E){eval(__YY__.gE("a469"));}else{debugger;}}
              e.invokeWeChatAPI(d).then(function (a, b) {
//a470<
                if (__begin&&__YY__.S("a470", arguments)) {if(__E){eval(__YY__.gE("a470"));}else{debugger;}}
                g.resolve(e.buildResult(a, d, b))
              })
            })
          } catch (i) {
...
//a471<
            if (__begin&&__YY__.S("a471", arguments)) {if(__E){eval(__YY__.gE("a471"));}else{debugger;}}
            g.resolve(e.buildResult(a, d, b))
          })
        } catch (i) {
          g.resolve(e.buildResult(0, d))
...
//a472<
            if (__begin&&__YY__.S("a472", arguments)) {if(__E){eval(__YY__.gE("a472"));}else{debugger;}}
            g.resolve(e.buildResult(a, d, b))
          })
        } catch (i) {
          g.resolve(e.buildResult(0, d))
...
//a473<
        if (__begin&&__YY__.S("a473", arguments)) {if(__E){eval(__YY__.gE("a473"));}else{debugger;}}
        this.loadDownloaderAPI().done(function () {
//a474<
          if (__begin&&__YY__.S("a474", arguments)) {if(__E){eval(__YY__.gE("a474"));}else{debugger;}}
          new a.AppDownloader(b)
        })
      }, loadDownloaderAPI: function () {
//a475<
        if (__begin&&__YY__.S("a475", arguments)) {if(__E){eval(__YY__.gE("a475"));}else{debugger;}}
...
//a476<
          if (__begin&&__YY__.S("a476", arguments)) {if(__E){eval(__YY__.gE("a476"));}else{debugger;}}
          c.resolve()
        }), setTimeout(function () {
//a477<
          if (__begin&&__YY__.S("a477", arguments)) {if(__E){eval(__YY__.gE("a477"));}else{debugger;}}
          c.reject()
        }, 3e3)), c
      }, checkCanDownloader: function (a, c, d) {
//a478<
        if (__begin&&__YY__.S("a478", arguments)) {if(__E){eval(__YY__.gE("a478"));}else{debugger;}}
        function e() {
//a479<
          if (__begin&&__YY__.S("a479", arguments)) {if(__E){eval(__YY__.gE("a479"));}else{debugger;}}
...
//a480<
          if (__begin&&__YY__.S("a480", arguments)) {if(__E){eval(__YY__.gE("a480"));}else{debugger;}}
          1 == b && (g = !0), 2 == b && (h = !0)
        }), c.downloaderCallback || (g = !0, h = !0), b.browser.WeChat && g || b.browser.MQQClient && h ? this.loadDownloaderAPI().done(function () {
//a481<
          if (__begin&&__YY__.S("a481", arguments)) {if(__E){eval(__YY__.gE("a481"));}else{debugger;}}
          e()
        }).fail(function () {
//a482<
          if (__begin&&__YY__.S("a482", arguments)) {if(__E){eval(__YY__.gE("a482"));}else{debugger;}}
          f.resolve(0)
        }) : f.resolve(0), f)
      }, buildResult: function (c, d, e) {
//a483<
        if (__begin&&__YY__.S("a483", arguments)) {if(__E){eval(__YY__.gE("a483"));}else{debugger;}}
    ...
    html5FeatureExtJS: {adonend: "//192.168.1.199/tencentvideo_v1/tvp/js/plugins/adonend.js?max_age=86400"},
...
//a484<
    if (__begin&&__YY__.S("a484", arguments)) {if(__E){eval(__YY__.gE("a484"));}else{debugger;}}
    tvp = tvp || {}, tvp.fastclick = function (b) {
//a485<
      if (__begin&&__YY__.S("a485", arguments)) {if(__E){eval(__YY__.gE("a485"));}else{debugger;}}
      var c = a(b), d = {}, e = a.os.hasTouch;
      e && (c.attr("data-fastclick", 1), c.on("touchstart", function (a) {
//a486<
        if (__begin&&__YY__.S("a486", arguments)) {if(__E){eval(__YY__.gE("a486"));}else{debugger;}}
        a = e ? a.touches[0] : a, d.start = +new Date, d.tar = a.target, d.x1 = a.pageX, d.y1 = a.pageY
      }).on("touchend", function (b) {
//a487<
        if (__begin&&__YY__.S("a487", arguments)) {if(__E){eval(__YY__.gE("a487"));}else{debugger;}}
...
//a488<
    if (__begin&&__YY__.S("a488", arguments)) {if(__E){eval(__YY__.gE("a488"));}else{debugger;}}
    var b = function (a, c) {
//a489<
      if (__begin&&__YY__.S("a489", arguments)) {if(__E){eval(__YY__.gE("a489"));}else{debugger;}}
      return function (d, e) {
//a490<
        if (__begin&&__YY__.S("a490", arguments)) {if(__E){eval(__YY__.gE("a490"));}else{debugger;}}
        var f = /\s/.test(d) ? function (a) {
//a491<
          if (__begin&&__YY__.S("a491", arguments)) {if(__E){eval(__YY__.gE("a491"));}else{debugger;}}
          var b, d = [c], e = [[]];
...
//a492<
    if (__begin&&__YY__.S("a492", arguments)) {if(__E){eval(__YY__.gE("a492"));}else{debugger;}}
    "undefined" == typeof a.getScript && (a.getScript = function (a, b) {
//a493<
      if (__begin&&__YY__.S("a493", arguments)) {if(__E){eval(__YY__.gE("a493"));}else{debugger;}}
...
//a494<
        if (__begin&&__YY__.S("a494", arguments)) {if(__E){eval(__YY__.gE("a494"));}else{debugger;}}
...
//a495<
    if (__begin&&__YY__.S("a495", arguments)) {if(__E){eval(__YY__.gE("a495"));}else{debugger;}}
    function a() {
//a496<
      if (__begin&&__YY__.S("a496", arguments)) {if(__E){eval(__YY__.gE("a496"));}else{debugger;}}
      return 0 == h.length ? (f = !0, void(g = null)) : (clearTimeout(e), c(h.splice(0, 1)), void(f = !1))
    }

    function b(a) {
//a497<
      if (__begin&&__YY__.S("a497", arguments)) {if(__E){eval(__YY__.gE("a497"));}else{debugger;}}
      return tvp.dataset.openLazy ? a && a.toLowerCase && a.toLowerCase().indexOf("bossid=2865") > -1 ? !1 : !0 : (i && i.length && (h = i.concat(h), i = []), !1)
    }

    function c(c) {
//a498<
      if (__begin&&__YY__.S("a498", arguments)) {if(__E){eval(__YY__.gE("a498"));}else{debugger;}}
    ...
    function d(a) {
//a499<
      if (__begin&&__YY__.S("a499", arguments)) {if(__E){eval(__YY__.gE("a499"));}else{debugger;}}
...
//a500<
      if (__begin&&__YY__.S("a500", arguments)) {if(__E){eval(__YY__.gE("a500"));}else{debugger;}}
      ...
      if ("object" == tvp.$.type(a)) {
        var b, c = {
          ...
          str1: "",
          str2: tvp.filename
        }, f = "http://192.168.1.199/web_report?";
...
//a501<
    if (__begin&&__YY__.S("a501", arguments)) {if(__E){eval(__YY__.gE("a501"));}else{debugger;}}
    function b(a, b) {
//a502<
      if (__begin&&__YY__.S("a502", arguments)) {if(__E){eval(__YY__.gE("a502"));}else{debugger;}}
      a = a || {}, b = String(b);
      var c, d = /([\d\w_]+)/g;
    ...
    function c(a) {
//a503<
      if (__begin&&__YY__.S("a503", arguments)) {if(__E){eval(__YY__.gE("a503"));}else{debugger;}}
      return a = a.slice(0, a.indexOf("?")), a = a.split("/"), {host: a[2], path: "/" + a.slice(3).join("/")}
    }

    function d(a, b, d, e) {
//a504<
      if (__begin&&__YY__.S("a504", arguments)) {if(__E){eval(__YY__.gE("a504"));}else{debugger;}}
      var f = "http://192.168.1.199/code.cgi", g = c(a);
      tvp.report(f, {domain: g.host, cgi: g.path, type: b, code: d, time: e})
    }

    function e(c, e) {
//a505<
      if (__begin&&__YY__.S("a505", arguments)) {if(__E){eval(__YY__.gE("a505"));}else{debugger;}}
...
//a506<
          if (__begin&&__YY__.S("a506", arguments)) {if(__E){eval(__YY__.gE("a506"));}else{debugger;}}
...
//a507<
          if (__begin&&__YY__.S("a507", arguments)) {if(__E){eval(__YY__.gE("a507"));}else{debugger;}}
...
//a508<
    if (__begin&&__YY__.S("a508", arguments)) {if(__E){eval(__YY__.gE("a508"));}else{debugger;}}
    b = b || "tvperror";
    var c = "http://192.168.1.199/report/jsbossrep?block=" + b + "&ret=-1&level=4&msg=";
...
//a509<
      if (__begin&&__YY__.S("a509", arguments)) {if(__E){eval(__YY__.gE("a509"));}else{debugger;}}
      var e, f, g, h, i, j;
      ...
      var m = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=2745&Pwd=0&_dc=") + Math.random();
      m += "&" + tvp.$.param(e), tvp.report(m)
    }, window_error: function (a) {
//a510<
      if (__begin&&__YY__.S("a510", arguments)) {if(__E){eval(__YY__.gE("a510"));}else{debugger;}}
      return
    }, play_report: function (a) {
//a511<
      if (__begin&&__YY__.S("a511", arguments)) {if(__E){eval(__YY__.gE("a511"));}else{debugger;}}
      if (a && !tvp.$.isEmptyObject(a)) {
        ...
        var d = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=2865&Pwd=1698957057&_dc=") + Math.random();
        d += "&" + a.join("&"), tvp.report(d)
      }
    }, user_action_report: function (a) {
//a512<
      if (__begin&&__YY__.S("a512", arguments)) {if(__E){eval(__YY__.gE("a512"));}else{debugger;}}
      var b = "";
      try {
        b = top.location.href
      } catch (c) {
      ...
      var d = {
        ...
        vid: a.vid
      }, e = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=2797&Pwd=219856622&_dc=") + Math.random();
      e += "&" + tvp.$.param(d), tvp.report(e)
    }, apprecommend_report: function (a) {
//a513<
      if (__begin&&__YY__.S("a513", arguments)) {if(__E){eval(__YY__.gE("a513"));}else{debugger;}}
      ...
      var h = {
        ...
        ptype: 21,
        rtype: 1
      }, i = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=2745&Pwd=0&_dc=") + Math.random();
      i += "&" + tvp.$.param(h), tvp.report(i)
    }, report_bullet_switch: function (a) {
//a514<
      if (__begin&&__YY__.S("a514", arguments)) {if(__E){eval(__YY__.gE("a514"));}else{debugger;}}
      a = a || {};
      var b = tvp.$;
      if (a.platform = b.os.android ? 1 : b.os.iphone ? 2 : b.os.ipad ? 3 : 4, a.url = window.location.href, "undefined" !== b.type(a.user_action)) {
        var c = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=3084&Pwd=1539562724&_dc=") + Math.random();
        c += "&" + b.param(a), tvp.report(c)
      }
    }, h5_live_quality: function (a) {
//a515<
      if (__begin&&__YY__.S("a515", arguments)) {if(__E){eval(__YY__.gE("a515"));}else{debugger;}}
      var b = {
        step: a.step,
        sid: a.sid,
        vurl: a.vurl || "",
      ...
      }, c = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=3101&Pwd=1037836152&_dc=") + Math.random();
      c += "&" + tvp.$.param(b), tvp.report(c)
    }, appReportShowClick: function (a, b) {
//a516<
      if (__begin&&__YY__.S("a516", arguments)) {if(__E){eval(__YY__.gE("a516"));}else{debugger;}}
      var c = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=3267&Pwd=1887953802&"), d = {
        cmd: -1,
        url: window != top ? document.referrer : document.location.href,
        ver: tvp.ver.replace(/\$/g, ""),
        ua: tvp.common.getReportUA && tvp.common.getReportUA(),
...
//a517<
      if (__begin&&__YY__.S("a517", arguments)) {if(__E){eval(__YY__.gE("a517"));}else{debugger;}}
      var b = "";
      try {
      ...
      var e = tvp.common.getCompleteUrlByProtocol("//192.168.1.199/kvcollect?BossId=4046&Pwd=176231195&_dc=") + Math.random();
      e += "&" + tvp.$.param(d), tvp.app.report(e)
    }
  }, function () {
//a518<
    if (__begin&&__YY__.S("a518", arguments)) {if(__E){eval(__YY__.gE("a518"));}else{debugger;}}
    tvp.common && tvp.common.afterWeChatReady && tvp.$.browser.WeChat && tvp.common.afterWeChatReady({timeout: 5e3}).done(function () {
//a519<
      if (__begin&&__YY__.S("a519", arguments)) {if(__E){eval(__YY__.gE("a519"));}else{debugger;}}
      tvp.dataset.openLazy = !1, tvp.$(document).trigger("tvp:report:continue")
    })
  }(), tvp.retCode = {
    snid: 0,
    TYPE: {SUC: 1, ERR: 2},
    config: {cgi: "http://192.168.1.199/cgi-bin/v.cgi", sampling: 1},
    commCode: {error: 11, MQzone_Err: 12},
    report: function (a, b, c, d) {
//a520<
      if (__begin&&__YY__.S("a520", arguments)) {if(__E){eval(__YY__.gE("a520"));}else{debugger;}}
...
//a521<
    if (__begin&&__YY__.S("a521", arguments)) {if(__E){eval(__YY__.gE("a521"));}else{debugger;}}
    ...
    begin: function () {
//a522<
      if (__begin&&__YY__.S("a522", arguments)) {if(__E){eval(__YY__.gE("a522"));}else{debugger;}}
      this.timer.begin = (new Date).valueOf()
    }, end: function () {
//a523<
      if (__begin&&__YY__.S("a523", arguments)) {if(__E){eval(__YY__.gE("a523"));}else{debugger;}}
      this.timer.end = this.timer.end || (new Date).valueOf()
    }, report: function (a, b) {
//a524<
      if (__begin&&__YY__.S("a524", arguments)) {if(__E){eval(__YY__.gE("a524"));}else{debugger;}}
      if (!this.isReported) {
        this.end();
...
//a525<
      if (__begin&&__YY__.S("a525", arguments)) {if(__E){eval(__YY__.gE("a525"));}else{debugger;}}
      this.report(tvp.retCode.TYPE.SUC)
    }, reportErr: function (a) {
//a526<
      if (__begin&&__YY__.S("a526", arguments)) {if(__E){eval(__YY__.gE("a526"));}else{debugger;}}
      a = a || tvp.retCode.commCode.error, this.report(tvp.retCode.TYPE.ERR, a)
    }
  }, function (a, b) {
//a527<
    if (__begin&&__YY__.S("a527", arguments)) {if(__E){eval(__YY__.gE("a527"));}else{debugger;}}
    var c = {
      poster: "",
      prefix: 0,
      tail: 0,
...
//a528<
      if (__begin&&__YY__.S("a528", arguments)) {if(__E){eval(__YY__.gE("a528"));}else{debugger;}}
      function d(a) {
//a529<
        if (__begin&&__YY__.S("a529", arguments)) {if(__E){eval(__YY__.gE("a529"));}else{debugger;}}
        return a.indexOf("_") < 0 ? a : a.split("_")[0]
      }

      function e(a) {
//a530<
        if (__begin&&__YY__.S("a530", arguments)) {if(__E){eval(__YY__.gE("a530"));}else{debugger;}}
        return a.indexOf("_") < 0 ? 0 : parseInt(a.split("_")[1])
      }

      function f(a) {
//a531<
        if (__begin&&__YY__.S("a531", arguments)) {if(__E){eval(__YY__.gE("a531"));}else{debugger;}}
      ...
      function g() {
//a532<
        if (__begin&&__YY__.S("a532", arguments)) {if(__E){eval(__YY__.gE("a532"));}else{debugger;}}
        p && p instanceof a.Player && p.on(a.ACTION.onVodH5Init, function () {
//a533<
          if (__begin&&__YY__.S("a533", arguments)) {if(__E){eval(__YY__.gE("a533"));}else{debugger;}}
          var b;
...
//a534<
        if (__begin&&__YY__.S("a534", arguments)) {if(__E){eval(__YY__.gE("a534"));}else{debugger;}}
        var b = a.charAt(0).toUpperCase() + a.substr(1);
        n["set" + b] = function (b) {
//a535<
          if (__begin&&__YY__.S("a535", arguments)) {if(__E){eval(__YY__.gE("a535"));}else{debugger;}}
          return o[a] = b, this
        }, n["get" + b] = function () {
//a536<
          if (__begin&&__YY__.S("a536", arguments)) {if(__E){eval(__YY__.gE("a536"));}else{debugger;}}
          return o[a]
        }
      }), this.setCurPlayer = function (a) {
//a537<
        if (__begin&&__YY__.S("a537", arguments)) {if(__E){eval(__YY__.gE("a537"));}else{debugger;}}
        p = a, g()
      }, this.setVid = function (c) {
//a538<
        if (__begin&&__YY__.S("a538", arguments)) {if(__E){eval(__YY__.gE("a538"));}else{debugger;}}
        if (a.$.isString(c)) {
...
//a539<
        if (__begin&&__YY__.S("a539", arguments)) {if(__E){eval(__YY__.gE("a539"));}else{debugger;}}
        return h
      }, this.getVidList = function () {
//a540<
        if (__begin&&__YY__.S("a540", arguments)) {if(__E){eval(__YY__.gE("a540"));}else{debugger;}}
        return i
      }, this.getVidArray = function () {
//a541<
        if (__begin&&__YY__.S("a541", arguments)) {if(__E){eval(__YY__.gE("a541"));}else{debugger;}}
        return i.split("|")
      }, this.getIdx = function () {
//a542<
        if (__begin&&__YY__.S("a542", arguments)) {if(__E){eval(__YY__.gE("a542"));}else{debugger;}}
        return k
      }, this.getDuration = function () {
//a543<
        if (__begin&&__YY__.S("a543", arguments)) {if(__E){eval(__YY__.gE("a543"));}else{debugger;}}
...
//a544<
        if (__begin&&__YY__.S("a544", arguments)) {if(__E){eval(__YY__.gE("a544"));}else{debugger;}}
...
//a545<
        if (__begin&&__YY__.S("a545", arguments)) {if(__E){eval(__YY__.gE("a545"));}else{debugger;}}
        return this.getDuration()
      }, this.getEndOffset = function () {
//a546<
        if (__begin&&__YY__.S("a546", arguments)) {if(__E){eval(__YY__.gE("a546"));}else{debugger;}}
        return this.getDuration() - this.getTail()
      }, this.setChannelId = function (b) {
//a547<
        if (__begin&&__YY__.S("a547", arguments)) {if(__E){eval(__YY__.gE("a547"));}else{debugger;}}
        return a.$.isString(b) ? (m = b, this) : void 0
      }, this.getChannelId = function () {
//a548<
        if (__begin&&__YY__.S("a548", arguments)) {if(__E){eval(__YY__.gE("a548"));}else{debugger;}}
        return m
      }, this.getFullVid = function () {
//a549<
        if (__begin&&__YY__.S("a549", arguments)) {if(__E){eval(__YY__.gE("a549"));}else{debugger;}}
        return 0 == this.getIdx() ? d(this.getVid()) : d(this.getVid()) + "_" + this.getIdx()
      }, this.getTitle = function () {
//a550<
        if (__begin&&__YY__.S("a550", arguments)) {if(__E){eval(__YY__.gE("a550"));}else{debugger;}}
...
//a551<
        if (__begin&&__YY__.S("a551", arguments)) {if(__E){eval(__YY__.gE("a551"));}else{debugger;}}
        h = "", i = "", j = 0, k = 0, m = "", r = null, q = {}, b.extend(o, c), this.data = {}, this.url = ""
      }, this.clone = function (a) {
//a552<
        if (__begin&&__YY__.S("a552", arguments)) {if(__E){eval(__YY__.gE("a552"));}else{debugger;}}
...
//a553<
        if (__begin&&__YY__.S("a553", arguments)) {if(__E){eval(__YY__.gE("a553"));}else{debugger;}}
        var b = [];
...
//a554<
        if (__begin&&__YY__.S("a554", arguments)) {if(__E){eval(__YY__.gE("a554"));}else{debugger;}}
...
//a555<
          if (__begin&&__YY__.S("a555", arguments)) {if(__E){eval(__YY__.gE("a555"));}else{debugger;}}
          window.txvLogin && txvLogin.isLogin && txvLogin.isLogin(function (a) {
//a556<
            if (__begin&&__YY__.S("a556", arguments)) {if(__E){eval(__YY__.gE("a556"));}else{debugger;}}
            c && 8 === c.st ? k.tpay = 0 : k.tpay = 2, a || (k.tpay = -2)
          });
          var f = k.getFreeFlowHelper(), g = !1, h = function (a) {
//a557<
            if (__begin&&__YY__.S("a557", arguments)) {if(__E){eval(__YY__.gE("a557"));}else{debugger;}}
...
//a558<
            if (__begin&&__YY__.S("a558", arguments)) {if(__E){eval(__YY__.gE("a558"));}else{debugger;}}
            g = !0, h(a)
          }), setTimeout(function () {
//a559<
            if (__begin&&__YY__.S("a559", arguments)) {if(__E){eval(__YY__.gE("a559"));}else{debugger;}}
            g || h(a)
          }, 5e3)) : h(a)
        }).fail(function (a, c) {
//a560<
          if (__begin&&__YY__.S("a560", arguments)) {if(__E){eval(__YY__.gE("a560"));}else{debugger;}}
          q[j] && q[j].reject(a, b.isUndefined(c) ? 0 : c)
        }), i ? i : q[j]
      }, this.switchDefinition = function (c) {
//a561<
        if (__begin&&__YY__.S("a561", arguments)) {if(__E){eval(__YY__.gE("a561"));}else{debugger;}}
...
//a562<
          if (__begin&&__YY__.S("a562", arguments)) {if(__E){eval(__YY__.gE("a562"));}else{debugger;}}
          var h = e.getFreeFlowHelper(), i = !1, j = function (a) {
//a563<
            if (__begin&&__YY__.S("a563", arguments)) {if(__E){eval(__YY__.gE("a563"));}else{debugger;}}
...
//a564<
            if (__begin&&__YY__.S("a564", arguments)) {if(__E){eval(__YY__.gE("a564"));}else{debugger;}}
            i = !0, j(a)
          }), setTimeout(function () {
//a565<
            if (__begin&&__YY__.S("a565", arguments)) {if(__E){eval(__YY__.gE("a565"));}else{debugger;}}
            i || j(a)
          }, 5e3)) : j(a)
        }).fail(function (a, c) {
//a566<
          if (__begin&&__YY__.S("a566", arguments)) {if(__E){eval(__YY__.gE("a566"));}else{debugger;}}
          d.reject(a, b.isUndefined(c) ? 0 : c)
        }), d
      }, this.getHLS = function (c) {
//a567<
        if (__begin&&__YY__.S("a567", arguments)) {if(__E){eval(__YY__.gE("a567"));}else{debugger;}}
...
//a568<
          if (__begin&&__YY__.S("a568", arguments)) {if(__E){eval(__YY__.gE("a568"));}else{debugger;}}
          i.url = a, i.data = b, i.data.playtype = "hls", q[h] && q[h].resolve(a)
        }).fail(function (a, c) {
//a569<
          if (__begin&&__YY__.S("a569", arguments)) {if(__E){eval(__YY__.gE("a569"));}else{debugger;}}
          q[h] && q[h].reject(a, b.isUndefined(c) ? 0 : c)
        }), q[h]
      }, this.getPlayFormat = function () {
//a570<
        if (__begin&&__YY__.S("a570", arguments)) {if(__E){eval(__YY__.gE("a570"));}else{debugger;}}
...
//a571<
        if (__begin&&__YY__.S("a571", arguments)) {if(__E){eval(__YY__.gE("a571"));}else{debugger;}}
        return "object" == b.type(this.data.sfl) && b.isArray(this.data.sfl.fi) ? (b.each(this.data.sfl.fi, function (b, c) {
//a572<
          if (__begin&&__YY__.S("a572", arguments)) {if(__E){eval(__YY__.gE("a572"));}else{debugger;}}
          c.desc = a.html5lang.getSrtName(c.id)
        }), this.data.sfl.fi) : []
      }, this.getSrtUrlList = function (c) {
//a573<
        if (__begin&&__YY__.S("a573", arguments)) {if(__E){eval(__YY__.gE("a573"));}else{debugger;}}
        if (b.isUndefined(c)) {
...
//a574<
          if (__begin&&__YY__.S("a574", arguments)) {if(__E){eval(__YY__.gE("a574"));}else{debugger;}}
          var d = [];
          "object" == b.type(a.ul) && b.isArray(a.ul.ui) && b.each(a.ul.ui, function (a, b) {
//a575<
            if (__begin&&__YY__.S("a575", arguments)) {if(__E){eval(__YY__.gE("a575"));}else{debugger;}}
            d.push([b.url, "lang=" + c.name].join("?"))
          }), q[h].resolve(d)
        }).fail(function (a) {
//a576<
          if (__begin&&__YY__.S("a576", arguments)) {if(__E){eval(__YY__.gE("a576"));}else{debugger;}}
          q[h].reject(a)
        }), q[h]
      }, this.getFormatList = function () {
//a577<
        if (__begin&&__YY__.S("a577", arguments)) {if(__E){eval(__YY__.gE("a577"));}else{debugger;}}
        if ("object" == b.type(r) && b.isFunction(r.done))return r;
        r = b.Deferred();
        var a = this, c = ["sd", "hd", "shd", "fhd"], d = function () {
//a578<
          if (__begin&&__YY__.S("a578", arguments)) {if(__E){eval(__YY__.gE("a578"));}else{debugger;}}
          var d = [];
          return b.isPlainObject(a.data.fl) && b.isArray(a.data.fl.fi) ? (b.each(a.data.fl.fi, function (a, e) {
//a579<
            if (__begin&&__YY__.S("a579", arguments)) {if(__E){eval(__YY__.gE("a579"));}else{debugger;}}
            -1 != b.inArray(e.name, c) && d.push(e.name)
          }), d) : []
        };
        return this.getMP4Url().done(function () {
//a580<
          if (__begin&&__YY__.S("a580", arguments)) {if(__E){eval(__YY__.gE("a580"));}else{debugger;}}
          r.resolve({list: d()})
        }).fail(function () {
//a581<
          if (__begin&&__YY__.S("a581", arguments)) {if(__E){eval(__YY__.gE("a581"));}else{debugger;}}
          r.reject({list: []})
        }), r
      }, this.hasHardSubtitle = function () {
//a582<
        if (__begin&&__YY__.S("a582", arguments)) {if(__E){eval(__YY__.gE("a582"));}else{debugger;}}
...
//a583<
        if (__begin&&__YY__.S("a583", arguments)) {if(__E){eval(__YY__.gE("a583"));}else{debugger;}}
        return "object" == b.type(this.data.sfl) && b.isArray(this.data.sfl.fi) && this.data.sfl.fi.length > 0
      }
    }, a.PLAYTYPE = {LIVE: "1", VOD: "2"}
  }(tvp, tvp.$), function (a) {
//a584<
    if (__begin&&__YY__.S("a584", arguments)) {if(__E){eval(__YY__.gE("a584"));}else{debugger;}}
    tvp.speedlimit = {
      buildResult: function (b) {
//a585<
        if (__begin&&__YY__.S("a585", arguments)) {if(__E){eval(__YY__.gE("a585"));}else{debugger;}}
        var c = !1, d = !1, e = a.Deferred();
        return a.browser.MQQ && a.browser.version > 5.1 && (d = !0), d && this.mqqGetResult(b).then(function (a) {
//a586<
          if (__begin&&__YY__.S("a586", arguments)) {if(__E){eval(__YY__.gE("a586"));}else{debugger;}}
          a ? e.resolve(a) : e.resolve()
        }), d && (c = !0), c || e.resolve(), setTimeout(function () {
//a587<
          if (__begin&&__YY__.S("a587", arguments)) {if(__E){eval(__YY__.gE("a587"));}else{debugger;}}
          e.resolve()
        }, 3e3), e
      }, mqqGetResult: function (b) {
//a588<
        if (__begin&&__YY__.S("a588", arguments)) {if(__E){eval(__YY__.gE("a588"));}else{debugger;}}
        function c() {
//a589<
          if (__begin&&__YY__.S("a589", arguments)) {if(__E){eval(__YY__.gE("a589"));}else{debugger;}}
          if (window.x5 && window.x5.getBrowserSignature)try {
            var c = parseInt(tvp.$.now() / 1e3, 10);
            x5.getBrowserSignature("vid:" + b + "[" + c + "]", function (b) {
//a590<
              if (__begin&&__YY__.S("a590", arguments)) {if(__E){eval(__YY__.gE("a590"));}else{debugger;}}
              b ? d.resolve({bver: a.browser.version, pkckey: b}) : d.resolve()
            }, function () {
//a591<
              if (__begin&&__YY__.S("a591", arguments)) {if(__E){eval(__YY__.gE("a591"));}else{debugger;}}
              d.resolve()
            })
          } catch (e) {
            d.resolve()
          ...
          setTimeout(function () {
//a592<
            if (__begin&&__YY__.S("a592", arguments)) {if(__E){eval(__YY__.gE("a592"));}else{debugger;}}
            d.resolve()
          }, 300)
        }
...
//a593<
          if (__begin&&__YY__.S("a593", arguments)) {if(__E){eval(__YY__.gE("a593"));}else{debugger;}}
          c()
        }), tvp.app.loadMqqDefer.fail(function () {
//a594<
          if (__begin&&__YY__.S("a594", arguments)) {if(__E){eval(__YY__.gE("a594"));}else{debugger;}}
          d.resolve()
        })) : d.resolve(), d
      }
    }
  ...
  e.ha = function (a) {
//a595<
    if (__begin&&__YY__.S("a595", arguments)) {if(__E){eval(__YY__.gE("a595"));}else{debugger;}}
    function b(a, b) {
//a596<
      if (__begin&&__YY__.S("a596", arguments)) {if(__E){eval(__YY__.gE("a596"));}else{debugger;}}
    ...
    var e = function (d) {
//a597<
      if (__begin&&__YY__.S("a597", arguments)) {if(__E){eval(__YY__.gE("a597"));}else{debugger;}}
...
//a598<
    if (__begin&&__YY__.S("a598", arguments)) {if(__E){eval(__YY__.gE("a598"));}else{debugger;}}
...
//a599<
    if (__begin&&__YY__.S("a599", arguments)) {if(__E){eval(__YY__.gE("a599"));}else{debugger;}}
...
//a600<
    if (__begin&&__YY__.S("a600", arguments)) {if(__E){eval(__YY__.gE("a600"));}else{debugger;}}
    for (var c = "", d = 0; d < a.length; d++)c += String.fromCharCode(a.charCodeAt(d) ^ b.charCodeAt(d % 4));
    return c
  }, e.u1 = function (a, b) {
//a601<
    if (__begin&&__YY__.S("a601", arguments)) {if(__E){eval(__YY__.gE("a601"));}else{debugger;}}
...
//a602<
    if (__begin&&__YY__.S("a602", arguments)) {if(__E){eval(__YY__.gE("a602"));}else{debugger;}}
...
//a603<
    if (__begin&&__YY__.S("a603", arguments)) {if(__E){eval(__YY__.gE("a603"));}else{debugger;}}
...
//a604<
      if (__begin&&__YY__.S("a604", arguments)) {if(__E){eval(__YY__.gE("a604"));}else{debugger;}}
      var a = [];
...
//a605<
    if (__begin&&__YY__.S("a605", arguments)) {if(__E){eval(__YY__.gE("a605"));}else{debugger;}}
    function c() {
//a606<
      if (__begin&&__YY__.S("a606", arguments)) {if(__E){eval(__YY__.gE("a606"));}else{debugger;}}
      return this.init()
    }
    ...
    var d = [{
      reg: function () {
//a607<
        if (__begin&&__YY__.S("a607", arguments)) {if(__E){eval(__YY__.gE("a607"));}else{debugger;}}
        return this.cfg.noAuth ? !0 : !1
      }, request: function (a) {
//a608<
        if (__begin&&__YY__.S("a608", arguments)) {if(__E){eval(__YY__.gE("a608"));}else{debugger;}}
        var b = this;
      ...
      reg: function () {
//a609<
        if (__begin&&__YY__.S("a609", arguments)) {if(__E){eval(__YY__.gE("a609"));}else{debugger;}}
        return this.cfg.eduext ? !0 : !1
      }, request: function (a) {
//a610<
        if (__begin&&__YY__.S("a610", arguments)) {if(__E){eval(__YY__.gE("a610"));}else{debugger;}}
        var b = this;
        a.resolve({
      ...
      reg: function () {
//a611<
        if (__begin&&__YY__.S("a611", arguments)) {if(__E){eval(__YY__.gE("a611"));}else{debugger;}}
        return 1 === this.cfg.classType ? !0 : !1
      }, request: function (a) {
//a612<
        if (__begin&&__YY__.S("a612", arguments)) {if(__E){eval(__YY__.gE("a612"));}else{debugger;}}
        var b = this;
      ...
      reg: function () {
//a613<
        if (__begin&&__YY__.S("a613", arguments)) {if(__E){eval(__YY__.gE("a613"));}else{debugger;}}
        return this.cfg.yyactid ? !0 : !1
      }, request: function (a) {
//a614<
        if (__begin&&__YY__.S("a614", arguments)) {if(__E){eval(__YY__.gE("a614"));}else{debugger;}}
        var b = this;
        a.resolve({
      ...
      reg: function () {
//a615<
        if (__begin&&__YY__.S("a615", arguments)) {if(__E){eval(__YY__.gE("a615"));}else{debugger;}}
        if (window !== top && "192.168.1.199" === location.hostname && "/iframe/player.html" === location.pathname) {
...
//a616<
        if (__begin&&__YY__.S("a616", arguments)) {if(__E){eval(__YY__.gE("a616"));}else{debugger;}}
        var b, c = this, d = {
      ...
      reg: function () {
//a617<
        if (__begin&&__YY__.S("a617", arguments)) {if(__E){eval(__YY__.gE("a617"));}else{debugger;}}
        return a.common.is_mqq_buluo() ? !0 : !1
      }, request: function (b) {
//a618<
        if (__begin&&__YY__.S("a618", arguments)) {if(__E){eval(__YY__.gE("a618"));}else{debugger;}}
        if (!window.getBrowserSignature)return void b.reject();
        var c = this;
        window.getBrowserSignature(c.cfg.vid, function (d) {
//a619<
          if (__begin&&__YY__.S("a619", arguments)) {if(__E){eval(__YY__.gE("a619"));}else{debugger;}}
          var e;
          if (d && d.data)try {
      ...
      reg: function () {
//a620<
        if (__begin&&__YY__.S("a620", arguments)) {if(__E){eval(__YY__.gE("a620"));}else{debugger;}}
        return b.browser.MQQ && !a.$.browser.MQQClient && window === top ? !0 : !1
      }, request: function (c) {
//a621<
        if (__begin&&__YY__.S("a621", arguments)) {if(__E){eval(__YY__.gE("a621"));}else{debugger;}}
        var d, e, f = this, g = "undefined" != typeof f.cfg.svr_time ? f.cfg.svr_time + "" : parseInt(+new Date / 1e3) + "", h = function () {
//a622<
          if (__begin&&__YY__.S("a622", arguments)) {if(__E){eval(__YY__.gE("a622"));}else{debugger;}}
...
//a623<
            if (__begin&&__YY__.S("a623", arguments)) {if(__E){eval(__YY__.gE("a623"));}else{debugger;}}
            if ("object" == typeof a && a.key && a.ver && a.platform) {
              var b = {
                cgi: f.cfg.cgi.getvinfo,
                param: {cKey: a.key, encryptVer: a.ver, platform: a.platform, vid: f.cfg.vid, defn: f.cfg.fmt}
              };
              c.resolve(b)
            } else if ("object" == typeof a && a.data) {
              var b = {
                cgi: f.cfg.cgi.getvinfo,
                param: {cKey: a.data, encryptVer: "4.0", platform: "161001", vid: f.cfg.vid, defn: f.cfg.fmt}
              };
              c.resolve(b)
...
//a624<
            if (__begin&&__YY__.S("a624", arguments)) {if(__E){eval(__YY__.gE("a624"));}else{debugger;}}
            c.reject()
          })
        };
...
//a625<
          if (__begin&&__YY__.S("a625", arguments)) {if(__E){eval(__YY__.gE("a625"));}else{debugger;}}
...
//a626<
          if (__begin&&__YY__.S("a626", arguments)) {if(__E){eval(__YY__.gE("a626"));}else{debugger;}}
          c.reject()
        })
      }
    }, {
      reg: function () {
//a627<
        if (__begin&&__YY__.S("a627", arguments)) {if(__E){eval(__YY__.gE("a627"));}else{debugger;}}
        return b.browser.qqnews || b.browser.kuaibao ? !0 : !1
      }, request: function (a) {
//a628<
        if (__begin&&__YY__.S("a628", arguments)) {if(__E){eval(__YY__.gE("a628"));}else{debugger;}}
        ...
        c[i] = function (b) {
//a629<
          if (__begin&&__YY__.S("a629", arguments)) {if(__E){eval(__YY__.gE("a629"));}else{debugger;}}
          var c;
          try {
            c = JSON.parse(b)
          } catch (d) {
        ...
        var l = function () {
//a630<
          if (__begin&&__YY__.S("a630", arguments)) {if(__E){eval(__YY__.gE("a630"));}else{debugger;}}
          var a = {
            method: "getCKey",
            types: ["string", "string", "string"],
            args: [g, h, i],
...
//a631<
          if (__begin&&__YY__.S("a631", arguments)) {if(__E){eval(__YY__.gE("a631"));}else{debugger;}}
          var a = function () {
//a632<
            if (__begin&&__YY__.S("a632", arguments)) {if(__E){eval(__YY__.gE("a632"));}else{debugger;}}
...
//a633<
            if (__begin&&__YY__.S("a633", arguments)) {if(__E){eval(__YY__.gE("a633"));}else{debugger;}}
            a()
          })) : d.addEventListener("TencentNewsJSInjectionComplete", function () {
//a634<
            if (__begin&&__YY__.S("a634", arguments)) {if(__E){eval(__YY__.gE("a634"));}else{debugger;}}
            a()
          })
        };
      ...
      reg: function () {
//a635<
        if (__begin&&__YY__.S("a635", arguments)) {if(__E){eval(__YY__.gE("a635"));}else{debugger;}}
        return b.browser.douban || b.browser.liebao ? !0 : !1
      }, request: function (a) {
//a636<
        if (__begin&&__YY__.S("a636", arguments)) {if(__E){eval(__YY__.gE("a636"));}else{debugger;}}
        var b, c = this, d = "undefined" != typeof c.cfg.svr_time ? c.cfg.svr_time + "" : parseInt(+new Date / 1e3) + "", e = function () {
//a637<
          if (__begin&&__YY__.S("a637", arguments)) {if(__E){eval(__YY__.gE("a637"));}else{debugger;}}
      ...
      reg: function () {
//a638<
        if (__begin&&__YY__.S("a638", arguments)) {if(__E){eval(__YY__.gE("a638"));}else{debugger;}}
        return a.$.browser.MQQClient && "mqqcartoon" === a.$.getUrlParam("openS") ? !0 : !1
      }, request: function (b) {
//a639<
        if (__begin&&__YY__.S("a639", arguments)) {if(__E){eval(__YY__.gE("a639"));}else{debugger;}}
        var c = this;
        a.$.getScript("http://192.168.1.199/club/client/comic/release/js/util/qqComicVideoAuth.js?t=" + a.ts, function () {
//a640<
          if (__begin&&__YY__.S("a640", arguments)) {if(__E){eval(__YY__.gE("a640"));}else{debugger;}}
          "function" === a.$.type(window.getBrowserSignature) ? window.getBrowserSignature(c.cfg.vid, function (a) {
//a641<
            if (__begin&&__YY__.S("a641", arguments)) {if(__E){eval(__YY__.gE("a641"));}else{debugger;}}
            if (a && -1 !== a) {
              var d = {
    ...
    c.prototype = {
      init: function () {
//a642<
        if (__begin&&__YY__.S("a642", arguments)) {if(__E){eval(__YY__.gE("a642"));}else{debugger;}}
        return this.reg_request
      }, reg_request: function (c, e) {
//a643<
        if (__begin&&__YY__.S("a643", arguments)) {if(__E){eval(__YY__.gE("a643"));}else{debugger;}}
        var f = this;
        f.cfg = c, f.cfg2 = e;
...
//a644<
          if (__begin&&__YY__.S("a644", arguments)) {if(__E){eval(__YY__.gE("a644"));}else{debugger;}}
...
//a645<
          if (__begin&&__YY__.S("a645", arguments)) {if(__E){eval(__YY__.gE("a645"));}else{debugger;}}
          g.reject()
        }, 6e3), g
      }
    }, a.auth = new c
...
//a646<
    if (__begin&&__YY__.S("a646", arguments)) {if(__E){eval(__YY__.gE("a646"));}else{debugger;}}
    function c() {
//a647<
      if (__begin&&__YY__.S("a647", arguments)) {if(__E){eval(__YY__.gE("a647"));}else{debugger;}}
      var a = "192.168.1.199" === k.host;
    ...
    function d(a, b) {
//a648<
      if (__begin&&__YY__.S("a648", arguments)) {if(__E){eval(__YY__.gE("a648"));}else{debugger;}}
    ...
    function f(c) {
//a649<
      if (__begin&&__YY__.S("a649", arguments)) {if(__E){eval(__YY__.gE("a649"));}else{debugger;}}
    ...
    function g(a) {
//a650<
      if (__begin&&__YY__.S("a650", arguments)) {if(__E){eval(__YY__.gE("a650"));}else{debugger;}}
      a = a || {};
      var d, e = !1;
...
//a651<
        if (__begin&&__YY__.S("a651", arguments)) {if(__E){eval(__YY__.gE("a651"));}else{debugger;}}
    ...
    function h(a) {
//a652<
      if (__begin&&__YY__.S("a652", arguments)) {if(__E){eval(__YY__.gE("a652"));}else{debugger;}}
      if ("object" !== b.type(a))return 0;
      if (!(a.ul && a.ul.ui && a.ul.ui.length))return 0;
      var c = [];
      return b(a.ul.ui).each(function (a, b) {
//a653<
        if (__begin&&__YY__.S("a653", arguments)) {if(__E){eval(__YY__.gE("a653"));}else{debugger;}}
    ...
    function i(a) {
//a654<
      if (__begin&&__YY__.S("a654", arguments)) {if(__E){eval(__YY__.gE("a654"));}else{debugger;}}
      return function (c) {
//a655<
        if (__begin&&__YY__.S("a655", arguments)) {if(__E){eval(__YY__.gE("a655"));}else{debugger;}}
        f(b.extend(a, c))
      }
    }
    ...
    function j(d, f) {
//a656<
      if (__begin&&__YY__.S("a656", arguments)) {if(__E){eval(__YY__.gE("a656"));}else{debugger;}}
      f = f || "";
      var g, h, i, j = "", k = 1, l = {};
    ...
    k.cgi = function () {
//a657<
      if (__begin&&__YY__.S("a657", arguments)) {if(__E){eval(__YY__.gE("a657"));}else{debugger;}}
      if ("192.168.1.199" === k.host) {
        var c = "";
...
//a658<
      if (__begin&&__YY__.S("a658", arguments)) {if(__E){eval(__YY__.gE("a658"));}else{debugger;}}
      return {getinfo: "//192.168.1.199/getinfo?callback=?&", getkey: "//192.168.1.199/getkey?callback=?&"}
    }(), a.h5Helper = {
      loadVideoUrlByVid: function (c) {
//a659<
        if (__begin&&__YY__.S("a659", arguments)) {if(__E){eval(__YY__.gE("a659"));}else{debugger;}}
        var d = "";
        return a.speedlimit ? (d = b.Deferred(), a.speedlimit.buildResult().done(function (b) {
//a660<
          if (__begin&&__YY__.S("a660", arguments)) {if(__E){eval(__YY__.gE("a660"));}else{debugger;}}
          var e = a.h5Helper.loadVideoUrlByVid_base(c, b);
          e.done(function (a, b) {
//a661<
            if (__begin&&__YY__.S("a661", arguments)) {if(__E){eval(__YY__.gE("a661"));}else{debugger;}}
            d.resolve(a, b)
          }), e.fail(function (a, b) {
//a662<
            if (__begin&&__YY__.S("a662", arguments)) {if(__E){eval(__YY__.gE("a662"));}else{debugger;}}
            d.reject(a, b)
          })
        })) : d = a.h5Helper.loadVideoUrlByVid_base(c), d
      }, loadVideoUrlByVid_base: function (e, f) {
//a663<
        if (__begin&&__YY__.S("a663", arguments)) {if(__E){eval(__YY__.gE("a663"));}else{debugger;}}
        ...
        var A = function (d) {
//a664<
          if (__begin&&__YY__.S("a664", arguments)) {if(__E){eval(__YY__.gE("a664"));}else{debugger;}}
          ...
          if (s.reportSuc(), y({val: 0, speed: w}), e.loadingAdCgi)return void q.resolve(l.ul.ui[0].url, {
            vl: d.vl,
            fl: d.fl,
            sfl: d.sfl,
            exem: d.exem,
...
//a665<
          if (__begin&&__YY__.S("a665", arguments)) {if(__E){eval(__YY__.gE("a665"));}else{debugger;}}
          var h, k = l.ul.ui[0];
...
//a666<
            if (__begin&&__YY__.S("a666", arguments)) {if(__E){eval(__YY__.gE("a666"));}else{debugger;}}
            var d = "";
...
//a667<
            if (__begin&&__YY__.S("a667", arguments)) {if(__E){eval(__YY__.gE("a667"));}else{debugger;}}
            h.reportErr(), y({
              val: 500,
              speed: b.now() - v
...
//a668<
          if (__begin&&__YY__.S("a668", arguments)) {if(__E){eval(__YY__.gE("a668"));}else{debugger;}}
...
//a669<
            if (__begin&&__YY__.S("a669", arguments)) {if(__E){eval(__YY__.gE("a669"));}else{debugger;}}
...
//a670<
            if (__begin&&__YY__.S("a670", arguments)) {if(__E){eval(__YY__.gE("a670"));}else{debugger;}}
            if (s.reportErr(), y({val: 500, speed: b.now() - v}), t)q.reject(500, 1); else {
              var c = parseInt(700 * Math.random() + 300);
              setTimeout(function () {
//a671<
                if (__begin&&__YY__.S("a671", arguments)) {if(__E){eval(__YY__.gE("a671"));}else{debugger;}}
...
//a672<
          if (__begin&&__YY__.S("a672", arguments)) {if(__E){eval(__YY__.gE("a672"));}else{debugger;}}
          a = a || {}, "undefined" !== b.type(a.cgi) && a.cgi && (u = a.cgi), "undefined" !== b.type(a.cgi2) && a.cgi2 && (z = a.cgi2), a.param && b.extend(r, a.param), C()
        }).fail(function () {
//a673<
          if (__begin&&__YY__.S("a673", arguments)) {if(__E){eval(__YY__.gE("a673"));}else{debugger;}}
          b.extend(r, {vids: n.vid, defaultfmt: n.fmt}), C()
        }), q
      }, loadHDVideoUrlByVid: function (b) {
//a674<
        if (__begin&&__YY__.S("a674", arguments)) {if(__E){eval(__YY__.gE("a674"));}else{debugger;}}
        b.fmt = "mp4", a.h5Helper.loadVideoUrlByVid(b)
      }, loadHLSUrlByVid: function (c) {
//a675<
        if (__begin&&__YY__.S("a675", arguments)) {if(__E){eval(__YY__.gE("a675"));}else{debugger;}}
        var d = {}, e = b.Deferred();
        b.extend(b.extend(d, k), c);
        var f = new a.RetCode(100128), g = "http://192.168.1.199/gethls?callback=?&" + b.param({
            vid: d.vid,
            charge: d.isPay ? 1 : 0,
            otype: "json",
            platform: d.platform,
...
//a676<
          if (__begin&&__YY__.S("a676", arguments)) {if(__E){eval(__YY__.gE("a676"));}else{debugger;}}
          ...
          return 0 == d.length ? (f.reportErr(68), h({
            speed: b.now() - l,
            val: 68
          }), void e.reject(68, g)) : (h({speed: b.now() - l, val: 0}), f.reportSuc(), void e.resolve(d[0], c.vd))
        }).fail(function () {
//a677<
          if (__begin&&__YY__.S("a677", arguments)) {if(__E){eval(__YY__.gE("a677"));}else{debugger;}}
          f.reportErr(), h({speed: b.now() - l, val: 500}), e.reject(500, 3)
        }), e
      }, load3GVideoUrl: function (b) {
//a678<
        if (__begin&&__YY__.S("a678", arguments)) {if(__E){eval(__YY__.gE("a678"));}else{debugger;}}
        b.fmt = "msd", a.h5Helper.loadVideoUrlByVid(b)
      }, loadIsUseHLS: function (c) {
//a679<
        if (__begin&&__YY__.S("a679", arguments)) {if(__E){eval(__YY__.gE("a679"));}else{debugger;}}
        var d = {}, e = b.Deferred();
        b.extend(b.extend(d, k), c);
...
//a680<
          if (__begin&&__YY__.S("a680", arguments)) {if(__E){eval(__YY__.gE("a680"));}else{debugger;}}
          var d = 1;
...
//a681<
          if (__begin&&__YY__.S("a681", arguments)) {if(__E){eval(__YY__.gE("a681"));}else{debugger;}}
          f.reportErr(), e.reject(500, 4)
        }), e
      }, loadSRT: function (a) {
//a682<
        if (__begin&&__YY__.S("a682", arguments)) {if(__E){eval(__YY__.gE("a682"));}else{debugger;}}
        var c = {}, d = b.Deferred();
        return b.extend(b.extend(c, k), a), b.ajax({
          url: "http://192.168.1.199/getsurl?" + b.param({
            vid: c.vid,
            format: c.sflid,
            platform: c.platform,
            pid: c.pid,
...
//a683<
          if (__begin&&__YY__.S("a683", arguments)) {if(__E){eval(__YY__.gE("a683"));}else{debugger;}}
          return "object" != b.type(a) ? void d.reject(500) : "o" != a.s ? void d.reject(isNaN(a.em) ? 500 : a.em, a.msg || "") : void d.resolve(a)
        }).fail(function () {
//a684<
          if (__begin&&__YY__.S("a684", arguments)) {if(__E){eval(__YY__.gE("a684"));}else{debugger;}}
          d.reject(500)
        }), d
      }, setSpecialVideoFileDomain: function (a) {
//a685<
        if (__begin&&__YY__.S("a685", arguments)) {if(__E){eval(__YY__.gE("a685"));}else{debugger;}}
        "string" == typeof a && /^(\S+[\.])?qq\.com/.test(location.host) && (l = a)
      }
    }
  }(tvp, tvp.$), function () {
//a686<
    if (__begin&&__YY__.S("a686", arguments)) {if(__E){eval(__YY__.gE("a686"));}else{debugger;}}
    function a() {
//a687<
      if (__begin&&__YY__.S("a687", arguments)) {if(__E){eval(__YY__.gE("a687"));}else{debugger;}}
    ...
    if (!window.txvLogin) {
      var c = {
        set: function (a, b, c, d, e) {
//a688<
          if (__begin&&__YY__.S("a688", arguments)) {if(__E){eval(__YY__.gE("a688"));}else{debugger;}}
          if (e) {
            var f = new Date, g = new Date;
            g.setTime(f.getTime() + 36e5 * e)
          }
...
//a689<
          if (__begin&&__YY__.S("a689", arguments)) {if(__E){eval(__YY__.gE("a689"));}else{debugger;}}
          var b = new RegExp("(?:^|;+|\\s+)" + a + "=([^;]*)"), c = document.cookie.match(b);
          return c ? c[1] : ""
        }, del: function (a, b, c) {
//a690<
          if (__begin&&__YY__.S("a690", arguments)) {if(__E){eval(__YY__.gE("a690"));}else{debugger;}}
          var d = new Date;
          d.setTime(d.getTime() - 1), document.cookie = a + "=; expires=" + d.toGMTString() + ";" + (c ? "path=" + c + "; " : "path=/; ") + (b ? "domain=" + b + ";" : "domain=" + window.location.host + ";")
        }
      }, d = {
        ajax: function (a, c, d) {
//a691<
          if (__begin&&__YY__.S("a691", arguments)) {if(__E){eval(__YY__.gE("a691"));}else{debugger;}}
...
//a692<
            if (__begin&&__YY__.S("a692", arguments)) {if(__E){eval(__YY__.gE("a692"));}else{debugger;}}
            c(a)
          }, a.error = function (a) {
//a693<
            if (__begin&&__YY__.S("a693", arguments)) {if(__E){eval(__YY__.gE("a693"));}else{debugger;}}
            d({error: a})
          }, e(a)
        }
      }, e = navigator.userAgent.toLowerCase(), f = {
        isqqlive: e.indexOf("qqlive") > -1 && -1 === e.indexOf("qqlivebroadcastbrowser") && -1 === e.indexOf("qqlivebroadcast"),
        isipad: e.search(/ipad/i) > -1
      };
      a.prototype = {
        isLogin: function (a) {
//a694<
          if (__begin&&__YY__.S("a694", arguments)) {if(__E){eval(__YY__.gE("a694"));}else{debugger;}}
          a = a || function () {
//a695<
              if (__begin&&__YY__.S("a695", arguments)) {if(__E){eval(__YY__.gE("a695"));}else{debugger;}}
            };
          var b = this;
          return f.isqqlive ? void this.tvGetCookie(["qq", "wx"], function (b) {
//a696<
            if (__begin&&__YY__.S("a696", arguments)) {if(__E){eval(__YY__.gE("a696"));}else{debugger;}}
            var c;
            try {
              c = JSON.parse(b)
            } catch (d) {
...
//a697<
            if (__begin&&__YY__.S("a697", arguments)) {if(__E){eval(__YY__.gE("a697"));}else{debugger;}}
            b.isQQLogin(function (d) {
//a698<
              if (__begin&&__YY__.S("a698", arguments)) {if(__E){eval(__YY__.gE("a698"));}else{debugger;}}
              return d && c && "qq" === c.main_login ? void a(1, null) : void b.isWXLogin(function (b) {
//a699<
                if (__begin&&__YY__.S("a699", arguments)) {if(__E){eval(__YY__.gE("a699"));}else{debugger;}}
...
//a700<
          if (__begin&&__YY__.S("a700", arguments)) {if(__E){eval(__YY__.gE("a700"));}else{debugger;}}
          var a, b, c = this;
...
//a701<
            if (__begin&&__YY__.S("a701", arguments)) {if(__E){eval(__YY__.gE("a701"));}else{debugger;}}
          }), this.isLogin(function (d, e) {
//a702<
            if (__begin&&__YY__.S("a702", arguments)) {if(__E){eval(__YY__.gE("a702"));}else{debugger;}}
            if (0 === d)return void b({error: "not login"});
            if (f.isqqlive) {
              var g = a && [a];
              return void c.tvGetUserInfo(g || ["qq", "wx"], function (c) {
//a703<
                if (__begin&&__YY__.S("a703", arguments)) {if(__E){eval(__YY__.gE("a703"));}else{debugger;}}
                var e, f;
                try {
                  e = JSON.parse(c)
                } catch (g) {
...
//a704<
              if (__begin&&__YY__.S("a704", arguments)) {if(__E){eval(__YY__.gE("a704"));}else{debugger;}}
...
//a705<
          if (__begin&&__YY__.S("a705", arguments)) {if(__E){eval(__YY__.gE("a705"));}else{debugger;}}
          a = a || function () {
//a706<
              if (__begin&&__YY__.S("a706", arguments)) {if(__E){eval(__YY__.gE("a706"));}else{debugger;}}
            };
          var b = c.get("lskey"), d = c.get("luin"), e = c.get("uin"), f = c.get("skey");
          a(e && f ? 2 : b && d ? 1 : 0)
        }, isQQLogin: function (a) {
//a707<
          if (__begin&&__YY__.S("a707", arguments)) {if(__E){eval(__YY__.gE("a707"));}else{debugger;}}
          a = a || function () {
//a708<
              if (__begin&&__YY__.S("a708", arguments)) {if(__E){eval(__YY__.gE("a708"));}else{debugger;}}
            }, this.checkQQLogin(function (b) {
//a709<
            if (__begin&&__YY__.S("a709", arguments)) {if(__E){eval(__YY__.gE("a709"));}else{debugger;}}
            a(0 !== b)
          })
        }, isQQLowLogin: function (a) {
//a710<
          if (__begin&&__YY__.S("a710", arguments)) {if(__E){eval(__YY__.gE("a710"));}else{debugger;}}
          a = a || function () {
//a711<
              if (__begin&&__YY__.S("a711", arguments)) {if(__E){eval(__YY__.gE("a711"));}else{debugger;}}
            }, this.checkQQLogin(function (b) {
//a712<
            if (__begin&&__YY__.S("a712", arguments)) {if(__E){eval(__YY__.gE("a712"));}else{debugger;}}
            a(1 === b)
          })
        }, getUin: function (a) {
//a713<
          if (__begin&&__YY__.S("a713", arguments)) {if(__E){eval(__YY__.gE("a713"));}else{debugger;}}
          a = a || function () {
//a714<
              if (__begin&&__YY__.S("a714", arguments)) {if(__E){eval(__YY__.gE("a714"));}else{debugger;}}
            };
          var b;
          this.isQQLowLogin(function (d) {
//a715<
            if (__begin&&__YY__.S("a715", arguments)) {if(__E){eval(__YY__.gE("a715"));}else{debugger;}}
            b = d ? c.get("luin") : c.get("uin"), b ? (b = parseInt(b.replace(/^o0*/g, ""), 10), a(b)) : a(0)
          })
        }, getSkey: function (a) {
//a716<
          if (__begin&&__YY__.S("a716", arguments)) {if(__E){eval(__YY__.gE("a716"));}else{debugger;}}
          a = a || function () {
//a717<
              if (__begin&&__YY__.S("a717", arguments)) {if(__E){eval(__YY__.gE("a717"));}else{debugger;}}
            };
          var b = c.get("skey"), d = c.get("lskey");
          a(b || d)
        }, time33: function (a) {
//a718<
          if (__begin&&__YY__.S("a718", arguments)) {if(__E){eval(__YY__.gE("a718"));}else{debugger;}}
          for (var b = 0, c = a.length, d = 5381; c > b; ++b)d += (d << 5) + a.charAt(b).charCodeAt();
          return 2147483647 & d
        }, gTk: function (a) {
//a719<
          if (__begin&&__YY__.S("a719", arguments)) {if(__E){eval(__YY__.gE("a719"));}else{debugger;}}
          a = a || function () {
//a720<
              if (__begin&&__YY__.S("a720", arguments)) {if(__E){eval(__YY__.gE("a720"));}else{debugger;}}
            };
          var b = this;
          this.getWXCookie(function (c) {
//a721<
            if (__begin&&__YY__.S("a721", arguments)) {if(__E){eval(__YY__.gE("a721"));}else{debugger;}}
            "wx" == c.main_login ? a(b.time33(c.vusession), "wx") : b.getSkey(function (c) {
//a722<
              if (__begin&&__YY__.S("a722", arguments)) {if(__E){eval(__YY__.gE("a722"));}else{debugger;}}
              var d = c ? b.time33(c) : "";
              a(d, "")
            })
          })
...
//a723<
          if (__begin&&__YY__.S("a723", arguments)) {if(__E){eval(__YY__.gE("a723"));}else{debugger;}}
          a = a || function () {
//a724<
              if (__begin&&__YY__.S("a724", arguments)) {if(__E){eval(__YY__.gE("a724"));}else{debugger;}}
            };
          var b, c = this, e = function () {
//a725<
            if (__begin&&__YY__.S("a725", arguments)) {if(__E){eval(__YY__.gE("a725"));}else{debugger;}}
            c.checkQQLogin(function (c) {
//a726<
              if (__begin&&__YY__.S("a726", arguments)) {if(__E){eval(__YY__.gE("a726"));}else{debugger;}}
              return 0 === c ? void a({error: "qq not login"}) : (b = 1 === c ? 1 : 0, void f())
            })
          }, f = function () {
//a727<
            if (__begin&&__YY__.S("a727", arguments)) {if(__E){eval(__YY__.gE("a727"));}else{debugger;}}
            d.ajax({
              url: "//192.168.1.199/fcgi-bin/get_userinfo",
              data: {otype: "json", type: 2, _: +new Date, low_login: b},
              dataType: "jsonp",
              timeout: 5e3
            }, function (b) {
//a728<
              if (__begin&&__YY__.S("a728", arguments)) {if(__E){eval(__YY__.gE("a728"));}else{debugger;}}
              b = {qqface: b.data[0].headurl, nick: b.data[0].nick}, a(b)
            }, function (b) {
//a729<
              if (__begin&&__YY__.S("a729", arguments)) {if(__E){eval(__YY__.gE("a729"));}else{debugger;}}
              a(b)
            })
          };
          e()
...
//a730<
          if (__begin&&__YY__.S("a730", arguments)) {if(__E){eval(__YY__.gE("a730"));}else{debugger;}}
          a = a || {};
          var b = location.protocol + "//192.168.1.199/fcgi-bin/qq_login?redirect_url=" + encodeURIComponent(a.s_url || location.href);
          delete a.s_url;
          var c = "//192.168.1.199/cgi-bin/login?", d = {
            link_target: "blank",
            low_login: 0,
            target: "self",
            style: 9,
...
//a731<
            if (__begin&&__YY__.S("a731", arguments)) {if(__E){eval(__YY__.gE("a731"));}else{debugger;}}
            window.location.href = c
          }, 200)
        }, qqLogout: function () {
//a732<
          if (__begin&&__YY__.S("a732", arguments)) {if(__E){eval(__YY__.gE("a732"));}else{debugger;}}
...
//a733<
            if (__begin&&__YY__.S("a733", arguments)) {if(__E){eval(__YY__.gE("a733"));}else{debugger;}}
            a && (c.set("lskey", "", ".qq.com", "/", -24), c.set("luin", "", ".qq.com", "/", -24))
          }), (new Image).src = "//192.168.1.199/fcgi-bin/logout?_=" + Math.random()
        }, openWXLogin: function (a) {
//a734<
          if (__begin&&__YY__.S("a734", arguments)) {if(__E){eval(__YY__.gE("a734"));}else{debugger;}}
          a = a || window.location.href;
          var b = "//192.168.1.199/fcgi-bin/wx_login?from=1&redirect_url=" + encodeURIComponent(a);
          document.location.href = b
        }, getWXCookie: function (a) {
//a735<
          if (__begin&&__YY__.S("a735", arguments)) {if(__E){eval(__YY__.gE("a735"));}else{debugger;}}
          a = a || function () {
//a736<
              if (__begin&&__YY__.S("a736", arguments)) {if(__E){eval(__YY__.gE("a736"));}else{debugger;}}
            };
          var b = this, c = location.protocol + "//192.168.1.199/getcookie/getcookie.html.html";
...
//a737<
            if (__begin&&__YY__.S("a737", arguments)) {if(__E){eval(__YY__.gE("a737"));}else{debugger;}}
            if (b.cache.wxAuthCache = c, setInterval(function () {
//a738<
                if (__begin&&__YY__.S("a738", arguments)) {if(__E){eval(__YY__.gE("a738"));}else{debugger;}}
...
//a739<
          if (__begin&&__YY__.S("a739", arguments)) {if(__E){eval(__YY__.gE("a739"));}else{debugger;}}
          a = a || function () {
//a740<
              if (__begin&&__YY__.S("a740", arguments)) {if(__E){eval(__YY__.gE("a740"));}else{debugger;}}
            };
          var b = this, c = {};
          this.getWXCookie(function (d) {
//a741<
            if (__begin&&__YY__.S("a741", arguments)) {if(__E){eval(__YY__.gE("a741"));}else{debugger;}}
            return d && d.access_token && d.appid && d.openid && d.vuserid && d.vusession && d.refresh_token ? void b.checkWXLogin(function (b) {
//a742<
              if (__begin&&__YY__.S("a742", arguments)) {if(__E){eval(__YY__.gE("a742"));}else{debugger;}}
...
//a743<
          if (__begin&&__YY__.S("a743", arguments)) {if(__E){eval(__YY__.gE("a743"));}else{debugger;}}
          a = a || function () {
//a744<
              if (__begin&&__YY__.S("a744", arguments)) {if(__E){eval(__YY__.gE("a744"));}else{debugger;}}
            };
          var b = "//192.168.1.199/fcgi-bin/check_login", c = d.ajax({
            url: b,
            timeout: 5e3,
            dataType: "jsonp"
          }, function (b) {
//a745<
            if (__begin&&__YY__.S("a745", arguments)) {if(__E){eval(__YY__.gE("a745"));}else{debugger;}}
            a(b)
          }, function (b) {
//a746<
            if (__begin&&__YY__.S("a746", arguments)) {if(__E){eval(__YY__.gE("a746"));}else{debugger;}}
            a(b)
          });
          c && c.error && a(c)
        }, wxLogout: function (a) {
//a747<
          if (__begin&&__YY__.S("a747", arguments)) {if(__E){eval(__YY__.gE("a747"));}else{debugger;}}
          a = a || function () {
//a748<
              if (__begin&&__YY__.S("a748", arguments)) {if(__E){eval(__YY__.gE("a748"));}else{debugger;}}
            };
          var b = "//192.168.1.199/fcgi-bin/logout";
          this.cache && this.cache.wxAuthCache && (this.cache.wxAuthCache = null);
          var c = d.ajax({url: b, dataType: "jsonp", timeout: 5e3}, function (b) {
//a749<
            if (__begin&&__YY__.S("a749", arguments)) {if(__E){eval(__YY__.gE("a749"));}else{debugger;}}
            a(b)
          }, function (b) {
//a750<
            if (__begin&&__YY__.S("a750", arguments)) {if(__E){eval(__YY__.gE("a750"));}else{debugger;}}
            a(b)
          });
          c && c.error && a(c)
        }, tenvideoJSReady: function (a) {
//a751<
          if (__begin&&__YY__.S("a751", arguments)) {if(__E){eval(__YY__.gE("a751"));}else{debugger;}}
          return a = a || function () {
//a752<
              if (__begin&&__YY__.S("a752", arguments)) {if(__E){eval(__YY__.gE("a752"));}else{debugger;}}
            }, "object" == typeof window.TenvideoJSBridge ? void a() : void document.addEventListener("onTenvideoJSBridgeReady", function () {
//a753<
            if (__begin&&__YY__.S("a753", arguments)) {if(__E){eval(__YY__.gE("a753"));}else{debugger;}}
            a()
          }, !1)
        }, tvLogin: function (a, b) {
//a754<
          if (__begin&&__YY__.S("a754", arguments)) {if(__E){eval(__YY__.gE("a754"));}else{debugger;}}
          b = b || function () {
//a755<
              if (__begin&&__YY__.S("a755", arguments)) {if(__E){eval(__YY__.gE("a755"));}else{debugger;}}
            }, this.tenvideoJSReady(function () {
//a756<
            if (__begin&&__YY__.S("a756", arguments)) {if(__E){eval(__YY__.gE("a756"));}else{debugger;}}
...
//a757<
          if (__begin&&__YY__.S("a757", arguments)) {if(__E){eval(__YY__.gE("a757"));}else{debugger;}}
          a = a || function () {
//a758<
              if (__begin&&__YY__.S("a758", arguments)) {if(__E){eval(__YY__.gE("a758"));}else{debugger;}}
            }, this.tvLogin("qq", a)
        }, tvLoginWX: function (a) {
//a759<
          if (__begin&&__YY__.S("a759", arguments)) {if(__E){eval(__YY__.gE("a759"));}else{debugger;}}
          a = a || function () {
//a760<
              if (__begin&&__YY__.S("a760", arguments)) {if(__E){eval(__YY__.gE("a760"));}else{debugger;}}
            }, this.tvLogin("wx", a)
        }, tvLoginTV: function (a) {
//a761<
          if (__begin&&__YY__.S("a761", arguments)) {if(__E){eval(__YY__.gE("a761"));}else{debugger;}}
          a = a || function () {
//a762<
              if (__begin&&__YY__.S("a762", arguments)) {if(__E){eval(__YY__.gE("a762"));}else{debugger;}}
            }, this.tvLogin("tv", a)
        }, tvSwitchLogin: function (a, b) {
//a763<
          if (__begin&&__YY__.S("a763", arguments)) {if(__E){eval(__YY__.gE("a763"));}else{debugger;}}
          b = b || function () {
//a764<
              if (__begin&&__YY__.S("a764", arguments)) {if(__E){eval(__YY__.gE("a764"));}else{debugger;}}
            }, f.isipad ? b(new Error("iPad not support SwitchLogin")) : this.tenvideoJSReady(function () {
//a765<
            if (__begin&&__YY__.S("a765", arguments)) {if(__E){eval(__YY__.gE("a765"));}else{debugger;}}
            TenvideoJSBridge.invoke("switchLoginState", {userType: a}), TenvideoJSBridge.on("onSwitchLoginStateResponse", function (a) {
//a766<
              if (__begin&&__YY__.S("a766", arguments)) {if(__E){eval(__YY__.gE("a766"));}else{debugger;}}
              var c;
...
//a767<
          if (__begin&&__YY__.S("a767", arguments)) {if(__E){eval(__YY__.gE("a767"));}else{debugger;}}
          this.tenvideoJSReady(function () {
//a768<
            if (__begin&&__YY__.S("a768", arguments)) {if(__E){eval(__YY__.gE("a768"));}else{debugger;}}
            TenvideoJSBridge.invoke("getCookie", {type: a}, b)
          })
        }, tvGetMainCookie: function (a) {
//a769<
          if (__begin&&__YY__.S("a769", arguments)) {if(__E){eval(__YY__.gE("a769"));}else{debugger;}}
          this.tenvideoJSReady(function () {
//a770<
            if (__begin&&__YY__.S("a770", arguments)) {if(__E){eval(__YY__.gE("a770"));}else{debugger;}}
            TenvideoJSBridge.invoke("getMainCookie", null, a)
          })
        }, tvGetUserInfo: function (a, b) {
//a771<
          if (__begin&&__YY__.S("a771", arguments)) {if(__E){eval(__YY__.gE("a771"));}else{debugger;}}
          this.tenvideoJSReady(function () {
//a772<
            if (__begin&&__YY__.S("a772", arguments)) {if(__E){eval(__YY__.gE("a772"));}else{debugger;}}
...
//a773<
    if (__begin&&__YY__.S("a773", arguments)) {if(__E){eval(__YY__.gE("a773"));}else{debugger;}}
    a.BasePlayer = function () {
//a774<
      if (__begin&&__YY__.S("a774", arguments)) {if(__E){eval(__YY__.gE("a774"));}else{debugger;}}
      var c = {};
...
//a775<
        if (__begin&&__YY__.S("a775", arguments)) {if(__E){eval(__YY__.gE("a775"));}else{debugger;}}
...
//a776<
        if (__begin&&__YY__.S("a776", arguments)) {if(__E){eval(__YY__.gE("a776"));}else{debugger;}}
        this.config[a] = b
      }, this.on = function (a, d) {
//a777<
        if (__begin&&__YY__.S("a777", arguments)) {if(__E){eval(__YY__.gE("a777"));}else{debugger;}}
        a && b.isFunction(d) && (c[a] = b.isArray(c[a]) ? c[a] : [], c[a].push(d))
      }, this.trigger = function (a) {
//a778<
        if (__begin&&__YY__.S("a778", arguments)) {if(__E){eval(__YY__.gE("a778"));}else{debugger;}}
        var d, e, f;
...
//a779<
        if (__begin&&__YY__.S("a779", arguments)) {if(__E){eval(__YY__.gE("a779"));}else{debugger;}}
        var e;
...
//a780<
        if (__begin&&__YY__.S("a780", arguments)) {if(__E){eval(__YY__.gE("a780"));}else{debugger;}}
        this.curVideo = a
      }, getPlayer: function () {
//a781<
        if (__begin&&__YY__.S("a781", arguments)) {if(__E){eval(__YY__.gE("a781"));}else{debugger;}}
        return null
      }, getCurVideo: function () {
//a782<
        if (__begin&&__YY__.S("a782", arguments)) {if(__E){eval(__YY__.gE("a782"));}else{debugger;}}
        return this.curVideo
      }, getCurVid: function () {
//a783<
        if (__begin&&__YY__.S("a783", arguments)) {if(__E){eval(__YY__.gE("a783"));}else{debugger;}}
        return this.curVideo instanceof a.VideoInfo ? this.curVideo.getVid() : ""
      }, getCurVidList: function () {
//a784<
        if (__begin&&__YY__.S("a784", arguments)) {if(__E){eval(__YY__.gE("a784"));}else{debugger;}}
        return this.curVideo instanceof a.VideoInfo ? this.curVideo.getVidList() : ""
      }, init: function (c) {
//a785<
        if (__begin&&__YY__.S("a785", arguments)) {if(__E){eval(__YY__.gE("a785"));}else{debugger;}}
...
//a786<
        if (__begin&&__YY__.S("a786", arguments)) {if(__E){eval(__YY__.gE("a786"));}else{debugger;}}
        b("#" + a).html("here is player of base")
      }, log: function (a) {
//a787<
        if (__begin&&__YY__.S("a787", arguments)) {if(__E){eval(__YY__.gE("a787"));}else{debugger;}}
        window.console && window.console.log(a)
      }, getCBEvent: function (c) {
//a788<
        if (__begin&&__YY__.S("a788", arguments)) {if(__E){eval(__YY__.gE("a788"));}else{debugger;}}
        var d;
...
//a789<
        if (__begin&&__YY__.S("a789", arguments)) {if(__E){eval(__YY__.gE("a789"));}else{debugger;}}
...
//a790<
        if (__begin&&__YY__.S("a790", arguments)) {if(__E){eval(__YY__.gE("a790"));}else{debugger;}}
        var d = this.getPlayer();
        d && (d.style.width = b.formatSize(a), d.style.height = b.formatSize(c))
      }, showPlayer: function () {
//a791<
        if (__begin&&__YY__.S("a791", arguments)) {if(__E){eval(__YY__.gE("a791"));}else{debugger;}}
      }, hidePlayer: function () {
//a792<
        if (__begin&&__YY__.S("a792", arguments)) {if(__E){eval(__YY__.gE("a792"));}else{debugger;}}
      }, execFlashMethod: function (a) {
//a793<
        if (__begin&&__YY__.S("a793", arguments)) {if(__E){eval(__YY__.gE("a793"));}else{debugger;}}
...
//a794<
    if (__begin&&__YY__.S("a794", arguments)) {if(__E){eval(__YY__.gE("a794"));}else{debugger;}}
    a.html5lang = {
      errMsg: {
...
//a795<
            if (__begin&&__YY__.S("a795", arguments)) {if(__E){eval(__YY__.gE("a795"));}else{debugger;}}
            if (0 == parseInt(c) && a.app && d && d.vid) {
              var e = a.html5skin.errorDownloader;
              a.app.check(d).done(function (a) {
//a796<
                if (__begin&&__YY__.S("a796", arguments)) {if(__E){eval(__YY__.gE("a796"));}else{debugger;}}
                if (a.url) {
...
//a797<
        if (__begin&&__YY__.S("a797", arguments)) {if(__E){eval(__YY__.gE("a797"));}else{debugger;}}
        if (isNaN(c))return "";
...
//a798<
        if (__begin&&__YY__.S("a798", arguments)) {if(__E){eval(__YY__.gE("a798"));}else{debugger;}}
        return b in a.defaultConfig.definition ? a.defaultConfig.definition[b] : ""
      },
      getSrtName: function (b) {
//a799<
        if (__begin&&__YY__.S("a799", arguments)) {if(__E){eval(__YY__.gE("a799"));}else{debugger;}}
...
//a800<
      if (__begin&&__YY__.S("a800", arguments)) {if(__E){eval(__YY__.gE("a800"));}else{debugger;}}
...
//a801<
      if (__begin&&__YY__.S("a801", arguments)) {if(__E){eval(__YY__.gE("a801"));}else{debugger;}}
...
//a802<
      if (__begin&&__YY__.S("a802", arguments)) {if(__E){eval(__YY__.gE("a802"));}else{debugger;}}
...
//a803<
      if (__begin&&__YY__.S("a803", arguments)) {if(__E){eval(__YY__.gE("a803"));}else{debugger;}}
...
//a804<
      if (__begin&&__YY__.S("a804", arguments)) {if(__E){eval(__YY__.gE("a804"));}else{debugger;}}
...
//a805<
      if (__begin&&__YY__.S("a805", arguments)) {if(__E){eval(__YY__.gE("a805"));}else{debugger;}}
...
//a806<
      if (__begin&&__YY__.S("a806", arguments)) {if(__E){eval(__YY__.gE("a806"));}else{debugger;}}
...
//a807<
      if (__begin&&__YY__.S("a807", arguments)) {if(__E){eval(__YY__.gE("a807"));}else{debugger;}}
...
//a808<
    if (__begin&&__YY__.S("a808", arguments)) {if(__E){eval(__YY__.gE("a808"));}else{debugger;}}
    a.BaseHtml5 || (a.BaseHtml5 = function () {
//a809<
      if (__begin&&__YY__.S("a809", arguments)) {if(__E){eval(__YY__.gE("a809"));}else{debugger;}}
      ...
      getPlayer: function () {
//a810<
        if (__begin&&__YY__.S("a810", arguments)) {if(__E){eval(__YY__.gE("a810"));}else{debugger;}}
        return this.videoTag
      }, getPlayerType: function () {
//a811<
        if (__begin&&__YY__.S("a811", arguments)) {if(__E){eval(__YY__.gE("a811"));}else{debugger;}}
        return "html5"
      }, createVideoHtml: function () {
//a812<
        if (__begin&&__YY__.S("a812", arguments)) {if(__E){eval(__YY__.gE("a812"));}else{debugger;}}
        this.playerid = this.config.playerid, this.playerid || (this.playerid = "tenvideo_video_player_" + a.BaseHtml5.maxId++);
        var c = ['<video id="', this.playerid, '" width="100%" height="100%" '].join(""), d = this;this.config.isHtml5UseUI && (b.os.iphone || b.os.ipod) && this.config.isIOSVideoOffset && !this.config.isiPhoneShowPlaysinline && (c += 'style="position:absolute;top:-200%;left:-200%"'),
        this.config.isHtml5UseUI && this.config.isHtml5ShowPosterOnStart && b.os.android && (c += b.browser.UC ? 'style="position:absolute;left:-200%;"' : 'style="position:absolute;top:-200%;"', setTimeout(function () {
//a813<
          if (__begin&&__YY__.S("a813", arguments)) {if(__E){eval(__YY__.gE("a813"));}else{debugger;}}
          if (d.videoTag && 1 == d.$video.size()) {
            var a = !1;
            d.$video.one("playing", function () {
//a814<
              if (__begin&&__YY__.S("a814", arguments)) {if(__E){eval(__YY__.gE("a814"));}else{debugger;}}
              a || (a = !0, d.videoTag.style.cssText = "")
            }).one("tvp:h5ui:playbtn:click", function () {
//a815<
              if (__begin&&__YY__.S("a815", arguments)) {if(__E){eval(__YY__.gE("a815"));}else{debugger;}}
              a || (a = !0, d.videoTag.style.cssText = "")
            })
          }
        }, 100));
...
//a816<
        if (__begin&&__YY__.S("a816", arguments)) {if(__E){eval(__YY__.gE("a816"));}else{debugger;}}
        var d = null;
...
//a817<
        if (__begin&&__YY__.S("a817", arguments)) {if(__E){eval(__YY__.gE("a817"));}else{debugger;}}
        function a() {
//a818<
          if (__begin&&__YY__.S("a818", arguments)) {if(__E){eval(__YY__.gE("a818"));}else{debugger;}}
          b.isFullScreen || setTimeout(function () {
//a819<
            if (__begin&&__YY__.S("a819", arguments)) {if(__E){eval(__YY__.gE("a819"));}else{debugger;}}
...
//a820<
          if (__begin&&__YY__.S("a820", arguments)) {if(__E){eval(__YY__.gE("a820"));}else{debugger;}}
          a()
        }, !1)
      }, resize: function (a, c) {
//a821<
        if (__begin&&__YY__.S("a821", arguments)) {if(__E){eval(__YY__.gE("a821"));}else{debugger;}}
...
//a822<
        if (__begin&&__YY__.S("a822", arguments)) {if(__E){eval(__YY__.gE("a822"));}else{debugger;}}
        var f = this;
        setTimeout(function () {
//a823<
          if (__begin&&__YY__.S("a823", arguments)) {if(__E){eval(__YY__.gE("a823"));}else{debugger;}}
...
//a824<
                if (__begin&&__YY__.S("a824", arguments)) {if(__E){eval(__YY__.gE("a824"));}else{debugger;}}
...
//a825<
        if (__begin&&__YY__.S("a825", arguments)) {if(__E){eval(__YY__.gE("a825"));}else{debugger;}}
        return b.inArray(a, this.config.html5VodUIFeature) >= 0
      }, isForbiddenH5UIFeature: function (a) {
//a826<
        if (__begin&&__YY__.S("a826", arguments)) {if(__E){eval(__YY__.gE("a826"));}else{debugger;}}
        return b.inArray(a, this.config.html5ForbiddenUIFeature) >= 0
      }, callProtectFn: function (a) {
//a827<
        if (__begin&&__YY__.S("a827", arguments)) {if(__E){eval(__YY__.gE("a827"));}else{debugger;}}
        b.isFunction(this.protectedFn[a]) && this.protectedFn[a].call(this)
      }, registerMonitor: function () {
//a828<
        if (__begin&&__YY__.S("a828", arguments)) {if(__E){eval(__YY__.gE("a828"));}else{debugger;}}
        b.isFunction(this.buildmonitor) && this.buildmonitor.call(this)
      }, bindEventAdapt: function () {
//a829<
        if (__begin&&__YY__.S("a829", arguments)) {if(__E){eval(__YY__.gE("a829"));}else{debugger;}}
...
//a830<
          if (__begin&&__YY__.S("a830", arguments)) {if(__E){eval(__YY__.gE("a830"));}else{debugger;}}
          var e = "on" + b.camelCase(d), f = c.h5EvtAdapter[e];
          (window.DEBUG || b.isFunction(f)) && c.$video.on(d.replace(/-/g, ""), function (a) {
//a831<
            if (__begin&&__YY__.S("a831", arguments)) {if(__E){eval(__YY__.gE("a831"));}else{debugger;}}
...
//a832<
    if (__begin&&__YY__.S("a832", arguments)) {if(__E){eval(__YY__.gE("a832"));}else{debugger;}}
    function c() {
//a833<
      if (__begin&&__YY__.S("a833", arguments)) {if(__E){eval(__YY__.gE("a833"));}else{debugger;}}
    ...
    function d(a, b) {
//a834<
      if (__begin&&__YY__.S("a834", arguments)) {if(__E){eval(__YY__.gE("a834"));}else{debugger;}}
      return
    }

    function e(c, d) {
//a835<
      if (__begin&&__YY__.S("a835", arguments)) {if(__E){eval(__YY__.gE("a835"));}else{debugger;}}
      this.videoTag = null, this.$video = null, this.config.width = a.$.filterXSS(c), this.config.height = a.$.filterXSS(d), this.protectedFn = {}, this.isUseControl = !0, b.extend(this.h5EvtAdapter, {
        onEnded: function () {
//a836<
          if (__begin&&__YY__.S("a836", arguments)) {if(__E){eval(__YY__.gE("a836"));}else{debugger;}}
...
//a837<
          if (__begin&&__YY__.S("a837", arguments)) {if(__E){eval(__YY__.gE("a837"));}else{debugger;}}
          var e = this;
          if (a.report({
              cmd: 3525,
...
//a838<
          if (__begin&&__YY__.S("a838", arguments)) {if(__E){eval(__YY__.gE("a838"));}else{debugger;}}
          var a = this;
          this.callCBEvent("onplaying", f, this.curVideo), this.isShowingDurationLimit() && this.pause(), setTimeout(function () {
//a839<
            if (__begin&&__YY__.S("a839", arguments)) {if(__E){eval(__YY__.gE("a839"));}else{debugger;}}
            a.isPlayingLoadingAd() || a.isPlayingSplit || a.goOnPlaying()
          }, 50)
        }, onTimeupdate: function () {
//a840<
          if (__begin&&__YY__.S("a840", arguments)) {if(__E){eval(__YY__.gE("a840"));}else{debugger;}}
          this.callCBEvent("ontimeupdate", f, this.$video), b.isFunction(this.setGoOnPlayingTime) && this.setGoOnPlayingTime()
        }, onPause: function () {
//a841<
          if (__begin&&__YY__.S("a841", arguments)) {if(__E){eval(__YY__.gE("a841"));}else{debugger;}}
...
//a842<
          if (__begin&&__YY__.S("a842", arguments)) {if(__E){eval(__YY__.gE("a842"));}else{debugger;}}
          var c = this, d = [];
          b.each(d, function (d, e) {
//a843<
            if (__begin&&__YY__.S("a843", arguments)) {if(__E){eval(__YY__.gE("a843"));}else{debugger;}}
            try {
              var f = "build" + e;
...
//a844<
          if (__begin&&__YY__.S("a844", arguments)) {if(__E){eval(__YY__.gE("a844"));}else{debugger;}}
...
//a845<
            if (__begin&&__YY__.S("a845", arguments)) {if(__E){eval(__YY__.gE("a845"));}else{debugger;}}
            c() && d(f.videoTag, f)
          }), b.os.android && b.browser.WeChat && this.$video.one("click", function () {
//a846<
            if (__begin&&__YY__.S("a846", arguments)) {if(__E){eval(__YY__.gE("a846"));}else{debugger;}}
            this.load()
          }), this.init_report_playtime()
        }, init_report_playtime: function () {
//a847<
          if (__begin&&__YY__.S("a847", arguments)) {if(__E){eval(__YY__.gE("a847"));}else{debugger;}}
...
//a848<
              if (__begin&&__YY__.S("a848", arguments)) {if(__E){eval(__YY__.gE("a848"));}else{debugger;}}
              return b.isFunction(g.isPlayingLoadingAd) && g.isPlayingLoadingAd() ? !0 : !1
            };
            this.$video.on("pause", function () {
//a849<
              if (__begin&&__YY__.S("a849", arguments)) {if(__E){eval(__YY__.gE("a849"));}else{debugger;}}
              l() || n()
            }).on("playing", function () {
//a850<
              if (__begin&&__YY__.S("a850", arguments)) {if(__E){eval(__YY__.gE("a850"));}else{debugger;}}
              setTimeout(function () {
//a851<
                if (__begin&&__YY__.S("a851", arguments)) {if(__E){eval(__YY__.gE("a851"));}else{debugger;}}
                l() || (n(), m())
              }, 100)
            }).on("ended", function () {
//a852<
              if (__begin&&__YY__.S("a852", arguments)) {if(__E){eval(__YY__.gE("a852"));}else{debugger;}}
              if (!l()) {
            ...
            var m = function () {
//a853<
              if (__begin&&__YY__.S("a853", arguments)) {if(__E){eval(__YY__.gE("a853"));}else{debugger;}}
              n(), e = setInterval(function () {
//a854<
                if (__begin&&__YY__.S("a854", arguments)) {if(__E){eval(__YY__.gE("a854"));}else{debugger;}}
...
//a855<
              if (__begin&&__YY__.S("a855", arguments)) {if(__E){eval(__YY__.gE("a855"));}else{debugger;}}
              e && clearInterval(e), e = null
            }, o = function (a, c, d) {
//a856<
              if (__begin&&__YY__.S("a856", arguments)) {if(__E){eval(__YY__.gE("a856"));}else{debugger;}}
...
//a857<
          if (__begin&&__YY__.S("a857", arguments)) {if(__E){eval(__YY__.gE("a857"));}else{debugger;}}
          var d = "", e = "";
          try {
          ...
          }, h = new Image, i = "//192.168.1.199/kvcollect?BossId=2803&Pwd=524422958&_dc=" + Math.random();
          i += "&" + b.param(g), h.src = i
        }
      }), b.extend(e.prototype, {
        pause: function () {
//a858<
          if (__begin&&__YY__.S("a858", arguments)) {if(__E){eval(__YY__.gE("a858"));}else{debugger;}}
          this.videoTag.pause()
        }, getCurVid: function () {
//a859<
          if (__begin&&__YY__.S("a859", arguments)) {if(__E){eval(__YY__.gE("a859"));}else{debugger;}}
          return "" === f ? this.curVideo instanceof a.VideoInfo ? this.curVideo.getVid() : "" : f
        }, play: function (c, d, e) {
//a860<
          if (__begin&&__YY__.S("a860", arguments)) {if(__E){eval(__YY__.gE("a860"));}else{debugger;}}
          //yumingvvv
          function g(e) {
//a861<
            if (__begin&&__YY__.S("a861", arguments)) {if(__E){eval(__YY__.gE("a861"));}else{debugger;}}
...
//a862<
              if (__begin&&__YY__.S("a862", arguments)) {if(__E){eval(__YY__.gE("a862"));}else{debugger;}}
...
//a863<
              if (__begin&&__YY__.S("a863", arguments)) {if(__E){eval(__YY__.gE("a863"));}else{debugger;}}
...
//a864<
              if (__begin&&__YY__.S("a864", arguments)) {if(__E){eval(__YY__.gE("a864"));}else{debugger;}}
              i.callCBEvent("onadplay")
            })), i.curVideo.defer_cache.vd[l].done(function (b) {
//a865<
              if (__begin&&__YY__.S("a865", arguments)) {if(__E){eval(__YY__.gE("a865"));}else{debugger;}}
...
//a866<
              if (__begin&&__YY__.S("a866", arguments)) {if(__E){eval(__YY__.gE("a866"));}else{debugger;}}

              i.$UILayer
              && "function" === b.type(i.$UILayer.find)
              && i.$UILayer.find(".tvp_player_error").remove(),i.curVideo.defer_cache.vd[l] = null,i.curVideo.defer_cache.ad[l] = null,c = "undefined" == typeof c ? !1 : c,b.os.android
              && b.browser.wechat
              && (a += "&nocache=1&time=" + (new Date).getTime()),i.isGetingInfo = !1,b.browser.WeChat,true
              && "setAttribute"in i.videoTag ? (a = 'http://192.168.1.101:8089/movieEnglish2.0/movieEnglishService/subtitle/MAKING_GOLD1.mp4', i.videoTag.setAttribute("src", a)) : i.videoTag.src = a, i.$video && i.$video.trigger && i.$video.trigger("tvp:video:src"), i._isInited || (i._isInited = !0, i.callCBEvent("oninited")), i.callCBEvent("onplay", i.curVideo.lastQueryVid, i.curVideo), (d || c) && (i.videoTag.load(), i.$video.trigger("overlay_ctrl_showloading"), i.videoTag.play());
...
//a867<
              if (__begin&&__YY__.S("a867", arguments)) {if(__E){eval(__YY__.gE("a867"));}else{debugger;}}
              a = a || h, i.$UILayer && i.$UILayer.find(".tvp_player_error").remove(), j(a)
            }).fail(function (b, c) {
//a868<
              if (__begin&&__YY__.S("a868", arguments)) {if(__E){eval(__YY__.gE("a868"));}else{debugger;}}
...
//a869<
              if (__begin&&__YY__.S("a869", arguments)) {if(__E){eval(__YY__.gE("a869"));}else{debugger;}}
...
//a870<
            if (__begin&&__YY__.S("a870", arguments)) {if(__E){eval(__YY__.gE("a870"));}else{debugger;}}
            l = 3 == a
          }).fail(function () {
//a871<
            if (__begin&&__YY__.S("a871", arguments)) {if(__E){eval(__YY__.gE("a871"));}else{debugger;}}
            l = !1
          }).always(function () {
//a872<
            if (__begin&&__YY__.S("a872", arguments)) {if(__E){eval(__YY__.gE("a872"));}else{debugger;}}
            g.call(i, l)
          }) : (l = !1, g.call(i, l)) : (l = e, g.call(i, l))
        }, goOnPlayingHandler: function (a, c, d) {
//a873<
          if (__begin&&__YY__.S("a873", arguments)) {if(__E){eval(__YY__.gE("a873"));}else{debugger;}}
...
//a874<
            if (__begin&&__YY__.S("a874", arguments)) {if(__E){eval(__YY__.gE("a874"));}else{debugger;}}
            if ("string" === b.type(c)) {
              var d = c.split("|");
...
//a875<
            if (__begin&&__YY__.S("a875", arguments)) {if(__E){eval(__YY__.gE("a875"));}else{debugger;}}
            h = [];
...
//a876<
          if (__begin&&__YY__.S("a876", arguments)) {if(__E){eval(__YY__.gE("a876"));}else{debugger;}}
...
//a877<
          if (__begin&&__YY__.S("a877", arguments)) {if(__E){eval(__YY__.gE("a877"));}else{debugger;}}
          if (!this.isPlayingSplit && this.config.isContinuePlay && !(this.getCurTime() > 3 || this.hasShowGoOnPlaying)) {
            var a = this.getCurVid(), a = this.curVideo.getVid(), b = this, c = this.goOnPlayingHandler("get", a), d = this.$mod.find('[data-role="xubo-banner"]'), e = this.$mod.find('[data-role="xubo-text"]'), f = e.html(), g = {};
            if (c) {
              c = parseInt(c), this.seek(c);
              var h = function () {
//a878<
                if (__begin&&__YY__.S("a878", arguments)) {if(__E){eval(__YY__.gE("a878"));}else{debugger;}}
...
//a879<
                  if (__begin&&__YY__.S("a879", arguments)) {if(__E){eval(__YY__.gE("a879"));}else{debugger;}}
                  d.addClass("tvp_none")
                }, 3e3))
              };
              h()
...
//a880<
          if (__begin&&__YY__.S("a880", arguments)) {if(__E){eval(__YY__.gE("a880"));}else{debugger;}}
          if (!isNaN(a)) {
...
//a881<
              if (__begin&&__YY__.S("a881", arguments)) {if(__E){eval(__YY__.gE("a881"));}else{debugger;}}
              b.seek(a)
            }, 100)
          }
        }, seekTo: function (a) {
//a882<
          if (__begin&&__YY__.S("a882", arguments)) {if(__E){eval(__YY__.gE("a882"));}else{debugger;}}
          var b = this;
          try {
...
//a883<
              if (__begin&&__YY__.S("a883", arguments)) {if(__E){eval(__YY__.gE("a883"));}else{debugger;}}
              b.videoTag.currentTime = a, b.videoTag.paused && b.videoTag.play()
            })
          }
        }, getCurTime: function () {
//a884<
          if (__begin&&__YY__.S("a884", arguments)) {if(__E){eval(__YY__.gE("a884"));}else{debugger;}}
          return this.videoTag.currentTime
        }, getPlaytime: function () {
//a885<
          if (__begin&&__YY__.S("a885", arguments)) {if(__E){eval(__YY__.gE("a885"));}else{debugger;}}
          return this.getCurTime()
        }, getRealPlayTime: function () {
//a886<
          if (__begin&&__YY__.S("a886", arguments)) {if(__E){eval(__YY__.gE("a886"));}else{debugger;}}
          var b = this;
          return b instanceof a.Html5Player || (b = b.instance), b.realPlayTime || 0
        }, setPlaytime: function (a) {
//a887<
          if (__begin&&__YY__.S("a887", arguments)) {if(__E){eval(__YY__.gE("a887"));}else{debugger;}}
          this.seek(a)
        }, checkIsPlayingLoop: function (a) {
//a888<
          if (__begin&&__YY__.S("a888", arguments)) {if(__E){eval(__YY__.gE("a888"));}else{debugger;}}
          a = a || 0;
          var b = this;
...
//a889<
            if (__begin&&__YY__.S("a889", arguments)) {if(__E){eval(__YY__.gE("a889"));}else{debugger;}}
            b.checkIsPlayingLoop(++a)
          }, 1e3))
        }, setPoster: function () {
//a890<
          if (__begin&&__YY__.S("a890", arguments)) {if(__E){eval(__YY__.gE("a890"));}else{debugger;}}
...
//a891<
          if (__begin&&__YY__.S("a891", arguments)) {if(__E){eval(__YY__.gE("a891"));}else{debugger;}}
          this.videoTag.removeAttribute("poster")
        }, getDuration: function () {
//a892<
          if (__begin&&__YY__.S("a892", arguments)) {if(__E){eval(__YY__.gE("a892"));}else{debugger;}}
          var a = this.curVideo.getDuration();
          return !isNaN(a) && a > 0 ? a : this.videoTag.duration
        }, getFileSize: function () {
//a893<
          if (__begin&&__YY__.S("a893", arguments)) {if(__E){eval(__YY__.gE("a893"));}else{debugger;}}
          var a = "function" == typeof this.curVideo.getFileSize ? this.curVideo.getFileSize() : 0;
          return !isNaN(a) && a > 0 ? a : 0
        }, checkPause: function () {
//a894<
          if (__begin&&__YY__.S("a894", arguments)) {if(__E){eval(__YY__.gE("a894"));}else{debugger;}}
          var a = [], b = this;
          g = setInterval(function () {
//a895<
            if (__begin&&__YY__.S("a895", arguments)) {if(__E){eval(__YY__.gE("a895"));}else{debugger;}}
...
//a896<
          if (__begin&&__YY__.S("a896", arguments)) {if(__E){eval(__YY__.gE("a896"));}else{debugger;}}
          var a = 1 == this.$video.attr("data-playing-loadingad") || 1 == this.$video.attr("data-playing-adonend");
          return a
        }, isPlayingFrontAd: function () {
//a897<
          if (__begin&&__YY__.S("a897", arguments)) {if(__E){eval(__YY__.gE("a897"));}else{debugger;}}
          return 1 == this.$video.attr("data-playing-loadingad")
        }, isPlayingEndAd: function () {
//a898<
          if (__begin&&__YY__.S("a898", arguments)) {if(__E){eval(__YY__.gE("a898"));}else{debugger;}}
          return 1 == this.$video.attr("data-playing-adonend")
        }, isShowingDurationLimit: function () {
//a899<
          if (__begin&&__YY__.S("a899", arguments)) {if(__E){eval(__YY__.gE("a899"));}else{debugger;}}
          return this.hasDurationLimit() && this.DurationLimitInstance.isShow
        }, hasDurationLimit: function () {
//a900<
          if (__begin&&__YY__.S("a900", arguments)) {if(__E){eval(__YY__.gE("a900"));}else{debugger;}}
...
//a901<
    if (__begin&&__YY__.S("a901", arguments)) {if(__E){eval(__YY__.gE("a901"));}else{debugger;}}
    function c(b, c) {
//a902<
      if (__begin&&__YY__.S("a902", arguments)) {if(__E){eval(__YY__.gE("a902"));}else{debugger;}}
      var d = {
        cmd: 3543,
    ...
    function d() {
//a903<
      if (__begin&&__YY__.S("a903", arguments)) {if(__E){eval(__YY__.gE("a903"));}else{debugger;}}
      var c = {
        cmd: 2,
        qq: a.common.getUin(),
...
//a904<
        if (__begin&&__YY__.S("a904", arguments)) {if(__E){eval(__YY__.gE("a904"));}else{debugger;}}
        d[a] = b.getUrlParam(a)
      }), b.extend(c, d), b.os.windows && (c.system = 0), (b.os.iphone || b.os.ipod) && (c.system = 1, c.sdtfrom = 113), b.os.ipad && (c.sdtfrom = 213), b.os.android && (c.system = 2, c.sdtfrom = 313), b.os.mac && (c.system = 3), c
    }

    function e(b, c) {
//a905<
      if (__begin&&__YY__.S("a905", arguments)) {if(__E){eval(__YY__.gE("a905"));}else{debugger;}}
      a.livehub && a.livehub.stepReport && a.livehub.stepReport(b, c)
    }

    function f() {
//a906<
      if (__begin&&__YY__.S("a906", arguments)) {if(__E){eval(__YY__.gE("a906"));}else{debugger;}}
      var b = this;
      this.$video.off("tvp:loading:livereport").on("tvp:loading:livereport", function (c, d) {
//a907<
        if (__begin&&__YY__.S("a907", arguments)) {if(__E){eval(__YY__.gE("a907"));}else{debugger;}}
        var e;
        d && (e = d.step), e && a.bossReport.h5_live_quality({
          step: e,
          playno: i,
    ...
    function g(d, e) {
//a908<
      if (__begin&&__YY__.S("a908", arguments)) {if(__E){eval(__YY__.gE("a908"));}else{debugger;}}
      this.config.width = a.$.filterXSS(d), this.config.height = a.$.filterXSS(e), this.videoTag = null, this.$video = null, this.protectedFn = {}, this.isUseControl = !0, b.extend(this.h5EvtAdapter, {
        onPlay: function () {
//a909<
          if (__begin&&__YY__.S("a909", arguments)) {if(__E){eval(__YY__.gE("a909"));}else{debugger;}}
          this.report_time = {onplay: (new Date).valueOf()}
        }, onPlaying: function () {
//a910<
          if (__begin&&__YY__.S("a910", arguments)) {if(__E){eval(__YY__.gE("a910"));}else{debugger;}}
          var d = this;
          this.callCBEvent("onplaying", this.curVideo.getChannelId(), this.curVideo), this.hasReportCanPlayHls || (this.hasReportCanPlayHls = !0, c(d, 1)), setTimeout(function () {
//a911<
            if (__begin&&__YY__.S("a911", arguments)) {if(__E){eval(__YY__.gE("a911"));}else{debugger;}}
            var c = !1;
            d.$video && "function" === b.type(d.$video.attr) && (c = "1" === d.$video.attr("data-playing-loadingad") ? !0 : !1), d.hasReportH5Live || c || (d.hasReportH5Live = !0, d.report_time.onplaying = (new Date).valueOf(), d.report_h5_live({
              ...
              block: 0,
              prd: 0
            }), d.report_event(), a.bossReport.h5_live_quality({
              step: 6,
              playno: i,
...
//a912<
          if (__begin&&__YY__.S("a912", arguments)) {if(__E){eval(__YY__.gE("a912"));}else{debugger;}}
          function f(a) {
//a913<
            if (__begin&&__YY__.S("a913", arguments)) {if(__E){eval(__YY__.gE("a913"));}else{debugger;}}
            var c = [2, 3, 4, 6, 25, 28, 50, "video_1", "video_2", "video_3", "video_4"];
            return b.inArray(a, c) > -1 ? !0 : !1
          }

          d = d || {};
          var g = this;
          c(g, 0);
          var h = -1, j = g.getCurVideo();
          e && e.target && e.target.error && (h = e.target.error.code);
          var k;
          if (d && d.hasOwnProperty("iretcode") ? k = d.iretcode : -1 !== h && (k = "video_" + h), this.report_h5_live({
              errcode: h,
              playno: i
            }), f(k) && (g.onerrorRetryTimes || (g.onerrorRetryTimes = 0), g.onerrorRetryTimes++, g.onerrorRetryTimes < 4))return void g.play(j, !0);
          b.each(a.html5LiveFrontShow.plugins, function (a, b) {
//a914<
            if (__begin&&__YY__.S("a914", arguments)) {if(__E){eval(__YY__.gE("a914"));}else{debugger;}}
            if ("liveDownloader" == b.name) {
              var c;
              j && (c = j.getChannelId()), new b.key(g, {code: k, msg: d.errinfo, lid: c})
            }
          });
          var l = d.errinfo;
          if (!l) {
    ...
    if (!a.Html5LiveTiny) {
      var h = !1, i = a.$.newGuid(), j = "tvp_report_h5_live", k = b.getData(j);
      k || (k = a.$.newGuid(), b.setData(j, k)), g.fn = g.prototype = new a.BaseHtml5, b.extend(g.fn, {
        write: function (b) {
//a915<
          if (__begin&&__YY__.S("a915", arguments)) {if(__E){eval(__YY__.gE("a915"));}else{debugger;}}
          a.BaseHtml5.prototype.write.call(this, b), this.callProtectFn("onwrite"), this.callCBEvent("onwrite"), this.callCBEvent("onready"), this.play(this.curVideo, this.config.autoplay), f.call(this)
        }, play: function (c, f) {
//a916<
          if (__begin&&__YY__.S("a916", arguments)) {if(__E){eval(__YY__.gE("a916"));}else{debugger;}}
          function g(a) {
//a917<
            if (__begin&&__YY__.S("a917", arguments)) {if(__E){eval(__YY__.gE("a917"));}else{debugger;}}
            j.videoTag.src = a, j.$video && j.$video.trigger && j.$video.trigger("tvp:video:src"), h || (h = !0, j.callCBEvent("oninited")), j.videoTag.pause(), f && (j.videoTag.load(), j.videoTag.play()), j.callCBEvent("onchange", j.curVideo.getChannelId()), j.liveStatusMonitor()
          }
          ...
          var l, m = this.config.playUrl, n = {cnlid: c.getChannelId(), host: a.$.getHost()};
          n = b.extend(n, d()), j.config && j.config.hasOwnProperty("livepid") && j.config.livepid && (n.livepid = j.config.livepid);
          var o, p = b.Deferred(), q = b.Deferred();
          if (m) {
            if (!/.*\.?qq\.com$/.test(n.host) && !/.*\.?qq\.com$/.test(m))throw e(10, {config: j.config}), new Error("\u5f53\u524d\u57df\u6216\u8005\u64ad\u653e\u5730\u5740\u4e0d\u5728\u767d\u540d\u5355\u5185!");
            l = m, e(9, {config: j.config}), p.resolve(l)
          } else {
            e(11, {config: j.config});
            var r = b.now();
            b.ajax({url: a.common.get_request_url("zb"), data: n, dataType: "jsonp"}).done(function (d, f) {
//a918<
              if (__begin&&__YY__.S("a918", arguments)) {if(__E){eval(__YY__.gE("a918"));}else{debugger;}}
              j.rs_cache = d, f = b.now() - r, d && 0 == d.iretcode || p.reject(d), d.playurl ? (e(12, {
                delay: f,
                config: j.config
                ...
                tpay: d.ispay,
                cpay: d.isuserpay
              }), o = d.playurl, p.resolve(d.playurl), j.play_limit(d)) : (e(13, {
                delay: f,
                config: j.config,
                code: d.iretcode
              }), p.reject(d))
...
//a919<
              if (__begin&&__YY__.S("a919", arguments)) {if(__E){eval(__YY__.gE("a919"));}else{debugger;}}
              c = b.now() - r, e(14, {delay: c, config: j.config}), p.reject(a)
            })
          }
          a.Html5UI && b.isFunction(a.Html5UI.fn.buildloadingAd) && j.config.isHtml5UseUI && (j.config.isHtml5ShowLoadingAdOnStart || j.config.isHtml5ShowLoadingAdOnChange) ? (j.$video.attr("tvp_loadingad_ended", 1), j.$video.off("tvp:loadingad:ended").on("tvp:loadingad:ended", function (a, b) {
//a920<
            if (__begin&&__YY__.S("a920", arguments)) {if(__E){eval(__YY__.gE("a920"));}else{debugger;}}
            j.config.autoplayAfterLoadingad && b && !b.emptyAd && (f = !0), q.resolve()
          })) : q.resolve(), b.when(p, q).done(function (a) {
//a921<
            if (__begin&&__YY__.S("a921", arguments)) {if(__E){eval(__YY__.gE("a921"));}else{debugger;}}
            g(o)
          }).fail(function (a) {
//a922<
            if (__begin&&__YY__.S("a922", arguments)) {if(__E){eval(__YY__.gE("a922"));}else{debugger;}}
            j.h5EvtAdapter.onError.call(j, a)
          })
        }, play_limit: function (a) {
//a923<
          if (__begin&&__YY__.S("a923", arguments)) {if(__E){eval(__YY__.gE("a923"));}else{debugger;}}
          function c() {
//a924<
            if (__begin&&__YY__.S("a924", arguments)) {if(__E){eval(__YY__.gE("a924"));}else{debugger;}}
            var a, c = '<span class="tvp_text">\u8bd5\u770b{$min}\u5206\u949f</span>';
            "number" === b.type(d) && (a = 60 > d ? 1 : Math.round(d / 60), c = c.replace("{$min}", a), e.$UILayer.find(".tvp_overlay_play").addClass("tvp_overlay_play_try").append(c))
          }

          if (!this.hasPlayInit && a.endplaytime && !(a.endplaytime - a.svrtick <= 0)) {
            this.hasPlayInit = !0;
            var d = a.endplaytime - a.svrtick, e = this;
            c(), this.$video.on("timeupdate", function () {
//a925<
              if (__begin&&__YY__.S("a925", arguments)) {if(__E){eval(__YY__.gE("a925"));}else{debugger;}}
              this.currentTime && d - parseInt(this.currentTime) <= 0 && (e.$video && e.$video[0] && (e.$video[0].pause && e.$video[0].pause(), e.$video.remove()), e.callCBEvent("onerror"))
            })
          }
        }, liveStatusMonitor: function () {
//a926<
          if (__begin&&__YY__.S("a926", arguments)) {if(__E){eval(__YY__.gE("a926"));}else{debugger;}}
          function c() {
//a927<
            if (__begin&&__YY__.S("a927", arguments)) {if(__E){eval(__YY__.gE("a927"));}else{debugger;}}
          ...
          function d() {
//a928<
            if (__begin&&__YY__.S("a928", arguments)) {if(__E){eval(__YY__.gE("a928"));}else{debugger;}}
            h = {
          ...
          function e() {
//a929<
            if (__begin&&__YY__.S("a929", arguments)) {if(__E){eval(__YY__.gE("a929"));}else{debugger;}}
            g.liveStatusTimer && clearTimeout(g.liveStatusTimer), g.liveStatusTimer = null, f()
          }

          function f() {
//a930<
            if (__begin&&__YY__.S("a930", arguments)) {if(__E){eval(__YY__.gE("a930"));}else{debugger;}}
            "https:" !== location.protocol && (g.liveStatusTimer || (g.liveStatusTimer = setTimeout(function () {
//a931<
              if (__begin&&__YY__.S("a931", arguments)) {if(__E){eval(__YY__.gE("a931"));}else{debugger;}}
              var d = "http://192.168.1.199/fcgi-bin/live_poll?otype=json&callback=?", f = {
                guid: h.guid || b.newGuid(),
                qqlog: c()
              }, i = {pid: h.livepid, type: "concert"};
              d += "&" + b.param(f), i = encodeURIComponent(b.param(i)), d += "&pollDataKey=" + i;
              var j = function () {
//a932<
                if (__begin&&__YY__.S("a932", arguments)) {if(__E){eval(__YY__.gE("a932"));}else{debugger;}}
                return "tvp_live_pool_jsonp_" + a.$.newGuid().substr(-1)
              };
              b.ajax({url: d, jsonpCallback: j(), type: "jsonp"}).done(function (a) {
//a933<
                if (__begin&&__YY__.S("a933", arguments)) {if(__E){eval(__YY__.gE("a933"));}else{debugger;}}
                return g.liveStatusTimer = null, a && a.pollTimeOut && (h.timeout = 1e3 * parseInt(a.pollTimeOut)), a && 3 === a.liveStatus ? (g.showError(403, 0), g.videoTag.pause(), void b(g.videoTag).removeAttr("src")) : void e()
              }).fail(function (a, b) {
//a934<
                if (__begin&&__YY__.S("a934", arguments)) {if(__E){eval(__YY__.gE("a934"));}else{debugger;}}
                g.liveStatusTimer = null, h.timeout = 3e4, e()
              })
            }, h.timeout)))
          }
...
//a935<
              if (__begin&&__YY__.S("a935", arguments)) {if(__E){eval(__YY__.gE("a935"));}else{debugger;}}
              d(), g.liveStatusTimer || f()
            }), b(this.videoTag).off("error.live_monitor").on("error.live_monitor", function () {
//a936<
              if (__begin&&__YY__.S("a936", arguments)) {if(__E){eval(__YY__.gE("a936"));}else{debugger;}}
              g.liveStatusTimer && clearTimeout(g.liveStatusTimer), g.liveStatusTimer = null
            })
          }
        }, report_event: function () {
//a937<
          if (__begin&&__YY__.S("a937", arguments)) {if(__E){eval(__YY__.gE("a937"));}else{debugger;}}
          var a, b, c = this.$video, d = "", e = this, f = 0, g = 0, h = 0, j = 0, k = !1;
          c.on("pause", function () {
//a938<
            if (__begin&&__YY__.S("a938", arguments)) {if(__E){eval(__YY__.gE("a938"));}else{debugger;}}
            d = "pause"
          }).on("playing", function () {
//a939<
            if (__begin&&__YY__.S("a939", arguments)) {if(__E){eval(__YY__.gE("a939"));}else{debugger;}}
            d = "play"
          }).on("play", function () {
//a940<
            if (__begin&&__YY__.S("a940", arguments)) {if(__E){eval(__YY__.gE("a940"));}else{debugger;}}
            d = "play"
          }).on("timeupdate", function () {
//a941<
            if (__begin&&__YY__.S("a941", arguments)) {if(__E){eval(__YY__.gE("a941"));}else{debugger;}}
            a = this.currentTime
          }), setInterval(function () {
//a942<
            if (__begin&&__YY__.S("a942", arguments)) {if(__E){eval(__YY__.gE("a942"));}else{debugger;}}
            b || (b = a), "pause" !== d && (a > b ? (d = "playing", k = !1) : (d = "waiting", k || (h += 1), k = !0, j += 1)), b = a > b ? a : b, 60 === f && (j = j > 60 ? 60 : j, e.report_h5_live({
              prd: 1e3 * g,
              blocktime: 1e3 * j,
              block: h,
              firstload: 0,
              playno: i
            }), f = 0, h = 0, j = 0, g = 0), "pause" !== d && (f += 1, g += 1)
          }, 1e3)
        }, report_h5_live: function (c) {
//a943<
          if (__begin&&__YY__.S("a943", arguments)) {if(__E){eval(__YY__.gE("a943"));}else{debugger;}}
          c = c || {};
          var d = this, e = d.$video.attr("src"), f = function (a) {
//a944<
            if (__begin&&__YY__.S("a944", arguments)) {if(__E){eval(__YY__.gE("a944"));}else{debugger;}}
            return "undefined" == typeof a ? "" : a
          }, g = this.getCurVideo(), h = g.getChannelId(), i = a.$.getUrlParam("cdn", e), j = a.common.get_stdfrom(), l = a.common.getDeviceId(), m = c.playno || a.$.newGuid(), n = f(c.firstload) || 0, o = f(c.errcode) || 0, p = f(c.blocktime) || 0, q = f(c.block) || 0, r = f(c.firstreport) || 0, s = f(c.prd) || 0, t = "";
          this.config && this.config.hasOwnProperty("livepid") && this.config.livepid && (t = this.config.livepid);
          var u = {
            prog: h,
            playno: m,
            guid: k,
            ...
            sbiz: "",
            livepid: t
          }, v = new Image, w = "http://192.168.1.199/kvcollect?BossId=2727&Pwd=1424084450&_dc=" + Math.random();
          w += "&" + b.param(u), v.src = w
        }, isPlayingLoadingAd: function () {
//a945<
          if (__begin&&__YY__.S("a945", arguments)) {if(__E){eval(__YY__.gE("a945"));}else{debugger;}}
          var a = 1 == this.$video.attr("data-playing-loadingad") || 1 == this.$video.attr("data-playing-adonend");
          return a
        }
      }), a.Html5LiveTiny = g, a.Html5LiveTiny.maxId = 0
    }
  }(tvp, tvp.$), function (a, b) {
//a946<
    if (__begin&&__YY__.S("a946", arguments)) {if(__E){eval(__YY__.gE("a946"));}else{debugger;}}
    function c(a) {
//a947<
      if (__begin&&__YY__.S("a947", arguments)) {if(__E){eval(__YY__.gE("a947"));}else{debugger;}}
    ...
    b.extend(c.prototype, {
      build: function (c) {
//a948<
        if (__begin&&__YY__.S("a948", arguments)) {if(__E){eval(__YY__.gE("a948"));}else{debugger;}}
        if (c && 1 === c.config.type && !b.os.windows) {
          var d = this, e = c.config.html5LiveFrontShow;
          b.each(e, function (e, f) {
//a949<
            if (__begin&&__YY__.S("a949", arguments)) {if(__E){eval(__YY__.gE("a949"));}else{debugger;}}
            b.each(a.html5LiveFrontShow.plugins, function (a, b) {
//a950<
              if (__begin&&__YY__.S("a950", arguments)) {if(__E){eval(__YY__.gE("a950"));}else{debugger;}}
      ...
      plugins: [], create: function (a) {
//a951<
        if (__begin&&__YY__.S("a951", arguments)) {if(__E){eval(__YY__.gE("a951"));}else{debugger;}}
        return a.html5LiveFrontShowInstance = new c(a), a.html5LiveFrontShowInstance
      }
    }
  }(tvp, tvp.$), function (a, b) {
//a952<
    if (__begin&&__YY__.S("a952", arguments)) {if(__E){eval(__YY__.gE("a952"));}else{debugger;}}
    function c(a, b) {
//a953<
      if (__begin&&__YY__.S("a953", arguments)) {if(__E){eval(__YY__.gE("a953"));}else{debugger;}}
      this.build(a, b)
    }
    ...
    var d = {
      ...
      video_3: "\u76f4\u64ad\u89c6\u9891\u64ad\u653e\u5931\u8d25",
      video_4: "\u76f4\u64ad\u89c6\u9891\u64ad\u653e\u5931\u8d25"
    }, e = {name: "liveDownloader"};
    a.html5LiveFrontShow.plugins.push({name: "liveDownloader", key: c}), b.extend(c.prototype, {
      build: function (c, f) {
//a954<
        if (__begin&&__YY__.S("a954", arguments)) {if(__E){eval(__YY__.gE("a954"));}else{debugger;}}
        function g(a) {
//a955<
          if (__begin&&__YY__.S("a955", arguments)) {if(__E){eval(__YY__.gE("a955"));}else{debugger;}}
          return b.inArray(a, [2, 3, 4, 5, 6, 7, 8, 9, 15, 16, 22, 23, 25, 28, 30, 31, 32, 45, 48, 50, 51, 104, "video_1", "video_2", "video_3", "video_4"]) > -1 ? !0 : !1
        }

        if (f = f || {}, c && 1 === c.config.type) {
          !f.msg && f.code && (f.msg = d[f.code]), f.msg || (f.msg = "\u672a\u77e5\u9519\u8bef");
          var h = a.html5skin[e.name], i = a.html5lang[e.name];
          i.iframe = window != top ? 'target="_parent"' : "", i.url = a.app.getDownloadUrl(), this.renderData = i, 20 === f.code ? this.renderData.btnText = "\u53bb\u817e\u8baf\u89c6\u9891\u770b\u6b63\u7248\u76f4\u64ad" : this.renderData.btnText = "\u770b\u770b\u522b\u7684\u89c6\u9891", b.extend(this.renderData, f), h = b.formatTpl(h, i), this.t = c, this.lid = c.curVideo.getChannelId();
          var j = c.$UILayer || c.$videomod;
          this.$mod = j, j.addClass("tvp_container"), this.element = b(h).appendTo(j), this.$errmsg = this.element.find('[data-role="tvp_errormsg"]'), this.$errcode = this.element.find('[data-role="tvp_errrocode"]'), this.$refresh = this.element.find('[data-role="tvp_err_refresh"]'), this.$btn = this.element.find('[data-role="tvp_error_btn"]'), g(f.code) ? this.$refresh.removeClass("tvp_none") : this.$refresh.addClass("tvp_none"), this._checkBtn(), this._bindEvents()
        }
      }, _checkBtn: function () {
//a956<
        if (__begin&&__YY__.S("a956", arguments)) {if(__E){eval(__YY__.gE("a956"));}else{debugger;}}
        var b = this, c = this.$btn;
        a.app.check({lid: b.lid, t: b.t}).done(function (a) {
//a957<
          if (__begin&&__YY__.S("a957", arguments)) {if(__E){eval(__YY__.gE("a957"));}else{debugger;}}
          b.hasApp = a.hasApp, a && a.hasApp ? c.attr({
            href: a.liveOpenUrl,
            "data-url": a.url
          }) : a && a.url && c.attr({
            href: a.url,
            "data-url": a.liveOpenUrl
          }), b.promotionId = b.t.config.livePromotionId || 140, c.attr("data-promotionid", b.promotionId), b.downloadUrl = a.url, b.bindDownloader(c, c)
        })
      }, bindDownloader: function (c, d) {
//a958<
        if (__begin&&__YY__.S("a958", arguments)) {if(__E){eval(__YY__.gE("a958"));}else{debugger;}}
        var e = this, f = "string" === b.type(this.t.config.downloaderCallback) ? this.t.config.downloaderCallback : !1, g = {
          downloader: !0,
...
//a959<
            if (__begin&&__YY__.S("a959", arguments)) {if(__E){eval(__YY__.gE("a959"));}else{debugger;}}
            b && b.md5 && (e.md5 = b.md5, h.downloadMd5 = b.md5, g.md5 = b.md5), a.app.checkCanDownloader(e.hasApp, g, h)
          }), this.onDownloaderStatusChange()
        }
      }, onDownloaderStatusChange: function () {
//a960<
        if (__begin&&__YY__.S("a960", arguments)) {if(__E){eval(__YY__.gE("a960"));}else{debugger;}}
        function a(a) {
//a961<
          if (__begin&&__YY__.S("a961", arguments)) {if(__E){eval(__YY__.gE("a961"));}else{debugger;}}
          var c = "";
          "downloading" === a ? c = "\u6b63\u5728\u4e0b\u8f7d\u817e\u8baf\u89c6\u9891" : "pause" === a ? c = "\u5df2\u6682\u505c\uff0c\u70b9\u51fb\u6062\u590d\u4e0b\u8f7d" : "complete" === a ? (c = "\u4e0b\u8f7d\u5df2\u5b8c\u6210\uff0c\u70b9\u51fb\u5b89\u88c5",
            a = "install") : "afterInstall" === a ? c = "\u5df2\u6682\u505c\uff0c\u70b9\u51fb\u6062\u590d\u4e0b\u8f7d" : "hasapp" === a && (c = b.renderData.btnText), c || (c = b.renderData.btnText), b.$btn.html(c), b.$btn.attr("data-status", a)
        }

        var b = this;
        this.$btn.on("tvp:appdownload:complete", function () {
//a962<
          if (__begin&&__YY__.S("a962", arguments)) {if(__E){eval(__YY__.gE("a962"));}else{debugger;}}
          a("complete")
        }).on("tvp:appdownload:downloading", function () {
//a963<
          if (__begin&&__YY__.S("a963", arguments)) {if(__E){eval(__YY__.gE("a963"));}else{debugger;}}
          a("downloading")
        }).on("tvp:appdownload:pause", function () {
//a964<
          if (__begin&&__YY__.S("a964", arguments)) {if(__E){eval(__YY__.gE("a964"));}else{debugger;}}
          a("pause")
        }).on("tvp:appdownload:afterInstall", function () {
//a965<
          if (__begin&&__YY__.S("a965", arguments)) {if(__E){eval(__YY__.gE("a965"));}else{debugger;}}
          a("afterInstall")
        }).on("tvp:appdownload:hasapp", function () {
//a966<
          if (__begin&&__YY__.S("a966", arguments)) {if(__E){eval(__YY__.gE("a966"));}else{debugger;}}
          a("hasapp")
        })
      }, _bindEvents: function () {
//a967<
        if (__begin&&__YY__.S("a967", arguments)) {if(__E){eval(__YY__.gE("a967"));}else{debugger;}}
        var a = this;
        this.$btn.on("click", function () {
//a968<
          if (__begin&&__YY__.S("a968", arguments)) {if(__E){eval(__YY__.gE("a968"));}else{debugger;}}
          a._report(1)
        })
      }, _report: function (b) {
//a969<
        if (__begin&&__YY__.S("a969", arguments)) {if(__E){eval(__YY__.gE("a969"));}else{debugger;}}
        var c = this.t, d = {
          cmd: 3542,
...
//a970<
    if (__begin&&__YY__.S("a970", arguments)) {if(__E){eval(__YY__.gE("a970"));}else{debugger;}}
    b.extend(a.BaseHtml5.fn, {
      enterFullScreen: function () {
//a971<
        if (__begin&&__YY__.S("a971", arguments)) {if(__E){eval(__YY__.gE("a971"));}else{debugger;}}
        ...
        if (this.videoTag.webkitSupportsFullscreen)if (this.videoTag.readyState >= 1)this.videoTag.webkitEnterFullscreen(); else {
          ...
          setTimeout(function () {
//a972<
            if (__begin&&__YY__.S("a972", arguments)) {if(__E){eval(__YY__.gE("a972"));}else{debugger;}}
            a.enterFullScreen()
          }, 200)
        }
      }
...
//a973<
    if (__begin&&__YY__.S("a973", arguments)) {if(__E){eval(__YY__.gE("a973"));}else{debugger;}}
    b.extend(a.Html5Tiny.fn, {
      swtichDefinition: function (a) {
//a974<
        if (__begin&&__YY__.S("a974", arguments)) {if(__E){eval(__YY__.gE("a974"));}else{debugger;}}
...
//a975<
            if (__begin&&__YY__.S("a975", arguments)) {if(__E){eval(__YY__.gE("a975"));}else{debugger;}}
            c.isDefinitionSwitching && (setTimeout(function () {
//a976<
              if (__begin&&__YY__.S("a976", arguments)) {if(__E){eval(__YY__.gE("a976"));}else{debugger;}}
              c.seek(b)
            }, 500), d = setInterval(function () {
//a977<
              if (__begin&&__YY__.S("a977", arguments)) {if(__E){eval(__YY__.gE("a977"));}else{debugger;}}
...
//a978<
    if (__begin&&__YY__.S("a978", arguments)) {if(__E){eval(__YY__.gE("a978"));}else{debugger;}}
    function c() {
//a979<
      if (__begin&&__YY__.S("a979", arguments)) {if(__E){eval(__YY__.gE("a979"));}else{debugger;}}
      this.start = a.$.now(), this.end = 0
    }

    function d(d, e) {
//a980<
      if (__begin&&__YY__.S("a980", arguments)) {if(__E){eval(__YY__.gE("a980"));}else{debugger;}}
      ...
      var f = b.isFunction(e.getPlayerType) ? e.getPlayerType().toUpperCase() : "", g = "http://192.168.1.199/report/play?", h = this.getplatform(), i = ["TenPlayer", f, "V2.0"].join(""), j = {
        version: i,
        vid: this.vid,
        rid: this.rid,
        pid: this.pid,
...
//a981<
        if (__begin&&__YY__.S("a981", arguments)) {if(__E){eval(__YY__.gE("a981"));}else{debugger;}}
        return "report_" + a
      }, this.addStep = function (a) {
//a982<
        if (__begin&&__YY__.S("a982", arguments)) {if(__E){eval(__YY__.gE("a982"));}else{debugger;}}
        this.reportTimer[this.getStepName(a)] = new c
      }, this.delStep = function (a) {
//a983<
        if (__begin&&__YY__.S("a983", arguments)) {if(__E){eval(__YY__.gE("a983"));}else{debugger;}}
        delete this.reportTimer[this.getStepName(a)]
      }, this.report = function (c, d, f) {
//a984<
        if (__begin&&__YY__.S("a984", arguments)) {if(__E){eval(__YY__.gE("a984"));}else{debugger;}}
        var h = [], i = {}, k = {}, l = g;
        if (c) {
          ...
          i.vurl = e.curVideo.url, i.bt = parseInt(e.getDuration(), 10), b.extend(k, i), k.step = c, k.ctime = b.getISOTimeFormat(), k.val = d, e && e.config && e.config.isShortVideo ? k.isshortvd = 1 : k.isshortvd = 0, k.opensource = {
            ...
            "192.168.1.199": 2,
            "192.168.1.199": 3
          }[a.$.getUrlParam("openS") || e.config.openS], k.opensource || (k.opensource = 0), e.config.openS && /^\d+$/.test(e.config.openS + "") && (k.opensource = e.config.openS), e.curVideo && e.curVideo.getGuid && (k.cmid = e.curVideo.getGuid()), k.ua = a.common.getReportUA && a.common.getReportUA(), k.hh_ref = a.common.getTopFrameUrl && a.common.getTopFrameUrl(), k.hh_ref = encodeURIComponent(k.hh_ref), k.url = encodeURIComponent(k.url);
          for (var n in k) {
            var o = k[n];
...
//a985<
        if (__begin&&__YY__.S("a985", arguments)) {if(__E){eval(__YY__.gE("a985"));}else{debugger;}}
...
//a986<
        if (__begin&&__YY__.S("a986", arguments)) {if(__E){eval(__YY__.gE("a986"));}else{debugger;}}
        if (this.end = a.$.now(), this.end <= 0 || this.start <= 0)return 0;
        var b = this.end - this.start;
        return 0 >= b ? 0 : b
      }, getSeconds: function () {
//a987<
        if (__begin&&__YY__.S("a987", arguments)) {if(__E){eval(__YY__.gE("a987"));}else{debugger;}}
        return parseInt(this.getTimelong() / 1e3, 10)
      }
    }, d.fn = d.prototype = {
      getBusinessId: function () {
//a988<
        if (__begin&&__YY__.S("a988", arguments)) {if(__E){eval(__YY__.gE("a988"));}else{debugger;}}
        if (b.browser.WeChat)return 6;
        if (b.browser.MQQClient)return 17;
        var a = "";
        if (document.location.href.indexOf("http://192.168.1.199/iframe/") >= 0 && window != top) {
...
//a989<
        if (__begin&&__YY__.S("a989", arguments)) {if(__E){eval(__YY__.gE("a989"));}else{debugger;}}
...
//a990<
        if (__begin&&__YY__.S("a990", arguments)) {if(__E){eval(__YY__.gE("a990"));}else{debugger;}}
...
//a991<
    if (__begin&&__YY__.S("a991", arguments)) {if(__E){eval(__YY__.gE("a991"));}else{debugger;}}
    function c() {
//a992<
      if (__begin&&__YY__.S("a992", arguments)) {if(__E){eval(__YY__.gE("a992"));}else{debugger;}}
    }

    var d = {
      case1: {
        promotionId: 755,
        downloadUrl: "http://192.168.1.199/commdatav2?cmd=4&confid=755&platform=aphone",
        texts: {
      ...
      case2: {
        promotionId: 756,
        downloadUrl: "http://192.168.1.199/commdatav2?cmd=4&confid=756&platform=aphone",
        texts: {
      ...
      case3: {
        promotionId: 754,
        downloadUrl: "http://192.168.1.199/commdatav2?cmd=4&confid=754&platform=aphone",
        texts: {
          _download: "\u817e\u8baf\u89c6\u9891\u770b\u66f4\u591a",
          _downloading: "\u6b63\u5728\u4e0b\u8f7d",
          _pause: "\u70b9\u51fb\u6062\u590d",
      ...
      initEvent1: function () {
//a993<
        if (__begin&&__YY__.S("a993", arguments)) {if(__E){eval(__YY__.gE("a993"));}else{debugger;}}
        var a = this;
        this.$video.off("play.limit").on("play.limit", function () {
//a994<
          if (__begin&&__YY__.S("a994", arguments)) {if(__E){eval(__YY__.gE("a994"));}else{debugger;}}
...
//a995<
          if (__begin&&__YY__.S("a995", arguments)) {if(__E){eval(__YY__.gE("a995"));}else{debugger;}}
...
//a996<
            if (__begin&&__YY__.S("a996", arguments)) {if(__E){eval(__YY__.gE("a996"));}else{debugger;}}
...
//a997<
          if (__begin&&__YY__.S("a997", arguments)) {if(__E){eval(__YY__.gE("a997"));}else{debugger;}}
...
//a998<
            if (__begin&&__YY__.S("a998", arguments)) {if(__E){eval(__YY__.gE("a998"));}else{debugger;}}
            a.hideControl()
          }, 500))
        }), this.$video.off("ended.limit").on("ended.limit", function () {
//a999<
          if (__begin&&__YY__.S("a999", arguments)) {if(__E){eval(__YY__.gE("a999"));}else{debugger;}}
...
//a1000<
          if (__begin&&__YY__.S("a1000", arguments)) {if(__E){eval(__YY__.gE("a1000"));}else{debugger;}}
          a.showDownload && (a.remain = parseInt(a.duration - this.currentTime), a.updateCountDownTime())
        })
      }, initEvent2: function () {
//a1001<
        if (__begin&&__YY__.S("a1001", arguments)) {if(__E){eval(__YY__.gE("a1001"));}else{debugger;}}
        var a = this;
        this.$video.on("play", function () {
//a1002<
          if (__begin&&__YY__.S("a1002", arguments)) {if(__E){eval(__YY__.gE("a1002"));}else{debugger;}}
          a.$panel.addClass(f.HIDE)
        }), this.$video.on("playing", function () {
//a1003<
          if (__begin&&__YY__.S("a1003", arguments)) {if(__E){eval(__YY__.gE("a1003"));}else{debugger;}}
          a.showDownload && (a.updateCountDownTime(), a.$smallBtnBox.removeClass(f.HIDE)), setTimeout(function () {
//a1004<
            if (__begin&&__YY__.S("a1004", arguments)) {if(__E){eval(__YY__.gE("a1004"));}else{debugger;}}
            a.player && a.player.isPlayingLoadingAd && a.player.isPlayingLoadingAd() && a.$smallBtnBox.addClass(f.HIDE)
          }, 100)
        }), this.$video.on("pause", function () {
//a1005<
          if (__begin&&__YY__.S("a1005", arguments)) {if(__E){eval(__YY__.gE("a1005"));}else{debugger;}}
...
//a1006<
          if (__begin&&__YY__.S("a1006", arguments)) {if(__E){eval(__YY__.gE("a1006"));}else{debugger;}}
...
//a1007<
          if (__begin&&__YY__.S("a1007", arguments)) {if(__E){eval(__YY__.gE("a1007"));}else{debugger;}}
          a.showDownload && (a.remain = parseInt(a.duration - this.currentTime), a.updateCountDownTime())
        })
      }, initEvent3: function () {
//a1008<
        if (__begin&&__YY__.S("a1008", arguments)) {if(__E){eval(__YY__.gE("a1008"));}else{debugger;}}
        var a = this, b = this.$video.get(0);
        b && this.$video.off("timeupdate.limit").on("timeupdate.limit", function () {
//a1009<
          if (__begin&&__YY__.S("a1009", arguments)) {if(__E){eval(__YY__.gE("a1009"));}else{debugger;}}
...
//a1010<
        if (__begin&&__YY__.S("a1010", arguments)) {if(__E){eval(__YY__.gE("a1010"));}else{debugger;}}
        var a = this, b = this.$video.get(0);
        b && (a.$video.trigger("tvp_durationlimit_show"), a.$limitPlay.on("click", function () {
//a1011<
          if (__begin&&__YY__.S("a1011", arguments)) {if(__E){eval(__YY__.gE("a1011"));}else{debugger;}}
          a.player.play(null, !0)
        }), a.$limitRePlay.find(".tvp_overlay_replay").on("click", function () {
//a1012<
          if (__begin&&__YY__.S("a1012", arguments)) {if(__E){eval(__YY__.gE("a1012"));}else{debugger;}}
      ...
      update: function (a) {
//a1013<
        if (__begin&&__YY__.S("a1013", arguments)) {if(__E){eval(__YY__.gE("a1013"));}else{debugger;}}
        var b, c, d = this;
        "afterInstall" === a || "hasapp" === a ? (d.downloaded = !1, b = d.conf.openUrl, c = "open") : (d.downloaded = !0, b = d.conf.downloadUrl, c = a), 1 === d.type && (d.$bannerBtn.attr({
          ...
          "data-status": c,
          "data-downloadurl": b
        }) : d.$smallBtn.attr({"data-status": c, href: b}), d.$smallBtnTXT.attr({"data-text": d.renderData["_" + a]})
      }, onStatusChange: function () {
//a1014<
        if (__begin&&__YY__.S("a1014", arguments)) {if(__E){eval(__YY__.gE("a1014"));}else{debugger;}}
        if (this.type && 2 !== this.type) {
          var a = this;
          this.$box.on("tvp:appdownload:complete", function () {
//a1015<
            if (__begin&&__YY__.S("a1015", arguments)) {if(__E){eval(__YY__.gE("a1015"));}else{debugger;}}
            h.update.call(a, "install")
          }).on("tvp:appdownload:downloading", function () {
//a1016<
            if (__begin&&__YY__.S("a1016", arguments)) {if(__E){eval(__YY__.gE("a1016"));}else{debugger;}}
            h.update.call(a, "downloading")
          }).on("tvp:appdownload:pause", function () {
//a1017<
            if (__begin&&__YY__.S("a1017", arguments)) {if(__E){eval(__YY__.gE("a1017"));}else{debugger;}}
            h.update.call(a, "pause")
          }).on("tvp:appdownload:afterInstall", function () {
//a1018<
            if (__begin&&__YY__.S("a1018", arguments)) {if(__E){eval(__YY__.gE("a1018"));}else{debugger;}}
            b(), h.update.call(a, "afterInstall")
          }).on("tvp:appdownload:hasapp", function () {
//a1019<
            if (__begin&&__YY__.S("a1019", arguments)) {if(__E){eval(__YY__.gE("a1019"));}else{debugger;}}
            h.update.call(a, "hasapp")
          });
          var b = function () {
//a1020<
            if (__begin&&__YY__.S("a1020", arguments)) {if(__E){eval(__YY__.gE("a1020"));}else{debugger;}}
            a.$box.off("click.openApp").on("click.openApp", function () {
//a1021<
              if (__begin&&__YY__.S("a1021", arguments)) {if(__E){eval(__YY__.gE("a1021"));}else{debugger;}}
              a.stepReport(7, 1)
            })
          }
        }
...
//a1022<
        if (__begin&&__YY__.S("a1022", arguments)) {if(__E){eval(__YY__.gE("a1022"));}else{debugger;}}
        var a = this;
        a.conf.hasApp ? a.$btn.off("touchend.stepreport").on("touchend.stepreport", function () {
//a1023<
          if (__begin&&__YY__.S("a1023", arguments)) {if(__E){eval(__YY__.gE("a1023"));}else{debugger;}}
          a.stepReport(7, 3)
        }) : b.os.android || (b.os.ios || 2 === a.type) && (a.stepReport(1, 1), a.$btn.off("touchend.stepreport").on("touchend.stepreport", function () {
//a1024<
          if (__begin&&__YY__.S("a1024", arguments)) {if(__E){eval(__YY__.gE("a1024"));}else{debugger;}}
          a.stepReport(2, 1)
        }))
      }, setDownload1: function () {
//a1025<
        if (__begin&&__YY__.S("a1025", arguments)) {if(__E){eval(__YY__.gE("a1025"));}else{debugger;}}
        var c = this;
        ...
        }), b.os.android && (a.$.browser.WeChat || a.$.browser.MQQClient) && this.$btn.removeAttr("href"), this.bindDownloader(this.$box, this.$btn), h.onStatusChange.call(this)
      }, setDownload2: function () {
//a1026<
        if (__begin&&__YY__.S("a1026", arguments)) {if(__E){eval(__YY__.gE("a1026"));}else{debugger;}}
        var c = this;
...
//a1027<
        if (__begin&&__YY__.S("a1027", arguments)) {if(__E){eval(__YY__.gE("a1027"));}else{debugger;}}
        var a = this;
    ...
    c.prototype = {
      init: function (b) {
//a1028<
        if (__begin&&__YY__.S("a1028", arguments)) {if(__E){eval(__YY__.gE("a1028"));}else{debugger;}}
        if (b && 1 != b.config.type && b.config.isHtml5UseUI && !b.config.isShortVideo) {
          var c = this;
          return this.player = b, this.$video = b.$video, this.vid = b.curVideo.getVid(), this.enable = this.hasLimit(), this.type = this.getLimitCase(), this.conf = d["case" + this.type], a.app && a.app.config && (this.conf.appName = this.conf.appName || a.app.config.defaultName), this.updateUserConfig(), this.isUseCase1UI(), this.showBanner = !this.hasAppBanner(), this.whenToDisableCase3(), a.app && a.app.isSupportApp ? void(0 !== this.type && (this.enable && b.trigger && b.trigger("tvp.durationlimit.enable"), this.$video && this.$video.trigger && this.$video.on("tvp:player:videochange", function () {
//a1029<
            if (__begin&&__YY__.S("a1029", arguments)) {if(__E){eval(__YY__.gE("a1029"));}else{debugger;}}
            c.enable = !1
          }), this.start())) : void(this.enable && this.macLimit())
        }
      }, hide: function () {
//a1030<
        if (__begin&&__YY__.S("a1030", arguments)) {if(__E){eval(__YY__.gE("a1030"));}else{debugger;}}
        var a = this;
...
//a1031<
        if (__begin&&__YY__.S("a1031", arguments)) {if(__E){eval(__YY__.gE("a1031"));}else{debugger;}}
        var a = this.player.config.disableLimitBanner, c = this.type + "", f = this.player.config.caseSetting, g = this.player.config.limitSetting;
...
//a1032<
        if (__begin&&__YY__.S("a1032", arguments)) {if(__E){eval(__YY__.gE("a1032"));}else{debugger;}}
...
//a1033<
        if (__begin&&__YY__.S("a1033", arguments)) {if(__E){eval(__YY__.gE("a1033"));}else{debugger;}}
        var a = this.player.curVideo.data, b = this, c = function (a) {
//a1034<
          if (__begin&&__YY__.S("a1034", arguments)) {if(__E){eval(__YY__.gE("a1034"));}else{debugger;}}
...
//a1035<
        if (__begin&&__YY__.S("a1035", arguments)) {if(__E){eval(__YY__.gE("a1035"));}else{debugger;}}
        var a = navigator.userAgent.toLowerCase(), c = e.case_regx, d = !1;
        return b(c).each(function (b, c) {
//a1036<
          if (__begin&&__YY__.S("a1036", arguments)) {if(__E){eval(__YY__.gE("a1036"));}else{debugger;}}
          return c.test(a) ? (d = !0, !1) : void 0
        }), this.enable ? d ? 1 : 2 : d ? 3 : 0
      }, start: function () {
//a1037<
        if (__begin&&__YY__.S("a1037", arguments)) {if(__E){eval(__YY__.gE("a1037"));}else{debugger;}}
        var a = this;
...
//a1038<
          if (__begin&&__YY__.S("a1038", arguments)) {if(__E){eval(__YY__.gE("a1038"));}else{debugger;}}
          a.duration = a.player.getDuration()
        }), this.$video.off("timeupdate.limit-control").on("timeupdate.limit-control", function () {
//a1039<
          if (__begin&&__YY__.S("a1039", arguments)) {if(__E){eval(__YY__.gE("a1039"));}else{debugger;}}
...
//a1040<
        if (__begin&&__YY__.S("a1040", arguments)) {if(__E){eval(__YY__.gE("a1040"));}else{debugger;}}
...
//a1041<
        if (__begin&&__YY__.S("a1041", arguments)) {if(__E){eval(__YY__.gE("a1041"));}else{debugger;}}
        var c = a.html5skin[e.name + "_case" + this.type], f = d["case" + this.type], g = f.texts, h = this.preview - 29;
...
//a1042<
        if (__begin&&__YY__.S("a1042", arguments)) {if(__E){eval(__YY__.gE("a1042"));}else{debugger;}}
...
//a1043<
        if (__begin&&__YY__.S("a1043", arguments)) {if(__E){eval(__YY__.gE("a1043"));}else{debugger;}}
...
//a1044<
        if (__begin&&__YY__.S("a1044", arguments)) {if(__E){eval(__YY__.gE("a1044"));}else{debugger;}}
...
//a1045<
        if (__begin&&__YY__.S("a1045", arguments)) {if(__E){eval(__YY__.gE("a1045"));}else{debugger;}}
...
//a1046<
          if (__begin&&__YY__.S("a1046", arguments)) {if(__E){eval(__YY__.gE("a1046"));}else{debugger;}}
          var b = a.common.recomdText[e.vid];
          b && b.rmdword && (e.bannerTips = b.rmdword), e.reportData = b, c.resolve()
        }) : c.resolve(), c)
      }, showSmallBtnOnTime: function (a) {
//a1047<
        if (__begin&&__YY__.S("a1047", arguments)) {if(__E){eval(__YY__.gE("a1047"));}else{debugger;}}
        return 3 !== this.type ? !1 : this.isPad() ? !0 : 1 === a ? !0 : a % 30 === 0 ? !0 : !1
      }, isPad: function () {
//a1048<
        if (__begin&&__YY__.S("a1048", arguments)) {if(__E){eval(__YY__.gE("a1048"));}else{debugger;}}
        return b.os.ipad || b.os.tablet
      }, updateCountDownTime: function () {
//a1049<
        if (__begin&&__YY__.S("a1049", arguments)) {if(__E){eval(__YY__.gE("a1049"));}else{debugger;}}
...
//a1050<
        if (__begin&&__YY__.S("a1050", arguments)) {if(__E){eval(__YY__.gE("a1050"));}else{debugger;}}
        a = a || this.$panel, b = b || 1e4;
        var c = this;
        this.delayTimer || (this.delayTimer = setTimeout(function () {
//a1051<
          if (__begin&&__YY__.S("a1051", arguments)) {if(__E){eval(__YY__.gE("a1051"));}else{debugger;}}
          c.downloaded || a.addClass(f.HIDE), c.delayTimer = null
        }, b))
      }, showReport: function () {
//a1052<
        if (__begin&&__YY__.S("a1052", arguments)) {if(__E){eval(__YY__.gE("a1052"));}else{debugger;}}
...
//a1053<
        if (__begin&&__YY__.S("a1053", arguments)) {if(__E){eval(__YY__.gE("a1053"));}else{debugger;}}
...
//a1054<
          if (__begin&&__YY__.S("a1054", arguments)) {if(__E){eval(__YY__.gE("a1054"));}else{debugger;}}
          a && a.md5 && (d.conf.md5 = a.md5), c.resolve()
        }).fail(function () {
//a1055<
          if (__begin&&__YY__.S("a1055", arguments)) {if(__E){eval(__YY__.gE("a1055"));}else{debugger;}}
          c.reject()
        }), c) : (c.reject(), c)
      }, check: function () {
//a1056<
        if (__begin&&__YY__.S("a1056", arguments)) {if(__E){eval(__YY__.gE("a1056"));}else{debugger;}}
        var c = b.Deferred(), d = this;
        return this.conf.promotionId && d.conf.downloadUrl ? (this.getMD5().done(function () {
//a1057<
          if (__begin&&__YY__.S("a1057", arguments)) {if(__E){eval(__YY__.gE("a1057"));}else{debugger;}}
...
//a1058<
            if (__begin&&__YY__.S("a1058", arguments)) {if(__E){eval(__YY__.gE("a1058"));}else{debugger;}}
            a && a.openUrl && (d.conf.hasApp = a.hasApp, d.conf.openUrl = a.openUrl, d.conf.url = a.url), c.resolve()
          }) : void c.reject()
        }).fail(function () {
//a1059<
          if (__begin&&__YY__.S("a1059", arguments)) {if(__E){eval(__YY__.gE("a1059"));}else{debugger;}}
          c.reject()
        }), c) : (c.reject(), c)
      }, initDownload: function () {
//a1060<
        if (__begin&&__YY__.S("a1060", arguments)) {if(__E){eval(__YY__.gE("a1060"));}else{debugger;}}
        var a = this;
        this.check().done(function () {
//a1061<
          if (__begin&&__YY__.S("a1061", arguments)) {if(__E){eval(__YY__.gE("a1061"));}else{debugger;}}
...
//a1062<
        if (__begin&&__YY__.S("a1062", arguments)) {if(__E){eval(__YY__.gE("a1062"));}else{debugger;}}
        var e = this, f = "string" === b.type(this.player.config.downloaderCallback) ? this.player.config.downloaderCallback : !1;
        ...
        var g = {downloader: e.conf.downloader, downloadUrl: e.conf.downloadUrl, md5: e.conf.md5, range: e.conf.range};
        if (!this.hascheckDownloader) {
          this.hascheckDownloader = !0;
          var h = {
            t: e.player,
...
//a1063<
        if (__begin&&__YY__.S("a1063", arguments)) {if(__E){eval(__YY__.gE("a1063"));}else{debugger;}}
...
//a1064<
        if (__begin&&__YY__.S("a1064", arguments)) {if(__E){eval(__YY__.gE("a1064"));}else{debugger;}}
        var a = this;
...
//a1065<
        if (__begin&&__YY__.S("a1065", arguments)) {if(__E){eval(__YY__.gE("a1065"));}else{debugger;}}
        if (3 === this.type) {
          var c = this;
          ...
          if (b.isArray(c.conf.disable)) {
            var d = function () {
//a1066<
              if (__begin&&__YY__.S("a1066", arguments)) {if(__E){eval(__YY__.gE("a1066"));}else{debugger;}}
              ...
              return b = 1 === d ? "192.168.1.199" === c ? 1 : "192.168.1.199" === c ? 2 : 3 : 2 === d ? "192.168.1.199" === c ? 4 : 5 : 3 === d ? 6 : 7
            };
...
//a1067<
        if (__begin&&__YY__.S("a1067", arguments)) {if(__E){eval(__YY__.gE("a1067"));}else{debugger;}}
        this.player && this.player.hideControl && this.player.hideControl()
      }, macLimit: function () {
//a1068<
        if (__begin&&__YY__.S("a1068", arguments)) {if(__E){eval(__YY__.gE("a1068"));}else{debugger;}}
        ...
        if (c) {
          ...
          if (e = h.find('[data-role="tvp_fn_tips_box"]')) {
            f = e.find('[data-role="tvp_fn_tips_text"]'), g = window.txv && txv.login && "function" === b.type(txv.login.openLogin), d = "192.168.1.199" === window.location.hostname ? g ? '<span style="cursor: pointer;" class="tvp_link tvp_fn_openLogin">\u767b\u5f55</span>\u540e\u53ef\u89c2\u770b\u5b8c\u6574\u7248' : '<a class="tvp_link" href="http://192.168.1.199/">\u767b\u5f55</a>\u540e\u53ef\u89c2\u770b\u5b8c\u6574\u7248' : '\u5728<a class="tvp_link" href="http://192.168.1.199/">192.168.1.199</a>\u767b\u5f55\u540e\u53ef\u89c2\u770b\u5b8c\u6574\u7248';
            var l = function () {
//a1069<
              if (__begin&&__YY__.S("a1069", arguments)) {if(__E){eval(__YY__.gE("a1069"));}else{debugger;}}
              f.html(d), "192.168.1.199" === window.location.hostname && a.$(".tvp_fn_openLogin").off("click").on("click", function () {
//a1070<
                if (__begin&&__YY__.S("a1070", arguments)) {if(__E){eval(__YY__.gE("a1070"));}else{debugger;}}
...
//a1071<
                if (__begin&&__YY__.S("a1071", arguments)) {if(__E){eval(__YY__.gE("a1071"));}else{debugger;}}
...
//a1072<
              if (__begin&&__YY__.S("a1072", arguments)) {if(__E){eval(__YY__.gE("a1072"));}else{debugger;}}
              l()
            })
          }
        }
...
//a1073<
        if (__begin&&__YY__.S("a1073", arguments)) {if(__E){eval(__YY__.gE("a1073"));}else{debugger;}}
      ...
      create: function (b) {
//a1074<
        if (__begin&&__YY__.S("a1074", arguments)) {if(__E){eval(__YY__.gE("a1074"));}else{debugger;}}
...
//a1075<
    if (__begin&&__YY__.S("a1075", arguments)) {if(__E){eval(__YY__.gE("a1075"));}else{debugger;}}
    b.extend(a.Html5Tiny.fn, {
      buildmonitor: function () {
//a1076<
        if (__begin&&__YY__.S("a1076", arguments)) {if(__E){eval(__YY__.gE("a1076"));}else{debugger;}}
        var c = this, d = null, e = 0, f = !1;
        this.$video.on("playing", function () {
//a1077<
          if (__begin&&__YY__.S("a1077", arguments)) {if(__E){eval(__YY__.gE("a1077"));}else{debugger;}}
          setTimeout(function () {
//a1078<
            if (__begin&&__YY__.S("a1078", arguments)) {if(__E){eval(__YY__.gE("a1078"));}else{debugger;}}
            c.isPlayingLoadingAd() && (c.hasAds = !0, d && d.reportStep(7, {val1: 1}))
          }, 90)
        }), this.$video.on("tvp:video:ajaxstart", function (b, e, g) {
//a1079<
          if (__begin&&__YY__.S("a1079", arguments)) {if(__E){eval(__YY__.gE("a1079"));}else{debugger;}}
          f = g, d = null, d = new a.H5Monitor(e, c), d.addStep(f ? 1009 : 1011), d.addStep(7)
        }).on("tvp:video:ajaxsuc", function () {
//a1080<
          if (__begin&&__YY__.S("a1080", arguments)) {if(__E){eval(__YY__.gE("a1080"));}else{debugger;}}
          d && (d.report(3, 1), d.reportStep(f ? 1009 : 1011, {val1: 1, val2: 0}))
        }).on("tvp:video:src", function () {
//a1081<
          if (__begin&&__YY__.S("a1081", arguments)) {if(__E){eval(__YY__.gE("a1081"));}else{debugger;}}
          e = 0, d.report(4, 1, {val2: 1}), d.addStep(6), d.addStep(30), c.$video.one("canplay", function () {
//a1082<
            if (__begin&&__YY__.S("a1082", arguments)) {if(__E){eval(__YY__.gE("a1082"));}else{debugger;}}
            d && d.reportStep(30, {val1: 0, val2: 2})
          }).one("error", function () {
//a1083<
            if (__begin&&__YY__.S("a1083", arguments)) {if(__E){eval(__YY__.gE("a1083"));}else{debugger;}}
            d && (d.reportStep(30, {val1: 1, val2: 2}), d.report(5, 0, {val1: 3}))
          }).one("playing", function () {
//a1084<
            if (__begin&&__YY__.S("a1084", arguments)) {if(__E){eval(__YY__.gE("a1084"));}else{debugger;}}
            d && (d.reportStep(6, {val1: c.hasAds ? 4 : 1}), d.addStep(5), h({itype: 1}), c.$video.one("tvp:player:ended", function () {
//a1085<
              if (__begin&&__YY__.S("a1085", arguments)) {if(__E){eval(__YY__.gE("a1085"));}else{debugger;}}
              d.reportStep(5, {val1: 1}), h({itype: 2})
            }).one("tvp:player:videochange", function () {
//a1086<
              if (__begin&&__YY__.S("a1086", arguments)) {if(__E){eval(__YY__.gE("a1086"));}else{debugger;}}
              d.reportStep(5, {val1: 2}), h({itype: 3})
            }))
          })
        }).on("waiting", function () {
//a1087<
          if (__begin&&__YY__.S("a1087", arguments)) {if(__E){eval(__YY__.gE("a1087"));}else{debugger;}}
          d && 1 != ++e && (c.isDefinitionSwitching || c.isTouching || (d.addStep(31), c.$video.one("timeupdate", g)))
        }).one("tvp:h5ui:playbtn:click", function () {
//a1088<
          if (__begin&&__YY__.S("a1088", arguments)) {if(__E){eval(__YY__.gE("a1088"));}else{debugger;}}
          h({itype: 4})
        });
        var g = function () {
//a1089<
          if (__begin&&__YY__.S("a1089", arguments)) {if(__E){eval(__YY__.gE("a1089"));}else{debugger;}}
...
//a1090<
          if (__begin&&__YY__.S("a1090", arguments)) {if(__E){eval(__YY__.gE("a1090"));}else{debugger;}}
          d = d || {};
          var e = {
            cmd: 3533,
...
//a1091<
    if (__begin&&__YY__.S("a1091", arguments)) {if(__E){eval(__YY__.gE("a1091"));}else{debugger;}}
    a.html5lang = {
      errMsg: {
        "default": "\u89c6\u9891\u52a0\u8f7d\u5931\u8d25\uff0c\u8bf7\u5237\u65b0\u9875\u9762\u91cd\u8bd5",
        0: "\u89c6\u9891\u52a0\u8f7d\u5931\u8d25",
        ...
        80: {
          ...
          callback: function (b, c, d) {
//a1092<
            if (__begin&&__YY__.S("a1092", arguments)) {if(__E){eval(__YY__.gE("a1092"));}else{debugger;}}
            if (0 == parseInt(c) && a.app && d && d.vid) {
              var e = a.html5skin.errorDownloader;
              a.app.check(d).done(function (a) {
//a1093<
                if (__begin&&__YY__.S("a1093", arguments)) {if(__E){eval(__YY__.gE("a1093"));}else{debugger;}}
                if (a.url) {
                  var c = b.find(".tvp_player_error_content");
                  c = b;
                  var d = b.find(".text").html();
      ...
      getErrMsg: function (c, d) {
//a1094<
        if (__begin&&__YY__.S("a1094", arguments)) {if(__E){eval(__YY__.gE("a1094"));}else{debugger;}}
        if (isNaN(c))return "";
        if (c in a.html5lang.errMsg) {
          var e = a.html5lang.errMsg[c];
          if (0 === c && "-" + d in a.html5lang.errMsg && (e += "\uff0c" + a.html5lang.errMsg["-" + d]), b.isString(e))return e;
      ...
      getDefiName: function (b) {
//a1095<
        if (__begin&&__YY__.S("a1095", arguments)) {if(__E){eval(__YY__.gE("a1095"));}else{debugger;}}
        return b in a.defaultConfig.definition ? a.defaultConfig.definition[b] : ""
      },
      getSrtName: function (b) {
//a1096<
        if (__begin&&__YY__.S("a1096", arguments)) {if(__E){eval(__YY__.gE("a1096"));}else{debugger;}}
        return b in a.html5lang.srtLang ? a.html5lang.srtLang[b].desc : ""
      }
    }
  }(tvp, tvp.$), tvp.html5skin = {
    defaultError: function () {
//a1097<
      if (__begin&&__YY__.S("a1097", arguments)) {if(__E){eval(__YY__.gE("a1097"));}else{debugger;}}
      return [' <div class="tvp_player_error" id="$ERROR-TIPS-INNER$">', '   <div class="tvp_error_inner">', '     <div class="tvp_error_title">$ERROR-MSG$</div>', '     <div class="tvp_error_desc">$ERROR-DETAIL$</div>', '     <a href="javascript:;" data-role="error-refresh" class="tvp_btn_simple tvp_none">\u5237\u65b0</a>', "  </div>", " </div>"].join("")
    }(), errorDownloader: function () {
//a1098<
      if (__begin&&__YY__.S("a1098", arguments)) {if(__E){eval(__YY__.gE("a1098"));}else{debugger;}}
      return ['<div class="tvp_live_download_app">', '  <a class="tvp_download_app_inner" href="${url}">', '    <i class="tpv_icon_download"></i>', '   <span class="tvp_icon_text">${errorMsg}</span>', "  </a>", "</div>"].join("")
    }(), durationLimit: function () {
//a1099<
      if (__begin&&__YY__.S("a1099", arguments)) {if(__E){eval(__YY__.gE("a1099"));}else{debugger;}}
      return ['<div style="display:none" class="tvp_limit_tips" data-role="durationLimit">', '   <div class="tvp_limit_tips_inner">', '   <div class="tvp_tips_content">', '      <p class="tvp_tips_text">${msg}</p>', "   </div>", '    <div class="tvp_btn_line">', '      <span data-role="durationLimit-play" class="tvp_btn tvp_btn_try">${play}</span>', '     <span  data-role="durationLimit-replay" class="tvp_btn tvp_btn_try">${replay}</span>', '      <a data-action="applink" ${iframe} href="${url}" data-url="" data-role="durationLimit-download" class="tvp_btn tvp_btn_download">${download}</a>', '      <a data-action="applink" href="" data-url="" data-role="durationLimit-open" class="tvp_btn tvp_btn_download">${open}</a>', "    </div>", "  </div>", "</div>"].join("");
    }(), durationLimit_v2_case1: function () {
//a1100<
      if (__begin&&__YY__.S("a1100", arguments)) {if(__E){eval(__YY__.gE("a1100"));}else{debugger;}}
      return ['<div data-role="tvp-limit-case1" class="tvp_none">', '<div class="tvp_layer_replay tvp_none" data-role="tvp-limit-replay">', '<div class="tvp_overlay_replay">', '<span class="tvp_button_replay"></span>', '<span class="tvp_text" data-role="tvp-limit-replay-text">${replayText}</span>', "</div>", "</div>", '<div class="tvp_overlay_play_try tvp_none" data-role="tvp-limit-play">', '<span class="tvp_button_play"></span>', '<span class="tvp_text" data-role="tvp-limit-play-text">${playText}</span>', "</div>", '<div class="tvp_app_banner tvp_none" data-role="tvp-limit-download">', '<a data-role="tvp-limit-download-btn" href="javascript:;" class="tvp_app_btn" data-status="down">', '<span class="tvp_progress">', '<span class="tvp_progress_current"></span>', "</span>", '<span data-role="tvp-limit-download-text" class="tvp_text" data-text="${download}"></span>', "</a>", "</div>", '<div class="tvp_app_badge tvp_none" data-role="tvp-limit-timing">', '<a href="javascript:;" data-role="tvp-limit-timing-btn" class="tvp_app_btn" data-status="down">', '<span class="tvp_progress"><span class="tvp_progress_current"></span></span>', '<span class="tvp_text" data-text="\u8fd8\u5269" data-role="tvp-limit-timing-text"></span>', "</a>", "</div>", "</div>"].join("")
    }(), durationLimit_v2_case2: function () {
//a1101<
      if (__begin&&__YY__.S("a1101", arguments)) {if(__E){eval(__YY__.gE("a1101"));}else{debugger;}}
      return ['<div class="tvp_external_layer tvp_none" data-role="tvp-limit-case2">', '<div class="tvp_external_inner">', '<div class="tvp_overlay_play_try" data-role="tvp-limit-play">', '<span class="tvp_button_play"></span>', '<span class="tvp_text" data-role="tvp-limit-play-text">${playText}</span>', "</div>", '<div class="tvp_layer_replay tvp_none" data-role="tvp-limit-replay">', '<div class="tvp_overlay_replay">', '<span class="tvp_button_replay"></span>', '<span class="tvp_text" data-role="tvp-limit-replay-text">${replayText}</span>', "</div>", "</div>", '<div class="tvp_app_banner tvp_none" data-role="tvp-limit-download">', '<a href="javascript:;" class="tvp_app_btn" data-status="down" data-role="tvp-limit-download-btn">', '<span class="tvp_progress"><span class="tvp_progress_current"></span></span>', '<span data-role="tvp-limit-download-text" class="tvp_btn_text" data-text="${download}"></span>', "</a>", "</div>", "</div>", "</div>", '<div class="tvp_app_badge tvp_none" data-role="tvp-limit-timing">', '<a data-role="tvp-limit-timing-btn" href="javascript:;" class="tvp_app_btn" data-status="down">', '<span class="tvp_text" data-text="\u8fd8\u5269" data-role="tvp-limit-timing-text"></span>', "</a>", "</div>"].join("")
    }(), durationLimit_v2_case3: function () {
//a1102<
      if (__begin&&__YY__.S("a1102", arguments)) {if(__E){eval(__YY__.gE("a1102"));}else{debugger;}}
      return ['<div class="tvp_app_badge tvp_none" data-role="tvp-limit-case3">', '<a data-role="tvp-limit-timing-btn" href="javascript:;" class="tvp_app_btn" data-status="down">', '<span class="tvp_progress"><span class="tvp_progress_current"></span></span>', '<span data-role="tvp-limit-timing-text" class="tvp_text" data-text="${timingText}"></span>', "</a>", "</div>"].join("")
    }(), liveDownloader: function () {
//a1103<
      if (__begin&&__YY__.S("a1103", arguments)) {if(__E){eval(__YY__.gE("a1103"));}else{debugger;}}
      return ['<div class="tvp_player_error">', '<div class="tvp_error_inner">', '<div class="tvp_error_title" data-role="tvp_errormsg">${msg}</div>', '<a data-role="tvp_err_refresh" href="javascript:;" class="txvp_error_refresh tvp_none" onclick="location.reload();">\u70b9\u51fb\u5237\u65b0</a>', '<div class="tvp_error_code">\u9519\u8bef\u4ee3\u7801\uff1a<span data-role="tvp_errrocode">${code}</span></div>', '<a data-role="tvp_error_btn" href="javascript:;" class="tvp_btn_normal">${btnText}</a>', "</div>", "</div>"].join("")
    }(), follow: function () {
//a1104<
      if (__begin&&__YY__.S("a1104", arguments)) {if(__E){eval(__YY__.gE("a1104"));}else{debugger;}}
      return ['<a class="tvp_follow" data-role="appfollow_followbtn" data-follow="follow">', '<span class="tvp_icon_follow"></span>', '<span class="tvp_icon_text" data-role="appfollow_followtext">\u5173\u6ce8</span>', "</a>", '<div class="tvp_follow_hint">', '<div class="tvp_hint_title">\u5173\u6ce8\u6210\u529f\uff01</div>', '<div class="tvp_hint_desc" data-role="bannerText">{FOLLOWTEXT}</div>', "</div>"].join("")
    }()
  }, function (a, b) {
//a1105<
    if (__begin&&__YY__.S("a1105", arguments)) {if(__E){eval(__YY__.gE("a1105"));}else{debugger;}}
    function c(c, d) {
//a1106<
      if (__begin&&__YY__.S("a1106", arguments)) {if(__E){eval(__YY__.gE("a1106"));}else{debugger;}}
      ...
      b.extend(this.protectedFn, {
        onwrite: function () {
//a1107<
          if (__begin&&__YY__.S("a1107", arguments)) {if(__E){eval(__YY__.gE("a1107"));}else{debugger;}}
          var c = [];
...
//a1108<
            if (__begin&&__YY__.S("a1108", arguments)) {if(__E){eval(__YY__.gE("a1108"));}else{debugger;}}
            h.videoTag.style.cssText = h.videoTag.style.cssText
          }, 100), setTimeout(function () {
//a1109<
            if (__begin&&__YY__.S("a1109", arguments)) {if(__E){eval(__YY__.gE("a1109"));}else{debugger;}}
            clearInterval(f)
    ...
    a.Html5Player || (c.fn = c.prototype = new a.Html5Tiny, b.extend(c.prototype, {
      createVideoHtml: function () {
//a1110<
        if (__begin&&__YY__.S("a1110", arguments)) {if(__E){eval(__YY__.gE("a1110"));}else{debugger;}}
        var b = a.Html5Tiny.prototype.createVideoHtml.call(this), c = a.html5skin.getHtml(this.config);
        return c.replace("$VIDEO$", b)
      }, hideControl: function () {
//a1111<
        if (__begin&&__YY__.S("a1111", arguments)) {if(__E){eval(__YY__.gE("a1111"));}else{debugger;}}
        this.control.hide()
      }, showControl: function () {
//a1112<
        if (__begin&&__YY__.S("a1112", arguments)) {if(__E){eval(__YY__.gE("a1112"));}else{debugger;}}
        this.control.show()
      }
    }), a.Html5Player = c)
  }(tvp, tvp.$), function (a, b) {
//a1113<
    if (__begin&&__YY__.S("a1113", arguments)) {if(__E){eval(__YY__.gE("a1113"));}else{debugger;}}
    function c(c, d) {
//a1114<
      if (__begin&&__YY__.S("a1114", arguments)) {if(__E){eval(__YY__.gE("a1114"));}else{debugger;}}
      this.isUseControl = !1, this.config.width = a.$.filterXSS(c), this.config.height = a.$.filterXSS(d), this.control = null, this.$UILayer = null;
      var e = this;
      b.extend(this.protectedFn, {
        onwrite: function () {
//a1115<
          if (__begin&&__YY__.S("a1115", arguments)) {if(__E){eval(__YY__.gE("a1115"));}else{debugger;}}
          this.control = new a.Html5UI(e), this.control.feature = this.config.html5LiveUIFeature, this.control.init(), this.$UILayer = this.control.$UILayer, this.$UILayer && this.$UILayer.addClass && this.$UILayer.addClass("tvp_container_live")
        }
      })
    }
    ...
    a.Html5Live || (c.fn = c.prototype = new a.Html5LiveTiny, b.extend(c.prototype, {
      createVideoHtml: function () {
//a1116<
        if (__begin&&__YY__.S("a1116", arguments)) {if(__E){eval(__YY__.gE("a1116"));}else{debugger;}}
        var b = a.Html5LiveTiny.prototype.createVideoHtml.call(this), c = a.html5skin.getHtml(this.config);
        return c.replace("$VIDEO$", b)
      }, getPlayerType: function () {
//a1117<
        if (__begin&&__YY__.S("a1117", arguments)) {if(__E){eval(__YY__.gE("a1117"));}else{debugger;}}
        return "html5live"
      }
    }), a.Html5Live = c)
  }(tvp, tvp.$), function (a) {
//a1118<
    if (__begin&&__YY__.S("a1118", arguments)) {if(__E){eval(__YY__.gE("a1118"));}else{debugger;}}
    function b(a) {
//a1119<
      if (__begin&&__YY__.S("a1119", arguments)) {if(__E){eval(__YY__.gE("a1119"));}else{debugger;}}
      return "tagName"in a ? a : a.parentNode
    }

    function c(a, b, c, d) {
//a1120<
      if (__begin&&__YY__.S("a1120", arguments)) {if(__E){eval(__YY__.gE("a1120"));}else{debugger;}}
    ...
    function d() {
//a1121<
      if (__begin&&__YY__.S("a1121", arguments)) {if(__E){eval(__YY__.gE("a1121"));}else{debugger;}}
      j = null, k.last && (k.el.trigger("longTap"), k = {})
    }

    function e() {
//a1122<
      if (__begin&&__YY__.S("a1122", arguments)) {if(__E){eval(__YY__.gE("a1122"));}else{debugger;}}
      j && clearTimeout(j), j = null
    }

    function f() {
//a1123<
      if (__begin&&__YY__.S("a1123", arguments)) {if(__E){eval(__YY__.gE("a1123"));}else{debugger;}}
...
//a1124<
        if (__begin&&__YY__.S("a1124", arguments)) {if(__E){eval(__YY__.gE("a1124"));}else{debugger;}}
        var m, n;
        a(document.body).bind("touchstart", function (c) {
//a1125<
          if (__begin&&__YY__.S("a1125", arguments)) {if(__E){eval(__YY__.gE("a1125"));}else{debugger;}}
...
//a1126<
          if (__begin&&__YY__.S("a1126", arguments)) {if(__E){eval(__YY__.gE("a1126"));}else{debugger;}}
          a.originalEvent && (a = a.originalEvent), e(), k.x2 = a.touches[0].pageX, k.y2 = a.touches[0].pageY
        }).bind("touchend", function (b) {
//a1127<
          if (__begin&&__YY__.S("a1127", arguments)) {if(__E){eval(__YY__.gE("a1127"));}else{debugger;}}
          b.originalEvent && (b = b.originalEvent), e(), k.x2 && Math.abs(k.x1 - k.x2) > 30 || k.y2 && Math.abs(k.y1 - k.y2) > 30 ? i = setTimeout(function () {
//a1128<
            if (__begin&&__YY__.S("a1128", arguments)) {if(__E){eval(__YY__.gE("a1128"));}else{debugger;}}
...
//a1129<
            if (__begin&&__YY__.S("a1129", arguments)) {if(__E){eval(__YY__.gE("a1129"));}else{debugger;}}
...
//a1130<
                if (__begin&&__YY__.S("a1130", arguments)) {if(__E){eval(__YY__.gE("a1130"));}else{debugger;}}
...
//a1131<
          if (__begin&&__YY__.S("a1131", arguments)) {if(__E){eval(__YY__.gE("a1131"));}else{debugger;}}
          if (k.x2 && Math.abs(k.x1 - k.x2) > 30 || k.y2 && Math.abs(k.y1 - k.y2) > 30)try {
            i = setTimeout(function () {
//a1132<
              if (__begin&&__YY__.S("a1132", arguments)) {if(__E){eval(__YY__.gE("a1132"));}else{debugger;}}
              k.el && "function" == typeof k.el.trigger && (k.el.trigger("swipe"), k.el.trigger("swipe" + c(k.x1, k.x2, k.y1, k.y2)), k = {})
            }, 0)
          } catch (a) {
            f()
...
//a1133<
        if (__begin&&__YY__.S("a1133", arguments)) {if(__E){eval(__YY__.gE("a1133"));}else{debugger;}}
        a.fn[b] = function (a) {
//a1134<
          if (__begin&&__YY__.S("a1134", arguments)) {if(__E){eval(__YY__.gE("a1134"));}else{debugger;}}
...
//a1135<
    if (__begin&&__YY__.S("a1135", arguments)) {if(__E){eval(__YY__.gE("a1135"));}else{debugger;}}
    a.extend(tvp.html5skin, {
      html: function () {
//a1136<
        if (__begin&&__YY__.S("a1136", arguments)) {if(__E){eval(__YY__.gE("a1136"));}else{debugger;}}
...
//a1137<
        if (__begin&&__YY__.S("a1137", arguments)) {if(__E){eval(__YY__.gE("a1137"));}else{debugger;}}
      ...
      getHtml: function (a) {
//a1138<
        if (__begin&&__YY__.S("a1138", arguments)) {if(__E){eval(__YY__.gE("a1138"));}else{debugger;}}
...
//a1139<
          if (__begin&&__YY__.S("a1139", arguments)) {if(__E){eval(__YY__.gE("a1139"));}else{debugger;}}
          c[b] = !0
        }), tvp.$.each(a.html5ForbiddenUIFeature, function (a, b) {
//a1140<
          if (__begin&&__YY__.S("a1140", arguments)) {if(__E){eval(__YY__.gE("a1140"));}else{debugger;}}
          c[b] = !1
        }), b({feature: c})
      }
    })
...
//a1141<
    if (__begin&&__YY__.S("a1141", arguments)) {if(__E){eval(__YY__.gE("a1141"));}else{debugger;}}
    var c;
    a.Html5UI = function (a) {
//a1142<
      if (__begin&&__YY__.S("a1142", arguments)) {if(__E){eval(__YY__.gE("a1142"));}else{debugger;}}
      ...
      getCurVideo: function () {
//a1143<
        if (__begin&&__YY__.S("a1143", arguments)) {if(__E){eval(__YY__.gE("a1143"));}else{debugger;}}
        return this.player.getCurVideo()
      }, init: function () {
//a1144<
        if (__begin&&__YY__.S("a1144", arguments)) {if(__E){eval(__YY__.gE("a1144"));}else{debugger;}}
        this.initDom(), this.controlReady()
      }, initDom: function () {
//a1145<
        if (__begin&&__YY__.S("a1145", arguments)) {if(__E){eval(__YY__.gE("a1145"));}else{debugger;}}
...
//a1146<
        if (__begin&&__YY__.S("a1146", arguments)) {if(__E){eval(__YY__.gE("a1146"));}else{debugger;}}
        function c(a) {
//a1147<
          if (__begin&&__YY__.S("a1147", arguments)) {if(__E){eval(__YY__.gE("a1147"));}else{debugger;}}
          try {
            var c = "build" + a;
...
//a1148<
          if (__begin&&__YY__.S("a1148", arguments)) {if(__E){eval(__YY__.gE("a1148"));}else{debugger;}}
...
//a1149<
              if (__begin&&__YY__.S("a1149", arguments)) {if(__E){eval(__YY__.gE("a1149"));}else{debugger;}}
              c(f)
            })
          } else c(f)
...
//a1150<
          if (__begin&&__YY__.S("a1150", arguments)) {if(__E){eval(__YY__.gE("a1150"));}else{debugger;}}
...
//a1151<
          if (__begin&&__YY__.S("a1151", arguments)) {if(__E){eval(__YY__.gE("a1151"));}else{debugger;}}
          d.beginHide(3e3)
        }).on("pause paused", function () {
//a1152<
          if (__begin&&__YY__.S("a1152", arguments)) {if(__E){eval(__YY__.gE("a1152"));}else{debugger;}}
          d.beginHide(3e3)
        })))
      }, beginHide: function (a) {
//a1153<
        if (__begin&&__YY__.S("a1153", arguments)) {if(__E){eval(__YY__.gE("a1153"));}else{debugger;}}
        var b = this;
        a = a || 3e3, this.stopHide(), this.hideControlTimer = setTimeout(function () {
//a1154<
          if (__begin&&__YY__.S("a1154", arguments)) {if(__E){eval(__YY__.gE("a1154"));}else{debugger;}}
          b.isTouching || b.hide()
        }, a)
      }, stopHide: function () {
//a1155<
        if (__begin&&__YY__.S("a1155", arguments)) {if(__E){eval(__YY__.gE("a1155"));}else{debugger;}}
        this.hideControlTimer && (clearTimeout(this.hideControlTimer), this.hideControlTimer = 0)
      }, hide: function () {
//a1156<
        if (__begin&&__YY__.S("a1156", arguments)) {if(__E){eval(__YY__.gE("a1156"));}else{debugger;}}
...
//a1157<
        if (__begin&&__YY__.S("a1157", arguments)) {if(__E){eval(__YY__.gE("a1157"));}else{debugger;}}
...
//a1158<
        if (__begin&&__YY__.S("a1158", arguments)) {if(__E){eval(__YY__.gE("a1158"));}else{debugger;}}
        return this.$UILayer.hasClass("tvp_controls_hide")
      }, getDuration: function () {
//a1159<
        if (__begin&&__YY__.S("a1159", arguments)) {if(__E){eval(__YY__.gE("a1159"));}else{debugger;}}
        return this.player.getDuration()
      }, getClickName: function () {
//a1160<
        if (__begin&&__YY__.S("a1160", arguments)) {if(__E){eval(__YY__.gE("a1160"));}else{debugger;}}
        return b.os.hasTouch ? "touchend" : "click"
      }
    }
  }(tvp, tvp.$), function (a, b) {
//a1161<
    if (__begin&&__YY__.S("a1161", arguments)) {if(__E){eval(__YY__.gE("a1161"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildbullet: function (b, c, d, e) {
//a1162<
        if (__begin&&__YY__.S("a1162", arguments)) {if(__E){eval(__YY__.gE("a1162"));}else{debugger;}}
        new a.Html5Bullet(b, c, d, e)
      }
    })
  }(tvp, tvp.$), function (a, b) {
//a1163<
    if (__begin&&__YY__.S("a1163", arguments)) {if(__E){eval(__YY__.gE("a1163"));}else{debugger;}}
    var c = {
      speed: [5, 8],
...
//a1164<
      if (__begin&&__YY__.S("a1164", arguments)) {if(__E){eval(__YY__.gE("a1164"));}else{debugger;}}
      this.player = a, this.$video = b, this.$UILayer = c, this.$videomod = this.player.$videomod, this.init()
    }, a.Html5Bullet.prototype = {
      init: function () {
//a1165<
        if (__begin&&__YY__.S("a1165", arguments)) {if(__E){eval(__YY__.gE("a1165"));}else{debugger;}}
...
//a1166<
          if (__begin&&__YY__.S("a1166", arguments)) {if(__E){eval(__YY__.gE("a1166"));}else{debugger;}}
          d.init_events(), d.init_style(), d.set_top_values(), d.init_switch_status()
        }).fail(function () {
//a1167<
          if (__begin&&__YY__.S("a1167", arguments)) {if(__E){eval(__YY__.gE("a1167"));}else{debugger;}}
        }), this.player.sendMyBullet || (this.player.sendMyBullet = function (a) {
//a1168<
          if (__begin&&__YY__.S("a1168", arguments)) {if(__E){eval(__YY__.gE("a1168"));}else{debugger;}}
      ...
      start: function () {
//a1169<
        if (__begin&&__YY__.S("a1169", arguments)) {if(__E){eval(__YY__.gE("a1169"));}else{debugger;}}
        var a = this;
        this.reset_animate_speed(), this.show(), a.text_list.unshift(c.null_tips), a.add_bullet(), this.text_list.length > 20 || a.request_live_cgi(), this.cgi_timer && clearInterval(this.cgi_timer), this.cgi_timer = setInterval(function () {
//a1170<
          if (__begin&&__YY__.S("a1170", arguments)) {if(__E){eval(__YY__.gE("a1170"));}else{debugger;}}
          a.request_live_cgi()
        }, 1e3 * this.cgi_interval), this.bullet_timer && clearInterval(this.bullet_timer), this.bullet_timer = setInterval(function () {
//a1171<
          if (__begin&&__YY__.S("a1171", arguments)) {if(__E){eval(__YY__.gE("a1171"));}else{debugger;}}
          a.add_bullet()
        }, 1e3 * c.bullet_interval)
      },
      stop: function () {
//a1172<
        if (__begin&&__YY__.S("a1172", arguments)) {if(__E){eval(__YY__.gE("a1172"));}else{debugger;}}
        clearInterval(this.cgi_timer), clearInterval(this.bullet_timer), this.hide(), this.$bullet.empty()
      },
      reset_animate_speed: function () {
//a1173<
        if (__begin&&__YY__.S("a1173", arguments)) {if(__E){eval(__YY__.gE("a1173"));}else{debugger;}}
        var a = this;
        setTimeout(function () {
//a1174<
          if (__begin&&__YY__.S("a1174", arguments)) {if(__E){eval(__YY__.gE("a1174"));}else{debugger;}}
          c.speed[0] = parseInt(a.$bullet.parent().width() / c.one_second_per_px), c.speed[1] = c.speed[0] + 3
        }, 500)
      },
      show: function () {
//a1175<
        if (__begin&&__YY__.S("a1175", arguments)) {if(__E){eval(__YY__.gE("a1175"));}else{debugger;}}
        this.$bullet.removeClass("tvp_none")
      },
      hide: function () {
//a1176<
        if (__begin&&__YY__.S("a1176", arguments)) {if(__E){eval(__YY__.gE("a1176"));}else{debugger;}}
        this.$bullet.addClass("tvp_none")
      },
      check_switch: function () {
//a1177<
        if (__begin&&__YY__.S("a1177", arguments)) {if(__E){eval(__YY__.gE("a1177"));}else{debugger;}}
        var a = this.$switch.hasClass(this.switch_open_cls);
        return a
      },
      check_video: function () {
//a1178<
        if (__begin&&__YY__.S("a1178", arguments)) {if(__E){eval(__YY__.gE("a1178"));}else{debugger;}}
        var a, b = this.$video.get(0);
        return b ? a = b.paused ? !1 : b.ended ? !1 : !0 : !1
      },
      check_switch_pre_status: function () {
//a1179<
        if (__begin&&__YY__.S("a1179", arguments)) {if(__E){eval(__YY__.gE("a1179"));}else{debugger;}}
        var a = b.getData(this.switch_db_key);
        return "1" == a ? !0 : !1
      },
      update_switch_db_status: function (a) {
//a1180<
        if (__begin&&__YY__.S("a1180", arguments)) {if(__E){eval(__YY__.gE("a1180"));}else{debugger;}}
        a = "undefined" == typeof a ? 0 : 1, b.setData(this.switch_db_key, a)
      },
      init_events: function () {
//a1181<
        if (__begin&&__YY__.S("a1181", arguments)) {if(__E){eval(__YY__.gE("a1181"));}else{debugger;}}
        var c = this, d = "click";
        this.$switch.off(d).on(d, function () {
//a1182<
          if (__begin&&__YY__.S("a1182", arguments)) {if(__E){eval(__YY__.gE("a1182"));}else{debugger;}}
          var b = c.check_switch(), d = b ? 0 : 1;
          b ? (c.set_switch_close(), c.stop(), c.update_switch_db_status()) : (c.set_switch_open(), c.check_video() && c.start(), c.update_switch_db_status(1)), a.bossReport.report_bullet_switch({
            user_action: d,
            lid: c.player.curVideo.getChannelId(),
            bulletid: c.bulletId
          })
        });
        var e = function () {
//a1183<
          if (__begin&&__YY__.S("a1183", arguments)) {if(__E){eval(__YY__.gE("a1183"));}else{debugger;}}
          setTimeout(function () {
//a1184<
            if (__begin&&__YY__.S("a1184", arguments)) {if(__E){eval(__YY__.gE("a1184"));}else{debugger;}}
            c.reset_top_values()
          }, 200), c.reset_animate_speed()
        };
        ...
        var f = function () {
//a1185<
          if (__begin&&__YY__.S("a1185", arguments)) {if(__E){eval(__YY__.gE("a1185"));}else{debugger;}}
          c.check_switch() && c.start()
        }, g = function () {
//a1186<
          if (__begin&&__YY__.S("a1186", arguments)) {if(__E){eval(__YY__.gE("a1186"));}else{debugger;}}
          c.stop()
        }, h = function () {
//a1187<
          if (__begin&&__YY__.S("a1187", arguments)) {if(__E){eval(__YY__.gE("a1187"));}else{debugger;}}
          c.stop()
        };
        this.$video.off("playing.tvp_bullet").on("playing.tvp_bullet", f).off("pause.tvp_bullet").on("pause.tvp_bullet", g).off("ended.tvp_bullet").on("ended.tvp_bullet", h)
      },
      init_style: function () {
//a1188<
        if (__begin&&__YY__.S("a1188", arguments)) {if(__E){eval(__YY__.gE("a1188"));}else{debugger;}}
        this.$videomod.css({position: "relative"})
      },
      show_switch: function () {
//a1189<
        if (__begin&&__YY__.S("a1189", arguments)) {if(__E){eval(__YY__.gE("a1189"));}else{debugger;}}
        this.$switch.parent().removeClass("tvp_none")
      },
      hide_switch: function () {
//a1190<
        if (__begin&&__YY__.S("a1190", arguments)) {if(__E){eval(__YY__.gE("a1190"));}else{debugger;}}
        this.$switch.parent().addClass("tvp_none")
      },
      set_switch_open: function () {
//a1191<
        if (__begin&&__YY__.S("a1191", arguments)) {if(__E){eval(__YY__.gE("a1191"));}else{debugger;}}
        this.$switch.addClass(this.switch_open_cls)
      },
      set_switch_close: function () {
//a1192<
        if (__begin&&__YY__.S("a1192", arguments)) {if(__E){eval(__YY__.gE("a1192"));}else{debugger;}}
        this.$switch.removeClass(this.switch_open_cls)
      },
      init_switch_status: function () {
//a1193<
        if (__begin&&__YY__.S("a1193", arguments)) {if(__E){eval(__YY__.gE("a1193"));}else{debugger;}}
        this.check_switch_pre_status() ? this.set_switch_open() : this.set_switch_close()
      },
      add_bullet: function () {
//a1194<
        if (__begin&&__YY__.S("a1194", arguments)) {if(__E){eval(__YY__.gE("a1194"));}else{debugger;}}
        var a = this;
...
//a1195<
        if (__begin&&__YY__.S("a1195", arguments)) {if(__E){eval(__YY__.gE("a1195"));}else{debugger;}}
...
//a1196<
        if (__begin&&__YY__.S("a1196", arguments)) {if(__E){eval(__YY__.gE("a1196"));}else{debugger;}}
        var c = a || b.Deferred(), d = this;
        return this.request_live_cgi().done(function (a) {
//a1197<
          if (__begin&&__YY__.S("a1197", arguments)) {if(__E){eval(__YY__.gE("a1197"));}else{debugger;}}
...
//a1198<
            if (__begin&&__YY__.S("a1198", arguments)) {if(__E){eval(__YY__.gE("a1198"));}else{debugger;}}
...
//a1199<
        if (__begin&&__YY__.S("a1199", arguments)) {if(__E){eval(__YY__.gE("a1199"));}else{debugger;}}
        if (!(this.text_list.length >= c.full_nums)) {
          var a, d = "http://192.168.1.199/live_danmu?callback=?", e = b.Deferred(), f = this;
          "https:" === location.protocol && (d = "https://192.168.1.199/p/mfm.video/live_danmu?callback=?");
...
//a1200<
            if (__begin&&__YY__.S("a1200", arguments)) {if(__E){eval(__YY__.gE("a1200"));}else{debugger;}}
            a && a.loop_interval && (f.cgi_interval = parseInt(a.loop_interval)), a && a.last_stamp && (f.cgi_timestamp = a.last_stamp), a && a.comments && a.comments.length && b(a.comments).each(function (a, c) {
//a1201<
              if (__begin&&__YY__.S("a1201", arguments)) {if(__E){eval(__YY__.gE("a1201"));}else{debugger;}}
      ...
      get_html: function () {
//a1202<
        if (__begin&&__YY__.S("a1202", arguments)) {if(__E){eval(__YY__.gE("a1202"));}else{debugger;}}
        var a = ['<div class="tvp_barrage_layer tvp_none" data-role="tvp-mod-bullet">', "</div>"];
        return a.join("")
      },
      setDomRole: function () {
//a1203<
        if (__begin&&__YY__.S("a1203", arguments)) {if(__E){eval(__YY__.gE("a1203"));}else{debugger;}}
...
//a1204<
        if (__begin&&__YY__.S("a1204", arguments)) {if(__E){eval(__YY__.gE("a1204"));}else{debugger;}}
        this.topValues = {}, this.set_top_values()
      },
      set_top_values: function () {
//a1205<
        if (__begin&&__YY__.S("a1205", arguments)) {if(__E){eval(__YY__.gE("a1205"));}else{debugger;}}
...
//a1206<
        if (__begin&&__YY__.S("a1206", arguments)) {if(__E){eval(__YY__.gE("a1206"));}else{debugger;}}
        var a, b, c, d = [];
...
//a1207<
        if (__begin&&__YY__.S("a1207", arguments)) {if(__E){eval(__YY__.gE("a1207"));}else{debugger;}}
        var a = [], b = [];
...
//a1208<
        if (__begin&&__YY__.S("a1208", arguments)) {if(__E){eval(__YY__.gE("a1208"));}else{debugger;}}
        var a = this.get_topValue_count(), b = a.b.length, d = a.a.length;
        return b >= d * c.filter ? 1 : 0
      },
      insert_bullet: function (a) {
//a1209<
        if (__begin&&__YY__.S("a1209", arguments)) {if(__E){eval(__YY__.gE("a1209"));}else{debugger;}}
        if (a) {
...
//a1210<
            if (__begin&&__YY__.S("a1210", arguments)) {if(__E){eval(__YY__.gE("a1210"));}else{debugger;}}
            f.move_bullet(i, {speed: g, width: d + h})
          }, 10), setTimeout(function () {
//a1211<
            if (__begin&&__YY__.S("a1211", arguments)) {if(__E){eval(__YY__.gE("a1211"));}else{debugger;}}
            i.parentNode && i.parentNode.removeChild(i)
          }, 1e3 * g + 200), setTimeout(function () {
//a1212<
            if (__begin&&__YY__.S("a1212", arguments)) {if(__E){eval(__YY__.gE("a1212"));}else{debugger;}}
...
//a1213<
        if (__begin&&__YY__.S("a1213", arguments)) {if(__E){eval(__YY__.gE("a1213"));}else{debugger;}}
        if (a) {
          var c = a.style;
...
//a1214<
        if (__begin&&__YY__.S("a1214", arguments)) {if(__E){eval(__YY__.gE("a1214"));}else{debugger;}}
...
//a1215<
    if (__begin&&__YY__.S("a1215", arguments)) {if(__E){eval(__YY__.gE("a1215"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildoverlay: function (c, d, e, f) {
//a1216<
        if (__begin&&__YY__.S("a1216", arguments)) {if(__E){eval(__YY__.gE("a1216"));}else{debugger;}}
        var g = d[0], h = {}, i = d.parent().find("video"), j = 2 === i.length ? !0 : !1, k = this, l = "tvp_none", m = !1, n = !1;
        b.each(a.html5skin.elements.overlay, function (a, b) {
//a1217<
          if (__begin&&__YY__.S("a1217", arguments)) {if(__E){eval(__YY__.gE("a1217"));}else{debugger;}}
          h[a] = f.find(b)
        }), c && c.config && c.config.isShortVideo && h.play.addClass("tvp_overlay_play_v2");
        var o = {
          showPlay: function () {
//a1218<
            if (__begin&&__YY__.S("a1218", arguments)) {if(__E){eval(__YY__.gE("a1218"));}else{debugger;}}
            m || h.play.removeClass(l)
          }, showReplay: function () {
//a1219<
            if (__begin&&__YY__.S("a1219", arguments)) {if(__E){eval(__YY__.gE("a1219"));}else{debugger;}}
            h.replay.removeClass(l)
          }, showLoading: function () {
//a1220<
            if (__begin&&__YY__.S("a1220", arguments)) {if(__E){eval(__YY__.gE("a1220"));}else{debugger;}}
            h.loading.removeClass(l)
          }, hidePlay: function () {
//a1221<
            if (__begin&&__YY__.S("a1221", arguments)) {if(__E){eval(__YY__.gE("a1221"));}else{debugger;}}
            h.play.addClass(l)
          }, hideReplay: function () {
//a1222<
            if (__begin&&__YY__.S("a1222", arguments)) {if(__E){eval(__YY__.gE("a1222"));}else{debugger;}}
            h.replay.addClass(l)
          }, hideLoading: function () {
//a1223<
            if (__begin&&__YY__.S("a1223", arguments)) {if(__E){eval(__YY__.gE("a1223"));}else{debugger;}}
            h.loading.addClass(l)
          }
        }, p = function () {
//a1224<
          if (__begin&&__YY__.S("a1224", arguments)) {if(__E){eval(__YY__.gE("a1224"));}else{debugger;}}
          j && "0" === b(this).attr("data-focus") || (o.hideLoading(), o.hidePlay(), o.hideReplay())
        }, q = function () {
//a1225<
          if (__begin&&__YY__.S("a1225", arguments)) {if(__E){eval(__YY__.gE("a1225"));}else{debugger;}}
...
//a1226<
          if (__begin&&__YY__.S("a1226", arguments)) {if(__E){eval(__YY__.gE("a1226"));}else{debugger;}}
          j && "0" === b(this).attr("data-focus") || c.isDefinitionSwitching || (o.showLoading(), o.hidePlay(), o.hideReplay())
        }, s = function () {
//a1227<
          if (__begin&&__YY__.S("a1227", arguments)) {if(__E){eval(__YY__.gE("a1227"));}else{debugger;}}
          j && "0" === b(this).attr("data-focus") || o.hideLoading()
        }, t = function () {
//a1228<
          if (__begin&&__YY__.S("a1228", arguments)) {if(__E){eval(__YY__.gE("a1228"));}else{debugger;}}
          j && "0" === b(this).attr("data-focus") || c.isDefinitionSwitching || (o.hideReplay(), o.hidePlay(), o.showLoading())
        }, u = function () {
//a1229<
          if (__begin&&__YY__.S("a1229", arguments)) {if(__E){eval(__YY__.gE("a1229"));}else{debugger;}}
          o.hideLoading(), o.hidePlay(), o.showReplay()
        }, v = function () {
//a1230<
          if (__begin&&__YY__.S("a1230", arguments)) {if(__E){eval(__YY__.gE("a1230"));}else{debugger;}}
          m = !0
        }, w = function () {
//a1231<
          if (__begin&&__YY__.S("a1231", arguments)) {if(__E){eval(__YY__.gE("a1231"));}else{debugger;}}
          m = !1
        };
...
//a1232<
          if (__begin&&__YY__.S("a1232", arguments)) {if(__E){eval(__YY__.gE("a1232"));}else{debugger;}}
        }).on("canplay", function () {
//a1233<
          if (__begin&&__YY__.S("a1233", arguments)) {if(__E){eval(__YY__.gE("a1233"));}else{debugger;}}
        }).on("playing", p).on("pause", q).on("seeking", r).on("seeked", s).on("tvp_adonend_ended", u), d.on("tvp:overlay:update:filesize", function (a, b) {
//a1234<
          if (__begin&&__YY__.S("a1234", arguments)) {if(__E){eval(__YY__.gE("a1234"));}else{debugger;}}
          b && h.filesize && (b = parseInt(b / 1024), b > 1024 ? b = parseInt(b / 102.4) / 10 + "M" : b += "K", h.filesize.html(b))
        }), b.os.ios ? setTimeout(function () {
//a1235<
          if (__begin&&__YY__.S("a1235", arguments)) {if(__E){eval(__YY__.gE("a1235"));}else{debugger;}}
          d.on("waiting", t)
        }, 50) : b.os.android && d.on("waiting", t);
        var x = function () {
//a1236<
          if (__begin&&__YY__.S("a1236", arguments)) {if(__E){eval(__YY__.gE("a1236"));}else{debugger;}}
          if (c.isPlayingSplit) {
        ...
        var y = function () {
//a1237<
          if (__begin&&__YY__.S("a1237", arguments)) {if(__E){eval(__YY__.gE("a1237"));}else{debugger;}}
          o.hideReplay(), o.hidePlay(), o.showLoading(), c.seekVideoIndex(1, 0)
        }, z = function () {
//a1238<
          if (__begin&&__YY__.S("a1238", arguments)) {if(__E){eval(__YY__.gE("a1238"));}else{debugger;}}
...
//a1239<
    if (__begin&&__YY__.S("a1239", arguments)) {if(__E){eval(__YY__.gE("a1239"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildtips: function (c, d, e, f) {
//a1240<
        if (__begin&&__YY__.S("a1240", arguments)) {if(__E){eval(__YY__.gE("a1240"));}else{debugger;}}
        function g(a, c) {
//a1241<
          if (__begin&&__YY__.S("a1241", arguments)) {if(__E){eval(__YY__.gE("a1241"));}else{debugger;}}
          b.isUndefined(c) && (c = 5), h.main.addClass("tvp_show"), h.desc.text(a), 0 != c && setTimeout(function () {
//a1242<
            if (__begin&&__YY__.S("a1242", arguments)) {if(__E){eval(__YY__.gE("a1242"));}else{debugger;}}
...
//a1243<
          if (__begin&&__YY__.S("a1243", arguments)) {if(__E){eval(__YY__.gE("a1243"));}else{debugger;}}
          h[a] = f.find(b)
...
//a1244<
    if (__begin&&__YY__.S("a1244", arguments)) {if(__E){eval(__YY__.gE("a1244"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildtitle: function (c, d, e, f) {
//a1245<
        if (__begin&&__YY__.S("a1245", arguments)) {if(__E){eval(__YY__.gE("a1245"));}else{debugger;}}
        var g = {};
        b.each(a.html5skin.elements.title, function (a, b) {
//a1246<
          if (__begin&&__YY__.S("a1246", arguments)) {if(__E){eval(__YY__.gE("a1246"));}else{debugger;}}
          g[a] = f.find(b)
        }), d.on("tvp:video:ajaxsuc", function () {
//a1247<
          if (__begin&&__YY__.S("a1247", arguments)) {if(__E){eval(__YY__.gE("a1247"));}else{debugger;}}
...
//a1248<
    if (__begin&&__YY__.S("a1248", arguments)) {if(__E){eval(__YY__.gE("a1248"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildmeta: function (c, d, e, f) {
//a1249<
        if (__begin&&__YY__.S("a1249", arguments)) {if(__E){eval(__YY__.gE("a1249"));}else{debugger;}}
        var g = {};
        b.each(a.html5skin.elements.meta, function (a, b) {
//a1250<
          if (__begin&&__YY__.S("a1250", arguments)) {if(__E){eval(__YY__.gE("a1250"));}else{debugger;}}
          g[a] = f.find(b)
        }), g.main.hide(), b.isUndefined(g.main) || 0 == g.main.length || (d.on("durationchange tvp:video:src", function () {
//a1251<
          if (__begin&&__YY__.S("a1251", arguments)) {if(__E){eval(__YY__.gE("a1251"));}else{debugger;}}
...
//a1252<
          if (__begin&&__YY__.S("a1252", arguments)) {if(__E){eval(__YY__.gE("a1252"));}else{debugger;}}
          g.main.hide()
        }))
      }
    })
...
//a1253<
    if (__begin&&__YY__.S("a1253", arguments)) {if(__E){eval(__YY__.gE("a1253"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildplaypause: function (c, d, e, f) {
//a1254<
        if (__begin&&__YY__.S("a1254", arguments)) {if(__E){eval(__YY__.gE("a1254"));}else{debugger;}}
        var g = f.find(a.html5skin.elements.play), h = d[0], i = d.parent().find("video"), j = 2 === i.length ? !0 : !1, k = this, l = !1;
        g.on(b.os.hasTouch && !b.os.Mac ? "touchend" : "click", function () {
//a1255<
          if (__begin&&__YY__.S("a1255", arguments)) {if(__E){eval(__YY__.gE("a1255"));}else{debugger;}}
          if (j) {
...
//a1256<
          if (__begin&&__YY__.S("a1256", arguments)) {if(__E){eval(__YY__.gE("a1256"));}else{debugger;}}
          k.isTouching || g.addClass("tvp_play").removeClass("tvp_pause")
        }).on("play playing", function () {
//a1257<
          if (__begin&&__YY__.S("a1257", arguments)) {if(__E){eval(__YY__.gE("a1257"));}else{debugger;}}
...
//a1258<
    if (__begin&&__YY__.S("a1258", arguments)) {if(__E){eval(__YY__.gE("a1258"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildtimepanel: function (c, d, e) {
//a1259<
        if (__begin&&__YY__.S("a1259", arguments)) {if(__E){eval(__YY__.gE("a1259"));}else{debugger;}}
        var f = {};
        b.each(a.html5skin.elements.timePanel, function (a, b) {
//a1260<
          if (__begin&&__YY__.S("a1260", arguments)) {if(__E){eval(__YY__.gE("a1260"));}else{debugger;}}
          f[a] = e.find(b)
        }), b.isUndefined(f.total) || 0 == f.total.length || d.on("durationchange tvp:video:src", function () {
//a1261<
          if (__begin&&__YY__.S("a1261", arguments)) {if(__E){eval(__YY__.gE("a1261"));}else{debugger;}}
          f.total.text(b.formatSeconds(c.getDuration()))
        }), b.isUndefined(f.cur) || 0 == f.cur.length || d.on("timeupdate", function () {
//a1262<
          if (__begin&&__YY__.S("a1262", arguments)) {if(__E){eval(__YY__.gE("a1262"));}else{debugger;}}
          f.cur.text(b.formatSeconds(this.currentTime))
        }).on("tvp:player:videochange", function () {
//a1263<
          if (__begin&&__YY__.S("a1263", arguments)) {if(__E){eval(__YY__.gE("a1263"));}else{debugger;}}
          f.cur.text(b.formatSeconds(0))
        }), e.bind("tvp:progress:touchstart", function (a, c) {
//a1264<
          if (__begin&&__YY__.S("a1264", arguments)) {if(__E){eval(__YY__.gE("a1264"));}else{debugger;}}
...
//a1265<
    if (__begin&&__YY__.S("a1265", arguments)) {if(__E){eval(__YY__.gE("a1265"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildprogress: function (c, d, e) {
//a1266<
        if (__begin&&__YY__.S("a1266", arguments)) {if(__E){eval(__YY__.gE("a1266"));}else{debugger;}}
        function f() {
//a1267<
          if (__begin&&__YY__.S("a1267", arguments)) {if(__E){eval(__YY__.gE("a1267"));}else{debugger;}}
...
//a1268<
            if (__begin&&__YY__.S("a1268", arguments)) {if(__E){eval(__YY__.gE("a1268"));}else{debugger;}}
...
//a1269<
            if (__begin&&__YY__.S("a1269", arguments)) {if(__E){eval(__YY__.gE("a1269"));}else{debugger;}}
...
//a1270<
            if (__begin&&__YY__.S("a1270", arguments)) {if(__E){eval(__YY__.gE("a1270"));}else{debugger;}}
...
//a1271<
          if (__begin&&__YY__.S("a1271", arguments)) {if(__E){eval(__YY__.gE("a1271"));}else{debugger;}}
          i[a] = e.find(b)
        }), (a.$.browser.qqnews || a.$.browser.kuaibao) && top.location.hostname && (top._jsBridgePageScroll_ = function () {
//a1272<
          if (__begin&&__YY__.S("a1272", arguments)) {if(__E){eval(__YY__.gE("a1272"));}else{debugger;}}
          return g.isTouching ? 0 : 1
        }), f(), d.bind("timeupdate", function (a) {
//a1273<
          if (__begin&&__YY__.S("a1273", arguments)) {if(__E){eval(__YY__.gE("a1273"));}else{debugger;}}
...
//a1274<
          if (__begin&&__YY__.S("a1274", arguments)) {if(__E){eval(__YY__.gE("a1274"));}else{debugger;}}
...
//a1275<
          if (__begin&&__YY__.S("a1275", arguments)) {if(__E){eval(__YY__.gE("a1275"));}else{debugger;}}
          c.isDefinitionSwitching || g.resetProgress()
        }), e.bind("tvp:control:show", function () {
//a1276<
          if (__begin&&__YY__.S("a1276", arguments)) {if(__E){eval(__YY__.gE("a1276"));}else{debugger;}}
          var a = h.currentTime / c.getDuration() * i.total.width();
          g.setProgress(a, i)
        }), b.extend(this, {
          resetProgress: function () {
//a1277<
            if (__begin&&__YY__.S("a1277", arguments)) {if(__E){eval(__YY__.gE("a1277"));}else{debugger;}}
            i.cur.css("width", "0px"), i.loaded.css("width", "0px")
          }
        })
      }, setProgress: function (a, b) {
//a1278<
        if (__begin&&__YY__.S("a1278", arguments)) {if(__E){eval(__YY__.gE("a1278"));}else{debugger;}}
...
//a1279<
    if (__begin&&__YY__.S("a1279", arguments)) {if(__E){eval(__YY__.gE("a1279"));}else{debugger;}}
...
//a1280<
        if (__begin&&__YY__.S("a1280", arguments)) {if(__E){eval(__YY__.gE("a1280"));}else{debugger;}}
        var h = this;
        c = f.find(a.html5skin.elements.fullscreen), c.on("click", function () {
//a1281<
          if (__begin&&__YY__.S("a1281", arguments)) {if(__E){eval(__YY__.gE("a1281"));}else{debugger;}}
...
//a1282<
          if (__begin&&__YY__.S("a1282", arguments)) {if(__E){eval(__YY__.gE("a1282"));}else{debugger;}}
          document.webkitIsFullScreen ? h.enterFullScreen() : h.cancelFullScreen()
        }, !1) : e.bind("webkitendfullscreen ", function () {
//a1283<
          if (__begin&&__YY__.S("a1283", arguments)) {if(__E){eval(__YY__.gE("a1283"));}else{debugger;}}
          h.cancelFullScreen()
        }), b(document).on("keydown", function (a) {
//a1284<
          if (__begin&&__YY__.S("a1284", arguments)) {if(__E){eval(__YY__.gE("a1284"));}else{debugger;}}
          document.webkitIsFullScreen && 27 == a.keyCode && h.cancelFullScreen()
        });
        var i = {
          enterFullScreen: function () {
//a1285<
            if (__begin&&__YY__.S("a1285", arguments)) {if(__E){eval(__YY__.gE("a1285"));}else{debugger;}}
            h.enterFullScreen()
          }, cancelFullScreen: function () {
//a1286<
            if (__begin&&__YY__.S("a1286", arguments)) {if(__E){eval(__YY__.gE("a1286"));}else{debugger;}}
            h.cancelFullScreen()
          }, isFakeFullscreen: function () {
//a1287<
            if (__begin&&__YY__.S("a1287", arguments)) {if(__E){eval(__YY__.gE("a1287"));}else{debugger;}}
...
//a1288<
          if (__begin&&__YY__.S("a1288", arguments)) {if(__E){eval(__YY__.gE("a1288"));}else{debugger;}}
          setTimeout(function () {
//a1289<
            if (__begin&&__YY__.S("a1289", arguments)) {if(__E){eval(__YY__.gE("a1289"));}else{debugger;}}
            e && e[0] && e[0].ended && h.cancelFullScreen()
          }, 100)
        })
      }, fixClassName: function (a) {
//a1290<
        if (__begin&&__YY__.S("a1290", arguments)) {if(__E){eval(__YY__.gE("a1290"));}else{debugger;}}
...
//a1291<
        if (__begin&&__YY__.S("a1291", arguments)) {if(__E){eval(__YY__.gE("a1291"));}else{debugger;}}
...
//a1292<
        if (__begin&&__YY__.S("a1292", arguments)) {if(__E){eval(__YY__.gE("a1292"));}else{debugger;}}
...
//a1293<
        if (__begin&&__YY__.S("a1293", arguments)) {if(__E){eval(__YY__.gE("a1293"));}else{debugger;}}
...
//a1294<
        if (__begin&&__YY__.S("a1294", arguments)) {if(__E){eval(__YY__.gE("a1294"));}else{debugger;}}
...
//a1295<
        if (__begin&&__YY__.S("a1295", arguments)) {if(__E){eval(__YY__.gE("a1295"));}else{debugger;}}
        var a = this, b = a.$video, c = b[0];
        this.fixClassName(0), c.webkitExitFullscreen && c.webkitExitFullscreen()
      }, allCancelFullScreen: function () {
//a1296<
        if (__begin&&__YY__.S("a1296", arguments)) {if(__E){eval(__YY__.gE("a1296"));}else{debugger;}}
        var a = this.player.config.isHtml5UseFakeFullScreen, c = b.os.android || b.os.ios && this.player.config.isiPhoneShowPlaysinline;
        if (a && c)try {
...
//a1297<
        if (__begin&&__YY__.S("a1297", arguments)) {if(__E){eval(__YY__.gE("a1297"));}else{debugger;}}
        var a = this.player.config.isHtml5UseFakeFullScreen, c = b.os.android || b.os.ios && this.player.config.isiPhoneShowPlaysinline, e = top.innerWidth;
        if (a && c)try {
...
//a1298<
        if (__begin&&__YY__.S("a1298", arguments)) {if(__E){eval(__YY__.gE("a1298"));}else{debugger;}}
...
//a1299<
            if (__begin&&__YY__.S("a1299", arguments)) {if(__E){eval(__YY__.gE("a1299"));}else{debugger;}}
...
//a1300<
        if (__begin&&__YY__.S("a1300", arguments)) {if(__E){eval(__YY__.gE("a1300"));}else{debugger;}}
...
//a1301<
        if (__begin&&__YY__.S("a1301", arguments)) {if(__E){eval(__YY__.gE("a1301"));}else{debugger;}}
        var a = this.player, c = this, d = function () {
//a1302<
          if (__begin&&__YY__.S("a1302", arguments)) {if(__E){eval(__YY__.gE("a1302"));}else{debugger;}}
...
//a1303<
            if (__begin&&__YY__.S("a1303", arguments)) {if(__E){eval(__YY__.gE("a1303"));}else{debugger;}}
...
//a1304<
            if (__begin&&__YY__.S("a1304", arguments)) {if(__E){eval(__YY__.gE("a1304"));}else{debugger;}}
            return b.os.ipod ? void d() : void(f.s0 && f.s1 ? d() : c.androidScreenCalc(d))
          }), b(top.document.body).on("touchmove", function (a) {
//a1305<
            if (__begin&&__YY__.S("a1305", arguments)) {if(__E){eval(__YY__.gE("a1305"));}else{debugger;}}
            a.preventDefault()
          }), b(document.body).on("touchmove", function (a) {
//a1306<
            if (__begin&&__YY__.S("a1306", arguments)) {if(__E){eval(__YY__.gE("a1306"));}else{debugger;}}
            a.preventDefault()
          })
        } catch (e) {
        }
...
//a1307<
        if (__begin&&__YY__.S("a1307", arguments)) {if(__E){eval(__YY__.gE("a1307"));}else{debugger;}}
        var c = this;
        a = a || function () {
//a1308<
            if (__begin&&__YY__.S("a1308", arguments)) {if(__E){eval(__YY__.gE("a1308"));}else{debugger;}}
          }, f.times >= 2 || (f.times += 1, f.calcTimer = setInterval(function () {
//a1309<
          if (__begin&&__YY__.S("a1309", arguments)) {if(__E){eval(__YY__.gE("a1309"));}else{debugger;}}
          c.setCalcValue(), f.changeTimes >= 1 && (clearInterval(f.calcTimer), f.calcTimer = null, setTimeout(function () {
//a1310<
            if (__begin&&__YY__.S("a1310", arguments)) {if(__E){eval(__YY__.gE("a1310"));}else{debugger;}}
            c.setCalcValue(), a()
          }, 100))
        }, 50), b.os.iphone && setTimeout(function () {
//a1311<
          if (__begin&&__YY__.S("a1311", arguments)) {if(__E){eval(__YY__.gE("a1311"));}else{debugger;}}
          c.setCalcValue(), a()
        }, 100), setTimeout(function () {
//a1312<
          if (__begin&&__YY__.S("a1312", arguments)) {if(__E){eval(__YY__.gE("a1312"));}else{debugger;}}
          f.calcTimer && clearInterval(f.calcTimer), c.setCalcValue(), a()
        }, 2e3))
      }, setCalcValue: function () {
//a1313<
        if (__begin&&__YY__.S("a1313", arguments)) {if(__E){eval(__YY__.gE("a1313"));}else{debugger;}}
...
//a1314<
        if (__begin&&__YY__.S("a1314", arguments)) {if(__E){eval(__YY__.gE("a1314"));}else{debugger;}}
        try {
...
//a1315<
    if (__begin&&__YY__.S("a1315", arguments)) {if(__E){eval(__YY__.gE("a1315"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildbigben: function (c, d, e, f) {
//a1316<
        if (__begin&&__YY__.S("a1316", arguments)) {if(__E){eval(__YY__.gE("a1316"));}else{debugger;}}
        var g = {}, h = 0;
        b.each(a.html5skin.elements.bigben, function (a, b) {
//a1317<
          if (__begin&&__YY__.S("a1317", arguments)) {if(__E){eval(__YY__.gE("a1317"));}else{debugger;}}
          g[a] = f.find(b)
        }), e.on("tvp:progress:touchstart", function (a, d) {
//a1318<
          if (__begin&&__YY__.S("a1318", arguments)) {if(__E){eval(__YY__.gE("a1318"));}else{debugger;}}
...
//a1319<
          if (__begin&&__YY__.S("a1319", arguments)) {if(__E){eval(__YY__.gE("a1319"));}else{debugger;}}
...
//a1320<
    if (__begin&&__YY__.S("a1320", arguments)) {if(__E){eval(__YY__.gE("a1320"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildposterlayer: function (c, d, e, f) {
//a1321<
        if (__begin&&__YY__.S("a1321", arguments)) {if(__E){eval(__YY__.gE("a1321"));}else{debugger;}}
        var g = f.find(a.html5skin.elements.posterlayer.main), h = g.find(a.html5skin.elements.posterlayer.img), i = this, j = function (a) {
//a1322<
          if (__begin&&__YY__.S("a1322", arguments)) {if(__E){eval(__YY__.gE("a1322"));}else{debugger;}}
...
//a1323<
            if (__begin&&__YY__.S("a1323", arguments)) {if(__E){eval(__YY__.gE("a1323"));}else{debugger;}}
            d.trigger("tvp:video:setposter:suc")
          }), h.off("error.tvp_video_showposter").one("error.tvp_video_showposter", function (a, b, c) {
//a1324<
            if (__begin&&__YY__.S("a1324", arguments)) {if(__E){eval(__YY__.gE("a1324"));}else{debugger;}}
            d.trigger("tvp:video:setposter:error")
          }))
        }, k = function () {
//a1325<
          if (__begin&&__YY__.S("a1325", arguments)) {if(__E){eval(__YY__.gE("a1325"));}else{debugger;}}
          c && c.control && c.control.checkIsFullScreen && !c.control.checkIsFullScreen() && g.show(), d.one("play playing", l)
        }, l = function () {
//a1326<
          if (__begin&&__YY__.S("a1326", arguments)) {if(__E){eval(__YY__.gE("a1326"));}else{debugger;}}
          g.hide()
        };
...
//a1327<
          if (__begin&&__YY__.S("a1327", arguments)) {if(__E){eval(__YY__.gE("a1327"));}else{debugger;}}
...
//a1328<
    if (__begin&&__YY__.S("a1328", arguments)) {if(__E){eval(__YY__.gE("a1328"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildshadow: function (a, c, d, e) {
//a1329<
        if (__begin&&__YY__.S("a1329", arguments)) {if(__E){eval(__YY__.gE("a1329"));}else{debugger;}}
        var f = b('<div class="tvp_shadow"></div>').appendTo(e.find(".tvp_video")), g = this;
        a.config.isHtml5ControlAlwaysShow || f.on("click", function (c) {
//a1330<
          if (__begin&&__YY__.S("a1330", arguments)) {if(__E){eval(__YY__.gE("a1330"));}else{debugger;}}
...
//a1331<
    if (__begin&&__YY__.S("a1331", arguments)) {if(__E){eval(__YY__.gE("a1331"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildpromotion: function (c, d, e, f) {
//a1332<
        if (__begin&&__YY__.S("a1332", arguments)) {if(__E){eval(__YY__.gE("a1332"));}else{debugger;}}
        function g(c) {
//a1333<
          if (__begin&&__YY__.S("a1333", arguments)) {if(__E){eval(__YY__.gE("a1333"));}else{debugger;}}
          var d = {
            cmd: 3526, val: c, itype: function () {
//a1334<
              if (__begin&&__YY__.S("a1334", arguments)) {if(__E){eval(__YY__.gE("a1334"));}else{debugger;}}
...
//a1335<
            if (__begin&&__YY__.S("a1335", arguments)) {if(__E){eval(__YY__.gE("a1335"));}else{debugger;}}
            h[a] = f.find(b)
          }), h.link.bind("click", function () {
//a1336<
            if (__begin&&__YY__.S("a1336", arguments)) {if(__E){eval(__YY__.gE("a1336"));}else{debugger;}}
            g(2)
...
//a1337<
    if (__begin&&__YY__.S("a1337", arguments)) {if(__E){eval(__YY__.gE("a1337"));}else{debugger;}}
    function c(c, d, e, f) {
//a1338<
      if (__begin&&__YY__.S("a1338", arguments)) {if(__E){eval(__YY__.gE("a1338"));}else{debugger;}}
      var g = new a.Html5LoaingAd, h = f.find(a.html5skin.elements.loadingAd.main), e = h.find(a.html5skin.elements.loadingAd.control), i = h.find(a.html5skin.elements.loadingAd.countdown), j = h.find(a.html5skin.elements.loadingAd.skip), k = h.find(a.html5skin.elements.loadingAd.more), l = h.find(a.html5skin.elements.loadingAd.adLink);
      d.on("tvp:player:videochange", function () {
//a1339<
        if (__begin&&__YY__.S("a1339", arguments)) {if(__E){eval(__YY__.gE("a1339"));}else{debugger;}}
        c.config.isHtml5ShowLoadingAdOnChange && (d.attr("data-playing-loadingad", "1"), g.getAdData())
      }), d.on("tvp:player:videoreplay", function () {
//a1340<
        if (__begin&&__YY__.S("a1340", arguments)) {if(__E){eval(__YY__.gE("a1340"));}else{debugger;}}
...
//a1341<
        if (__begin&&__YY__.S("a1341", arguments)) {if(__E){eval(__YY__.gE("a1341"));}else{debugger;}}
        a = a || {}, "undefined" === b.type(a.noOrder) && (a.noOrder = !0), h.addClass("tvp_none"), d.attr("data-playing-loadingad", "0");
        var e, f = function () {
//a1342<
          if (__begin&&__YY__.S("a1342", arguments)) {if(__E){eval(__YY__.gE("a1342"));}else{debugger;}}
...
//a1343<
            if (__begin&&__YY__.S("a1343", arguments)) {if(__E){eval(__YY__.gE("a1343"));}else{debugger;}}
            f()
          }, 100)
        };
        setTimeout(function () {
//a1344<
          if (__begin&&__YY__.S("a1344", arguments)) {if(__E){eval(__YY__.gE("a1344"));}else{debugger;}}
          clearTimeout(e)
        }, 6e3), f(), c.callCBEvent("onh5loadingadend"), d.on("tvp:player:videochange", function () {
//a1345<
          if (__begin&&__YY__.S("a1345", arguments)) {if(__E){eval(__YY__.gE("a1345"));}else{debugger;}}
          clearTimeout(e)
        })
      }, g.onStart = function () {
//a1346<
        if (__begin&&__YY__.S("a1346", arguments)) {if(__E){eval(__YY__.gE("a1346"));}else{debugger;}}
...
//a1347<
        if (__begin&&__YY__.S("a1347", arguments)) {if(__E){eval(__YY__.gE("a1347"));}else{debugger;}}
        function h() {
//a1348<
          if (__begin&&__YY__.S("a1348", arguments)) {if(__E){eval(__YY__.gE("a1348"));}else{debugger;}}
...
//a1349<
                if (__begin&&__YY__.S("a1349", arguments)) {if(__E){eval(__YY__.gE("a1349"));}else{debugger;}}
                "function" != typeof a.Html5LoaingAd ? (e.attr("data-playing-loadingad", "0"), e.trigger && e.trigger("tvp:loadingad:ended", d.curVideo.getVid())) : c(d, e, f, g)
              })
            }
            c(d, e, f, g)
          }
...
//a1350<
          if (__begin&&__YY__.S("a1350", arguments)) {if(__E){eval(__YY__.gE("a1350"));}else{debugger;}}
          h()
...
//a1351<
    if (__begin&&__YY__.S("a1351", arguments)) {if(__E){eval(__YY__.gE("a1351"));}else{debugger;}}
    b.extend(a.Html5UI.fn, {
      buildverticalbullet: function (b, c, d, e) {
//a1352<
        if (__begin&&__YY__.S("a1352", arguments)) {if(__E){eval(__YY__.gE("a1352"));}else{debugger;}}
...
//a1353<
    if (__begin&&__YY__.S("a1353", arguments)) {if(__E){eval(__YY__.gE("a1353"));}else{debugger;}}
    function c(a, c, e, f) {
//a1354<
      if (__begin&&__YY__.S("a1354", arguments)) {if(__E){eval(__YY__.gE("a1354"));}else{debugger;}}
    ...
    c.prototype = {
      init: function () {
//a1355<
        if (__begin&&__YY__.S("a1355", arguments)) {if(__E){eval(__YY__.gE("a1355"));}else{debugger;}}
        this.initRole(), this.initEvents()
      },
      initRole: function () {
//a1356<
        if (__begin&&__YY__.S("a1356", arguments)) {if(__E){eval(__YY__.gE("a1356"));}else{debugger;}}
        this.$bullet = this.$UILayer.find('[data-role="tvp_vertical_bullet"]')
      },
      initEvents: function () {
//a1357<
        if (__begin&&__YY__.S("a1357", arguments)) {if(__E){eval(__YY__.gE("a1357"));}else{debugger;}}
        var a = this;
        this.$video.on("playing.v_bullet", function () {
//a1358<
          if (__begin&&__YY__.S("a1358", arguments)) {if(__E){eval(__YY__.gE("a1358"));}else{debugger;}}
...
//a1359<
          if (__begin&&__YY__.S("a1359", arguments)) {if(__E){eval(__YY__.gE("a1359"));}else{debugger;}}
          a.isPlayingAd() || (a.hide(), a.stopMove())
        }), this.$video.on("ended.v_bullet", function () {
//a1360<
          if (__begin&&__YY__.S("a1360", arguments)) {if(__E){eval(__YY__.gE("a1360"));}else{debugger;}}
          a.index = 0, a.needReInit = !0
        })
      },
      initData: function () {
//a1361<
        if (__begin&&__YY__.S("a1361", arguments)) {if(__E){eval(__YY__.gE("a1361"));}else{debugger;}}
        var a = this;
        this.hasInit || (this.hasInit = !0, this.requestData().done(function () {
//a1362<
          if (__begin&&__YY__.S("a1362", arguments)) {if(__E){eval(__YY__.gE("a1362"));}else{debugger;}}
          a.initHTML(), a.isPlayingAd() || (a.show(), a.startMove())
        }).fail(function () {
//a1363<
          if (__begin&&__YY__.S("a1363", arguments)) {if(__E){eval(__YY__.gE("a1363"));}else{debugger;}}
          a.player.dataset && (a.player.dataset.noShortVideoData = !0)
        }))
      },
      initHTML: function () {
//a1364<
        if (__begin&&__YY__.S("a1364", arguments)) {if(__E){eval(__YY__.gE("a1364"));}else{debugger;}}
      ...
      startMove: function () {
//a1365<
        if (__begin&&__YY__.S("a1365", arguments)) {if(__E){eval(__YY__.gE("a1365"));}else{debugger;}}
        var a = this;
        this.stopMove(), !this.data || this.data.length < 1 || (this.timer = setInterval(function () {
//a1366<
          if (__begin&&__YY__.S("a1366", arguments)) {if(__E){eval(__YY__.gE("a1366"));}else{debugger;}}
          a.addNext()
        }, this.config.speed))
      },
      stopMove: function () {
//a1367<
        if (__begin&&__YY__.S("a1367", arguments)) {if(__E){eval(__YY__.gE("a1367"));}else{debugger;}}
        this.timer && clearInterval(this.timer), this.timer = null
      },
      show: function () {
//a1368<
        if (__begin&&__YY__.S("a1368", arguments)) {if(__E){eval(__YY__.gE("a1368"));}else{debugger;}}
        this.$bullet.removeClass("tvp_none")
      },
      hide: function () {
//a1369<
        if (__begin&&__YY__.S("a1369", arguments)) {if(__E){eval(__YY__.gE("a1369"));}else{debugger;}}
        this.$bullet.addClass("tvp_none")
      },
      addNext: function () {
//a1370<
        if (__begin&&__YY__.S("a1370", arguments)) {if(__E){eval(__YY__.gE("a1370"));}else{debugger;}}
        var a = this;
        !this.data || this.data.length < 1 || (this.$bullet.find(".tvp_out").remove(), setTimeout(function () {
//a1371<
          if (__begin&&__YY__.S("a1371", arguments)) {if(__E){eval(__YY__.gE("a1371"));}else{debugger;}}
...
//a1372<
        if (__begin&&__YY__.S("a1372", arguments)) {if(__E){eval(__YY__.gE("a1372"));}else{debugger;}}
        return a && a.length ? b.tmpl(this.htmlStr, {data: a}) : ""
      },
      isPlayingAd: function () {
//a1373<
        if (__begin&&__YY__.S("a1373", arguments)) {if(__E){eval(__YY__.gE("a1373"));}else{debugger;}}
        var a = !1;
...
//a1374<
        if (__begin&&__YY__.S("a1374", arguments)) {if(__E){eval(__YY__.gE("a1374"));}else{debugger;}}
        var a = b.Deferred(), c = this;
        if (this.data && this.data.length > 0)return a.resolve(), a;
        var d = "http://192.168.1.199/fcgi-bin/comment/news_hotlist?vid=" + c.vid;
        "https:" === location.protocol && (d = "https://192.168.1.199/p/bullet.video/fcgi-bin/comment/news_hotlist?vid=" + c.vid);
        var e = b.Ajax || b.ajax;
        return e({
          url: d,
          beforeSend: function (a) {
//a1375<
            if (__begin&&__YY__.S("a1375", arguments)) {if(__E){eval(__YY__.gE("a1375"));}else{debugger;}}
            a.withCredentials = !0
          },
...
//a1376<
          if (__begin&&__YY__.S("a1376", arguments)) {if(__E){eval(__YY__.gE("a1376"));}else{debugger;}}
          try {
...
//a1377<
          if (__begin&&__YY__.S("a1377", arguments)) {if(__E){eval(__YY__.gE("a1377"));}else{debugger;}}
          a.reject()
        }), a
      }
    }, a.VerticalBullet = c
...
//a1378<
    if (__begin&&__YY__.S("a1378", arguments)) {if(__E){eval(__YY__.gE("a1378"));}else{debugger;}}
    var c = "";
    a.MP4Skin = {
      html: function () {
//a1379<
        if (__begin&&__YY__.S("a1379", arguments)) {if(__E){eval(__YY__.gE("a1379"));}else{debugger;}}
...
//a1380<
      if (__begin&&__YY__.S("a1380", arguments)) {if(__E){eval(__YY__.gE("a1380"));}else{debugger;}}
      ...
      write: function (c) {
//a1381<
        if (__begin&&__YY__.S("a1381", arguments)) {if(__E){eval(__YY__.gE("a1381"));}else{debugger;}}
        var d = null, e = this;
        if (d = "object" == b.type(c) && 1 == c.nodeType ? c : a.$.getByID(c)) {
          ...
          g.width(b.formatSize(this.config.width)).height(b.formatSize(this.config.height)), this.$elements = b(f).appendTo(g).css("width", e.config.width).css("height", e.config.height), this.videomod = b.getByID(videoModId), this.$mp4linker = this.$elements.find(".tvp_mp4_link"), this.callCBEvent("onwrite"), this.registerMonitor(), this.play(this.curVideo), this.checkPlayerSize && this.checkPlayerSize()
        }
      }, play: function (d) {
//a1382<
        if (__begin&&__YY__.S("a1382", arguments)) {if(__E){eval(__YY__.gE("a1382"));}else{debugger;}}
        var e = this;
...
//a1383<
          if (__begin&&__YY__.S("a1383", arguments)) {if(__E){eval(__YY__.gE("a1383"));}else{debugger;}}
...
//a1384<
            if (__begin&&__YY__.S("a1384", arguments)) {if(__E){eval(__YY__.gE("a1384"));}else{debugger;}}
            b.preventDefault(), top.location.href = a
          })
        }).fail(function (a, b) {
//a1385<
          if (__begin&&__YY__.S("a1385", arguments)) {if(__E){eval(__YY__.gE("a1385"));}else{debugger;}}
          e.showError(a, b), e.$mp4linker.trigger("tvp:mp4:ajaxerror"), e.$mp4linker.trigger("tvp:mp4:error", a, b), e.callCBEvent("onerror", a, b)
        }).always(function () {
//a1386<
          if (__begin&&__YY__.S("a1386", arguments)) {if(__E){eval(__YY__.gE("a1386"));}else{debugger;}}
          c = e.curVideo.lastQueryVid
        })
      }, getPlayerType: function () {
//a1387<
        if (__begin&&__YY__.S("a1387", arguments)) {if(__E){eval(__YY__.gE("a1387"));}else{debugger;}}
        return "mp4"
      }, getDuration: function () {
//a1388<
        if (__begin&&__YY__.S("a1388", arguments)) {if(__E){eval(__YY__.gE("a1388"));}else{debugger;}}
        var a = this.curVideo.getDuration();
        return !isNaN(a) && a > 0 ? a : 0
      }
    }), a.MP4Link.maxId = 0
...
//a1389<
    if (__begin&&__YY__.S("a1389", arguments)) {if(__E){eval(__YY__.gE("a1389"));}else{debugger;}}
    b.extend(a.MP4Link.fn, {
      buildmonitor: function () {
//a1390<
        if (__begin&&__YY__.S("a1390", arguments)) {if(__E){eval(__YY__.gE("a1390"));}else{debugger;}}
        if (!b.isUndefined(a.H5Monitor)) {
          var c = this, d = null;
          this.$mp4linker.on("tvp:mp4:ajaxstart", function (b, e) {
//a1391<
            if (__begin&&__YY__.S("a1391", arguments)) {if(__E){eval(__YY__.gE("a1391"));}else{debugger;}}
            d = null, d = new a.H5Monitor(e, c), d.addStep(1011)
          }).on("tvp:mp4:ajaxsuc", function () {
//a1392<
            if (__begin&&__YY__.S("a1392", arguments)) {if(__E){eval(__YY__.gE("a1392"));}else{debugger;}}
            d.reportStep(1011, {val1: 1, val2: 0})
          }).on("tvp:mp4:src", function () {
//a1393<
            if (__begin&&__YY__.S("a1393", arguments)) {if(__E){eval(__YY__.gE("a1393"));}else{debugger;}}
            d.report(4, 1)
          }).on("click", function () {
//a1394<
            if (__begin&&__YY__.S("a1394", arguments)) {if(__E){eval(__YY__.gE("a1394"));}else{debugger;}}
...
//a1395<
    if (__begin&&__YY__.S("a1395", arguments)) {if(__E){eval(__YY__.gE("a1395"));}else{debugger;}}
    a.BaseFlash = function () {
//a1396<
      if (__begin&&__YY__.S("a1396", arguments)) {if(__E){eval(__YY__.gE("a1396"));}else{debugger;}}
...
//a1397<
        if (__begin&&__YY__.S("a1397", arguments)) {if(__E){eval(__YY__.gE("a1397"));}else{debugger;}}
        return ""
      }, getFlashVarVal: function () {
//a1398<
        if (__begin&&__YY__.S("a1398", arguments)) {if(__E){eval(__YY__.gE("a1398"));}else{debugger;}}
        var a = {}, c = this.config;
        return b.each(this.flashVarsKeyMapToCfg, function (d, e) {
//a1399<
          if (__begin&&__YY__.S("a1399", arguments)) {if(__E){eval(__YY__.gE("a1399"));}else{debugger;}}
          var f = e;
          if (f in c) {
            var g = b.type(c[f]);
...
//a1400<
        if (__begin&&__YY__.S("a1400", arguments)) {if(__E){eval(__YY__.gE("a1400"));}else{debugger;}}
        var c = "";
        if (this.config.type == a.PLAYER_DEFINE.LIVE)b.isString(this.config.liveFlashUrl) && this.config.liveFlashUrl.length > 0 ? c = this.config.liveFlashUrl : (c = this.swfPathRoot + this.config.liveFlashSwfType.replace(/[^\w+]/gi, "") + ".swf", c += "?max_age=86400&v=" + this.config.flashVersionTag || "20140615"); else {
        ...
        if (c = b.filterXSS(c), "undefined" != typeof window.console && b.isFunction(window.console.warn) && c.indexOf("TencentPlayer.swf") > 0 && -1 == b.inArray(document.location.hostname, ["192.168.1.199", "192.168.1.199"])) {
...
//a1401<
        if (__begin&&__YY__.S("a1401", arguments)) {if(__E){eval(__YY__.gE("a1401"));}else{debugger;}}
...
//a1402<
        if (__begin&&__YY__.S("a1402", arguments)) {if(__E){eval(__YY__.gE("a1402"));}else{debugger;}}
        var d = null;
        if ("object" == b.type(c) && 1 == c.nodeType ? (d = c, this.$mod = b("#" + c.id), this.modId = this.$mod.attr("id") || "") : (d = a.$.getByID(c), this.modId = c, this.$mod = b(d)), d) {
          var e = this.getFlashHTML(), f = b.now(), g = this.getFlashSwfUrl(), h = 3544, i = this, j = "mod_" + this.playerid;
          this.on(a.ACTION.onFlashPlayerInited, function () {
//a1403<
            if (__begin&&__YY__.S("a1403", arguments)) {if(__E){eval(__YY__.gE("a1403"));}else{debugger;}}
            a.report({
              cmd: h,
              speed: b.now() - f,
            ...
            str3: i.getPlayerType(),
            str4: g
          }), window.jQuery ? jQuery(d).html('<div id="' + j + '" class="tenvideo_player">' + e + "</div>") : d.innerHTML = '<div id="' + j + '" class="tenvideo_player">' + e + "</div>", this.flashobj = b.browser.ie ? document.getElementById(this.playerid) : document.embeds[this.playerid], this.videomod = b.getByID(j);
          var k = this.config.height + "", l = b.getByID("tvp_flash_install");
          k.indexOf("%") > 0 && l && (l.style.lineHeight = d.offsetHeight)
        }
      }, getPlayer: function () {
//a1404<
        if (__begin&&__YY__.S("a1404", arguments)) {if(__E){eval(__YY__.gE("a1404"));}else{debugger;}}
        return this.flashobj
      }, listenerFlashCrash: function () {
//a1405<
        if (__begin&&__YY__.S("a1405", arguments)) {if(__E){eval(__YY__.gE("a1405"));}else{debugger;}}
        function c() {
//a1406<
          if (__begin&&__YY__.S("a1406", arguments)) {if(__E){eval(__YY__.gE("a1406"));}else{debugger;}}
          if (e) {
            var b = {
              ...
              vurl: document.URL
            }, c = new Image(1, 1), g = "//192.168.1.199/kvcollect?BossId=3353&Pwd=1856399576&_dc=";
            g = "http:" === location.protocol ? "http:" + g : "https:" + g, c.src = g + Math.random() + "&" + a.$.param(b)
          }
        }

        function d() {
//a1407<
          if (__begin&&__YY__.S("a1407", arguments)) {if(__E){eval(__YY__.gE("a1407"));}else{debugger;}}
        ...
        if (!this.timer_flash_crash && this.flashobj && "function" === b.type(this.flashobj.getFPInfo)) {
          var e = this.flashobj.getFPInfo(), f = this;
          this.timer_flash_crash = setInterval(function () {
//a1408<
            if (__begin&&__YY__.S("a1408", arguments)) {if(__E){eval(__YY__.gE("a1408"));}else{debugger;}}
            var a;
            f && f.flashobj && "function" === b.type(f.flashobj.getFPInfo) ? (a = f.flashobj.getFPInfo()) && (e = a) : (clearInterval(f.timer_flash_crash), c())
          }, 15e3)
        }
      }
    })
...
//a1409<
    if (__begin&&__YY__.S("a1409", arguments)) {if(__E){eval(__YY__.gE("a1409"));}else{debugger;}}
    a.FlashLivePlayer = function (c, d) {
//a1410<
      if (__begin&&__YY__.S("a1410", arguments)) {if(__E){eval(__YY__.gE("a1410"));}else{debugger;}}
      ...
      a.BaseFlash.maxId++, this.flashVarsKeyMapToCfg = {
        ...
        autoplay: "autoplay"
      }, this.swfPathRoot = "http://192.168.1.199/minivideo_v1/vd/res/", this.config.width = b.filterXSS(c), this.config.height = b.filterXSS(d), this.loginResponse = function () {
//a1411<
        if (__begin&&__YY__.S("a1411", arguments)) {if(__E){eval(__YY__.gE("a1411"));}else{debugger;}}
...
//a1412<
        if (__begin&&__YY__.S("a1412", arguments)) {if(__E){eval(__YY__.gE("a1412"));}else{debugger;}}
        var c, d, e;
        if (b && a.Player && a.Player.instance) {
          if (c = a.Player.instance[b], !c)return;
          e = 2 === c.config.type ? c.curVideo.getFullVid() : c.curVideo.getChannelId(), d = c.callCBEvent("ongetnextenable", e) ? 1 : 0, c.execFlashMethod("setNextEnable", d), c.trigger(a.ACTION.onFlashPlayerInited), c.callCBEvent("oninited"), c.callCBEvent("onplay", e)
        }
      }, window._flash_play_error = function (b, c) {
//a1413<
        if (__begin&&__YY__.S("a1413", arguments)) {if(__E){eval(__YY__.gE("a1413"));}else{debugger;}}
        var d;
        b && a.Player && a.Player.instance && (d = a.Player.instance[b], d.callCBEvent("onerror", c))
      }
    }, a.FlashLivePlayer.prototype = new a.BaseFlash, b.extend(a.FlashLivePlayer.prototype, {
      getChannelURl: function (a) {
//a1414<
        if (__begin&&__YY__.S("a1414", arguments)) {if(__E){eval(__YY__.gE("a1414"));}else{debugger;}}
        return "http://192.168.1.199:1863/?progid=" + a
      }, getPlayerType: function () {
//a1415<
        if (__begin&&__YY__.S("a1415", arguments)) {if(__E){eval(__YY__.gE("a1415"));}else{debugger;}}
        return "liveflash"
      }, getFlashVar: function () {
//a1416<
        if (__begin&&__YY__.S("a1416", arguments)) {if(__E){eval(__YY__.gE("a1416"));}else{debugger;}}
        var c = "", d = "TenVideo_FlashLive_", e = this.getFlashVarVal(), f = window != top ? document.referrer : document.location.href, g = "";
...
//a1417<
          if (__begin&&__YY__.S("a1417", arguments)) {if(__E){eval(__YY__.gE("a1417"));}else{debugger;}}
...
//a1418<
        if (__begin&&__YY__.S("a1418", arguments)) {if(__E){eval(__YY__.gE("a1418"));}else{debugger;}}
        if (this.flashobj) {
...
//a1419<
        if (__begin&&__YY__.S("a1419", arguments)) {if(__E){eval(__YY__.gE("a1419"));}else{debugger;}}
...
//a1420<
      if (__begin&&__YY__.S("a1420", arguments)) {if(__E){eval(__YY__.gE("a1420"));}else{debugger;}}
      var e;
      d && d.id && a.Player && a.Player.instance && (e = a.Player.instance[d.id] || {}, e.isStartPlay = !0, e.instance && (e.instance.isStartPlay = !0), "function" == typeof e.callCBEvent && e.callCBEvent("onplaying", e.getCurVideo().getChannelId(), d), "function" === b.type(e.listenerFlashCrash) && e.listenerFlashCrash.call(e))
    }, window.toggleFakeFullScreen = function (b) {
//a1421<
      if (__begin&&__YY__.S("a1421", arguments)) {if(__E){eval(__YY__.gE("a1421"));}else{debugger;}}
      var c, d, e;
      return b && b.id && a.Player && a.Player.instance ? (c = a.Player.instance[b.id] || {}, c.playerid ? (d = a.$("#" + c.playerid), d && d.length ? (e = d.parent()[0], b.enter ? (c._cache_flash_style = d[0].style.cssText, c._cache_flash_parent_style = d.parent()[0].style.cssText, d.css({
        width: "100%",
        height: "100%"
      }).parent().css({
        position: "fixed",
      ...
      }), $j("html,body").css({overflow: "hidden"}), c._cache_flash_isfullscreen = !0, "function" === a.$.type(c.onFlashFakeFullScreenChange) && c.onFlashFakeFullScreenChange.call(c, {
        isFull: 1,
        flash: d
      }), !0) : (d[0].style.cssText = c._cache_flash_style, d.parent()[0].style.cssText = c._cache_flash_parent_style, $j("html,body").css({overflow: "auto"}), c._cache_flash_isfullscreen = !1, "function" === a.$.type(c.onFlashFakeFullScreenChange) && c.onFlashFakeFullScreenChange.call(c, {
        isFull: 0,
        flash: d
      }), !0)) : !1) : !1) : !1
    }, window.toggleFakeFullScreen = function (b) {
//a1422<
      if (__begin&&__YY__.S("a1422", arguments)) {if(__E){eval(__YY__.gE("a1422"));}else{debugger;}}
      var c, d, e;
      return b && b.id && a.Player && a.Player.instance ? (c = a.Player.instance[b.id] || {}, c.playerid ? (d = a.$("#" + c.playerid), d && d.length ? (e = d.parent()[0], b.enter ? (c._cache_flash_style = d[0].style.cssText, c._cache_flash_parent_style = d.parent()[0].style.cssText, d.css({
        width: "100%",
        height: "100%"
        ...
        left: 0, width: "100%", height: "100%", "z-index": c.config.flashFakeFullscreenZindex || 9999
      }), $j("html,body").css({overflow: "hidden"}), c._cache_flash_isfullscreen = !0, "function" === a.$.type(c.onFlashFakeFullScreenChange) && c.onFlashFakeFullScreenChange.call(c, {
        isFull: 1,
        flash: d
      }), !0) : (d[0].style.cssText = c._cache_flash_style, d.parent()[0].style.cssText = c._cache_flash_parent_style, $j("html,body").css({overflow: "auto"}), c._cache_flash_isfullscreen = !1, "function" === a.$.type(c.onFlashFakeFullScreenChange) && c.onFlashFakeFullScreenChange.call(c, {
...
//a1423<
      if (__begin&&__YY__.S("a1423", arguments)) {if(__E){eval(__YY__.gE("a1423"));}else{debugger;}}
      return a.livehub.g_curCnlInfo
    }, window.TenVideo_FlashLive_GetTopUrl = function () {
//a1424<
      if (__begin&&__YY__.S("a1424", arguments)) {if(__E){eval(__YY__.gE("a1424"));}else{debugger;}}
      var a = "";
      try {
        a = top.location.href
      } catch (b) {
...
//a1425<
      if (__begin&&__YY__.S("a1425", arguments)) {if(__E){eval(__YY__.gE("a1425"));}else{debugger;}}
      return a.common.getUin() > 1e4
    }, window.TenVideo_FlashLive_OpenLogin = function (b) {
//a1426<
      if (__begin&&__YY__.S("a1426", arguments)) {if(__E){eval(__YY__.gE("a1426"));}else{debugger;}}
      a.FlashLivePlayer.flashloginParam = b || {}, a.common.openLogin()
    }, window.TenVideo_FlashLive_SwitchPlayer = b.noop, window.__flashplayer_getIframeReferrer = function () {
//a1427<
      if (__begin&&__YY__.S("a1427", arguments)) {if(__E){eval(__YY__.gE("a1427"));}else{debugger;}}
      return a.common.getTopFrameUrl ? a.common.getTopFrameUrl() : ""
    }
  }(tvp, tvp.$);
  tvp.$.noop, tvp.$.noop, tvp.$.noop, tvp.$.noop, tvp.$.noop;
  !function (a, b) {
//a1428<
    if (__begin&&__YY__.S("a1428", arguments)) {if(__E){eval(__YY__.gE("a1428"));}else{debugger;}}
    var c = "", d = -1, e = null;
    a.FlashPlayer = function (c, d) {
//a1429<
      if (__begin&&__YY__.S("a1429", arguments)) {if(__E){eval(__YY__.gE("a1429"));}else{debugger;}}
      this.config = b.extend({}, this.config), e = this, this.flashVarsKeyMapToCfg = {
        cid: "coverId",
        tpid: "typeId",
        ...
        autoplay: "autoplay"
      }, this.swfPathRoot = "http://192.168.1.199/tencentvideo_v1/player/", this.swfPathRoot = a.common.get_request_url("swf_root"), a.BaseFlash.maxId++, this.isStartPlay = !1, this.getPlayerType = function () {
//a1430<
        if (__begin&&__YY__.S("a1430", arguments)) {if(__E){eval(__YY__.gE("a1430"));}else{debugger;}}
        return "flash"
      }, this.config.width = a.$.filterXSS(c), this.config.height = a.$.filterXSS(d), window.__flashplayer_ismax = function (a) {
//a1431<
        if (__begin&&__YY__.S("a1431", arguments)) {if(__E){eval(__YY__.gE("a1431"));}else{debugger;}}
        e.callCBEvent("onfullscreen", a)
      }, window.__tenplay_popwin = function () {
//a1432<
        if (__begin&&__YY__.S("a1432", arguments)) {if(__E){eval(__YY__.gE("a1432"));}else{debugger;}}
        a.$.isFunction(e.onflashpopup) && e.callCBEvent("onflashpopup")
      }, window._showPlayer = function () {
//a1433<
        if (__begin&&__YY__.S("a1433", arguments)) {if(__E){eval(__YY__.gE("a1433"));}else{debugger;}}
        e.showPlayer()
      }, window._hidePlayer = function () {
//a1434<
        if (__begin&&__YY__.S("a1434", arguments)) {if(__E){eval(__YY__.gE("a1434"));}else{debugger;}}
        e.hidePlayer()
      }
    }, a.FlashPlayer.fn = a.FlashPlayer.prototype = new a.BaseFlash, b.extend(a.FlashPlayer.fn, {
      play: function (e) {
//a1435<
        if (__begin&&__YY__.S("a1435", arguments)) {if(__E){eval(__YY__.gE("a1435"));}else{debugger;}}
        function f(a) {
//a1436<
          if (__begin&&__YY__.S("a1436", arguments)) {if(__E){eval(__YY__.gE("a1436"));}else{debugger;}}
          var c = {
        ...
        if (this.curVideo.getVidList() != e.getVidList() || 0 == e.getIdx()) {
          var m = f(e);
          0 == this.config.starttips && (m.t = e.getHistoryStart() || 0), "function" == typeof this.flashobj.loadAndPlayVideoV2 && (e && e.getConnectionPlayType && (m.tpnext = e.getConnectionPlayType()), this.flashobj.loadAndPlayVideoV2(m))
...
//a1437<
        if (__begin&&__YY__.S("a1437", arguments)) {if(__E){eval(__YY__.gE("a1437"));}else{debugger;}}
...
//a1438<
        if (__begin&&__YY__.S("a1438", arguments)) {if(__E){eval(__YY__.gE("a1438"));}else{debugger;}}
        var c = "", d = this.getFlashVarVal();
        if (c += "vid=" + this.curVideo.getVidList(), this.curVideo.getTagEnd() - this.curVideo.getTagStart() > 0 && (c += "&attstart=" + a.$.filterXSS(this.curVideo.getTagStart()), c += "&attend=" + a.$.filterXSS(this.curVideo.getTagEnd())), this.curVideo.getDuration() > 0 && (c += "&duration=" + (this.curVideo.getDuration() || "")), this.curVideo.getHistoryStart() > 0 && (c += "&history=" + a.$.filterXSS(this.curVideo.getHistoryStart())), this.curVideo.getTstart() > 0 && (c += "&t=" + a.$.filterXSS(this.curVideo.getTstart())), 0 == this.curVideo.getIdx() && (this.curVideo.getPrefix() > 0 || this.curVideo.getTail() > 0)) {
          var e = this.curVideo.getPrefix(), f = this.curVideo.getEndOffset();
          (e > 0 || f) && (c += "&vstart=" + a.$.filterXSS(e), c += "&vend=" + a.$.filterXSS(f))
        }
        a.$.each(d, function (d, e) {
//a1439<
          if (__begin&&__YY__.S("a1439", arguments)) {if(__E){eval(__YY__.gE("a1439"));}else{debugger;}}
...
//a1445<
      if (__begin&&__YY__.S("a1445", arguments)) {if(__E){eval(__YY__.gE("a1445"));}else{debugger;}}
      var e;
      d && d.id && a.Player && a.Player.instance && (e = a.Player.instance[d.id] || {}, e.isStartPlay = !0, e.instance && (e.instance.isStartPlay = !0), "function" == typeof e.callCBEvent && e.callCBEvent("onplaying", e.getCurVid(), d), "function" === b.type(e.listenerFlashCrash) && e.listenerFlashCrash.call(e))
    }, window.toggleFakeFullScreen = function (b) {
//a1446<
      if (__begin&&__YY__.S("a1446", arguments)) {if(__E){eval(__YY__.gE("a1446"));}else{debugger;}}
      var c, d, e;
      return b && b.id && a.Player && a.Player.instance ? (c = a.Player.instance[b.id] || {}, c.playerid ? (d = a.$("#" + c.playerid), d && d.length ? (e = d.parent()[0], b.enter ? (c._cache_flash_style = d[0].style.cssText, c._cache_flash_parent_style = d.parent()[0].style.cssText, d.css({
        width: "100%",
        height: "100%"
...
//a1447<
      if (__begin&&__YY__.S("a1447", arguments)) {if(__E){eval(__YY__.gE("a1447"));}else{debugger;}}
      var c, d, e;
      if (b && a.Player && a.Player.instance) {
        if (c = a.Player.instance[b], !c)return;
        e = 2 === c.config.type ? c.curVideo.getFullVid() : c.curVideo.getChannelId(), d = c.callCBEvent("ongetnextenable", e) ? 1 : 0, c.execFlashMethod("setNextEnable", d), c.trigger(a.ACTION.onFlashPlayerInited), c.callCBEvent("oninited"), c.callCBEvent("onready"), c.callCBEvent("onplay", e)
      }
    }, window._flash_play_error || (window._flash_play_error = function (b, c) {
//a1448<
      if (__begin&&__YY__.S("a1448", arguments)) {if(__E){eval(__YY__.gE("a1448"));}else{debugger;}}
      var d;
      b && a.Player && a.Player.instance && (d = a.Player.instance[b], d.callCBEvent("onerror", c))
    }), window.attrationstop = window.nextplay = function (b, c) {
//a1449<
      if (__begin&&__YY__.S("a1449", arguments)) {if(__E){eval(__YY__.gE("a1449"));}else{debugger;}}
      var d, e;
      if (c && c.id && a.Player && a.Player.instance)d = a.Player.instance[c.id] || {}; else if (a.Player && a.Player.instance)for (e in a.Player.instance)if (a.Player.instance.hasOwnProperty(e)) {
...
//a1450<
      if (__begin&&__YY__.S("a1450", arguments)) {if(__E){eval(__YY__.gE("a1450"));}else{debugger;}}
      var c;
      if (b && a.Player && a.Player.instance) {
        if (c = a.Player.instance[b], !c)return;
...
//a1451<
      if (__begin&&__YY__.S("a1451", arguments)) {if(__E){eval(__YY__.gE("a1451"));}else{debugger;}}
      return a.common.getTopFrameUrl ? a.common.getTopFrameUrl() : ""
    }
  }(tvp, tvp.$), function (a, b) {
//a1452<
    if (__begin&&__YY__.S("a1452", arguments)) {if(__E){eval(__YY__.gE("a1452"));}else{debugger;}}
    a.livehub = {
      g_flashp2p: !1, iretcode: 0, g_curCnlInfo: {}, stepReport: function (c, d) {
//a1453<
        if (__begin&&__YY__.S("a1453", arguments)) {if(__E){eval(__YY__.gE("a1453"));}else{debugger;}}
...
//a1454<
        if (__begin&&__YY__.S("a1454", arguments)) {if(__E){eval(__YY__.gE("a1454"));}else{debugger;}}
        var d = this;
        ...
        var e = function (b, d) {
//a1455<
          if (__begin&&__YY__.S("a1455", arguments)) {if(__E){eval(__YY__.gE("a1455"));}else{debugger;}}
          d = d || {}, d.config = c, a.livehub.stepReport(b, d)
        };
        this.onSuccess = function (c) {
//a1456<
          if (__begin&&__YY__.S("a1456", arguments)) {if(__E){eval(__YY__.gE("a1456"));}else{debugger;}}
...
//a1457<
          if (__begin&&__YY__.S("a1457", arguments)) {if(__E){eval(__YY__.gE("a1457"));}else{debugger;}}
          if (e(1), a.common.isUseHtml5())return e(2), d.onCanHTML5(d.cnlId), void d.onComplete();
          var c = b.now(), f = "http://192.168.1.199/";
          "https:" === location.protocol && (f = "https://192.168.1.199/p/info.zb/"), b.ajax({
            url: f,
            data: {cmd: 1, cnlid: d.cnlId || ""},
            dataType: "jsonp"
          }).done(function (a, f) {
//a1458<
            if (__begin&&__YY__.S("a1458", arguments)) {if(__E){eval(__YY__.gE("a1458"));}else{debugger;}}
            f = b.now() - c, e(3, {delay: f}), d.onSuccess(a), d.onComplete()
          }).fail(function (a, f) {
//a1459<
            if (__begin&&__YY__.S("a1459", arguments)) {if(__E){eval(__YY__.gE("a1459"));}else{debugger;}}
            f = b.now() - c, e(4, {delay: f}), d.onError(), d.onComplete()
          })
        }
      }, getCurChannelInfo: function (c, d) {
//a1460<
        if (__begin&&__YY__.S("a1460", arguments)) {if(__E){eval(__YY__.gE("a1460"));}else{debugger;}}
...
//a1461<
    if (__begin&&__YY__.S("a1461", arguments)) {if(__E){eval(__YY__.gE("a1461"));}else{debugger;}}
    function c(c, d, e) {
//a1462<
      if (__begin&&__YY__.S("a1462", arguments)) {if(__E){eval(__YY__.gE("a1462"));}else{debugger;}}
    ...
    function e(c, d) {
//a1463<
      if (__begin&&__YY__.S("a1463", arguments)) {if(__E){eval(__YY__.gE("a1463"));}else{debugger;}}
      var e = c + "Defer";
      if (a[e])return a[e];
      var f = b.Deferred();
      a[e] = f;
...
//a1464<
          if (__begin&&__YY__.S("a1464", arguments)) {if(__E){eval(__YY__.gE("a1464"));}else{debugger;}}
          var e = b.now() - l;
    ...
    function f(a) {
//a1465<
      if (__begin&&__YY__.S("a1465", arguments)) {if(__E){eval(__YY__.gE("a1465"));}else{debugger;}}
      return "string" == b.type(a) && /html5|mp4/i.test(a)
    }

    var g = b.now(), h = ["\u672a\u6307\u660e\u64ad\u653e\u5668\u5185\u6838", "\u60a8\u5f53\u524d\u4f7f\u7528\u7684\u7edf\u4e00\u64ad\u653e\u5668JS\u6587\u4ef6\u4e0d\u5305\u542b\u6307\u5b9a\u7684\u64ad\u653e\u5668\u5185\u6838", "video\u672a\u521d\u59cb\u5316"], i = function (c, d) {
//a1466<
      if (__begin&&__YY__.S("a1466", arguments)) {if(__E){eval(__YY__.gE("a1466"));}else{debugger;}}
      function g() {
//a1467<
        if (__begin&&__YY__.S("a1467", arguments)) {if(__E){eval(__YY__.gE("a1467"));}else{debugger;}}
        var a = b.Deferred();
        switch (r.playerType) {
          case"flash":
            t = "FlashPlayer";
      ...
      function h() {
//a1468<
        if (__begin&&__YY__.S("a1468", arguments)) {if(__E){eval(__YY__.gE("a1468"));}else{debugger;}}
        ...
        return a.common.isEnforceMP4() ? void(t = "MP4Link") : e || f || a.$.os.android ? void(a.common.isSupportMP4() || a.common.isInUseH5() ? m() : t = "MP4Link") : a.$.os.Mac && "192.168.1.199" === location.hostname ? void(t = "FlashPlayer") : a.$.os.Mac && (10 > d || !d) && a.common.isSupportMP4() ? void m() : void(t = "FlashPlayer")
      }

      function j(c) {
//a1469<
        if (__begin&&__YY__.S("a1469", arguments)) {if(__E){eval(__YY__.gE("a1469"));}else{debugger;}}
        if (c.getChannelId()) {
...
//a1470<
            if (__begin&&__YY__.S("a1470", arguments)) {if(__E){eval(__YY__.gE("a1470"));}else{debugger;}}
            c.setChannelId(a), c.setIsLookBack(!!b)
          }, e.onCanFlash = function (a) {
//a1471<
            if (__begin&&__YY__.S("a1471", arguments)) {if(__E){eval(__YY__.gE("a1471"));}else{debugger;}}
            t = "FlashLivePlayer"
          }, e.onCanHTML5 = function () {
//a1472<
            if (__begin&&__YY__.S("a1472", arguments)) {if(__E){eval(__YY__.gE("a1472"));}else{debugger;}}
            n()
          }, e.onCanOCX = function () {
//a1473<
            if (__begin&&__YY__.S("a1473", arguments)) {if(__E){eval(__YY__.gE("a1473"));}else{debugger;}}
            t = "OcxPlayer"
          }, e.onError = function (a) {
//a1474<
            if (__begin&&__YY__.S("a1474", arguments)) {if(__E){eval(__YY__.gE("a1474"));}else{debugger;}}
            k(), f = !1
          }, e.onComplete = function () {
//a1475<
            if (__begin&&__YY__.S("a1475", arguments)) {if(__E){eval(__YY__.gE("a1475"));}else{debugger;}}
      ...
      function k() {
//a1476<
        if (__begin&&__YY__.S("a1476", arguments)) {if(__E){eval(__YY__.gE("a1476"));}else{debugger;}}
        a.common.isLiveUseHTML5() ? n() : t = b.os.android ? "FlashLivePlayer" : "OcxPlayer"
      }

      function l() {
//a1477<
        if (__begin&&__YY__.S("a1477", arguments)) {if(__E){eval(__YY__.gE("a1477"));}else{debugger;}}
        switch (r.playerType) {
          case"flash":
            t = "FlashLive";
            break;
      ...
      function m() {
//a1478<
        if (__begin&&__YY__.S("a1478", arguments)) {if(__E){eval(__YY__.gE("a1478"));}else{debugger;}}
        x = !0, t = r.isHtml5UseUI ? "Html5Player" : "Html5Tiny"
      }

      function n() {
//a1479<
        if (__begin&&__YY__.S("a1479", arguments)) {if(__E){eval(__YY__.gE("a1479"));}else{debugger;}}
        t = r.isHtml5UseUI ? "Html5Live" : "Html5LiveTiny"
      }

      function o(a) {
//a1480<
        if (__begin&&__YY__.S("a1480", arguments)) {if(__E){eval(__YY__.gE("a1480"));}else{debugger;}}
      ...
      function p() {
//a1481<
        if (__begin&&__YY__.S("a1481", arguments)) {if(__E){eval(__YY__.gE("a1481"));}else{debugger;}}
        function d() {
//a1482<
          if (__begin&&__YY__.S("a1482", arguments)) {if(__E){eval(__YY__.gE("a1482"));}else{debugger;}}
          if (!g) {
            g = !0;
            var b = new a[t];
...
//a1483<
          if (__begin&&__YY__.S("a1483", arguments)) {if(__E){eval(__YY__.gE("a1483"));}else{debugger;}}
...
//a1484<
          if (__begin&&__YY__.S("a1484", arguments)) {if(__E){eval(__YY__.gE("a1484"));}else{debugger;}}
...
//a1485<
        if (__begin&&__YY__.S("a1485", arguments)) {if(__E){eval(__YY__.gE("a1485"));}else{debugger;}}
        var f = "", g = function (b, d, e) {
//a1486<
          if (__begin&&__YY__.S("a1486", arguments)) {if(__E){eval(__YY__.gE("a1486"));}else{debugger;}}
          a.report({
            cmd: 3531,
            val: b,
            val2: d || 0,
...
//a1487<
          if (__begin&&__YY__.S("a1487", arguments)) {if(__E){eval(__YY__.gE("a1487"));}else{debugger;}}
          p.call(d)
        }) : p.call(d)
      }), q
    }, j = {
...
//a1488<
      if (__begin&&__YY__.S("a1488", arguments)) {if(__E){eval(__YY__.gE("a1488"));}else{debugger;}}
...
//a1489<
        if (__begin&&__YY__.S("a1489", arguments)) {if(__E){eval(__YY__.gE("a1489"));}else{debugger;}}
        this.config[a] = b
      }, output: function (a) {
//a1490<
        if (__begin&&__YY__.S("a1490", arguments)) {if(__E){eval(__YY__.gE("a1490"));}else{debugger;}}
        this.setting("modId", a), this.create(this.config)
      }, create: function (e) {
//a1491<
        if (__begin&&__YY__.S("a1491", arguments)) {if(__E){eval(__YY__.gE("a1491"));}else{debugger;}}
        var f = this;
        ...
        var g = function () {
//a1492<
          if (__begin&&__YY__.S("a1492", arguments)) {if(__E){eval(__YY__.gE("a1492"));}else{debugger;}}
          i(f.config, f).done(function (d, g) {
//a1493<
            if (__begin&&__YY__.S("a1493", arguments)) {if(__E){eval(__YY__.gE("a1493"));}else{debugger;}}
            try {
              c(3, f.sessionId, {
...
//a1494<
              if (__begin&&__YY__.S("a1494", arguments)) {if(__E){eval(__YY__.gE("a1494"));}else{debugger;}}
              b.isString(c) ? (f.config.video.setChannelId(c), c = f.config.video) : c instanceof a.VideoInfo && b.when(i.checkLivePlayer(c)).then(function () {
//a1495<
                if (__begin&&__YY__.S("a1495", arguments)) {if(__E){eval(__YY__.gE("a1495"));}else{debugger;}}
                f.instance instanceof a[g] ? f.instance.play(c) : (e.video = c, i(e))
              })
            }), a.Player.instance[f.playerid] = f
          }).always(function () {
//a1496<
            if (__begin&&__YY__.S("a1496", arguments)) {if(__E){eval(__YY__.gE("a1496"));}else{debugger;}}
            function c(a, c) {
//a1497<
              if (__begin&&__YY__.S("a1497", arguments)) {if(__E){eval(__YY__.gE("a1497"));}else{debugger;}}
              try {
                var d = "build" + a;
...
//a1498<
                if (__begin&&__YY__.S("a1498", arguments)) {if(__E){eval(__YY__.gE("a1498"));}else{debugger;}}
...
//a1499<
                      if (__begin&&__YY__.S("a1499", arguments)) {if(__E){eval(__YY__.gE("a1499"));}else{debugger;}}
                      c(a, g)
                    }))
                  }
                }
...
//a1500<
          if (__begin&&__YY__.S("a1500", arguments)) {if(__E){eval(__YY__.gE("a1500"));}else{debugger;}}
          var c, d = b.Deferred(), e = "//192.168.1.199/iframe/tvp.config.js";
...
//a1501<
            if (__begin&&__YY__.S("a1501", arguments)) {if(__E){eval(__YY__.gE("a1501"));}else{debugger;}}
            return a.config ? void d.resolve() : void d.reject()
          }), c && "function" === b.type(c.fail) && c.fail(function () {
//a1502<
            if (__begin&&__YY__.S("a1502", arguments)) {if(__E){eval(__YY__.gE("a1502"));}else{debugger;}}
            d.reject()
          }), setTimeout(function () {
//a1503<
            if (__begin&&__YY__.S("a1503", arguments)) {if(__E){eval(__YY__.gE("a1503"));}else{debugger;}}
            d.reject()
          }, 4e3), d)
        };
        h().done(function () {
//a1504<
          if (__begin&&__YY__.S("a1504", arguments)) {if(__E){eval(__YY__.gE("a1504"));}else{debugger;}}
          try {
...
//a1505<
          if (__begin&&__YY__.S("a1505", arguments)) {if(__E){eval(__YY__.gE("a1505"));}else{debugger;}}
          g()
        })
      }, addParam: function (c, d) {
//a1506<
        if (__begin&&__YY__.S("a1506", arguments)) {if(__E){eval(__YY__.gE("a1506"));}else{debugger;}}
        a.report({
          cmd: 3546,
          val: 1
...
//a1507<
        if (__begin&&__YY__.S("a1507", arguments)) {if(__E){eval(__YY__.gE("a1507"));}else{debugger;}}
        a.report({cmd: 3546, val: 2}), this.config.video = b, b && b instanceof a.VideoInfo && b.setCurPlayer(this)
      }, write: function (c) {
//a1508<
        if (__begin&&__YY__.S("a1508", arguments)) {if(__E){eval(__YY__.gE("a1508"));}else{debugger;}}
        a.report({cmd: 3546, val: 3}), this.config.modId = c;
        var d = 1 == this._oldcfg.type ? 1 : 2, e = this;
        b.each(this._oldcfg, function (c, f) {
//a1509<
          if (__begin&&__YY__.S("a1509", arguments)) {if(__E){eval(__YY__.gE("a1509"));}else{debugger;}}
  ...
  }(tvp, tvp.$), tvp.Player.instance = {}, function (a, b) {
//a1510<
    if (__begin&&__YY__.S("a1510", arguments)) {if(__E){eval(__YY__.gE("a1510"));}else{debugger;}}
    function c(a) {
//a1511<
      if (__begin&&__YY__.S("a1511", arguments)) {if(__E){eval(__YY__.gE("a1511"));}else{debugger;}}
      var c = a.t ? a.t.curVideo : !1, e = b.extend({lid: c ? c.getChannelId() : "", pageText2: a.text2}, d, a);
    ...
    var d = {
      ...
      appTextName: {weishi: "\u5fae\u89c6\u5ba2\u6237\u7aef", qqlive: "\u817e\u8baf\u89c6\u9891"},
      style: "none",
      isResetWords: !1,
      downloader: !0,
      range: [1, 2],
    ...
    b.extend(c.prototype, {
      init: function (a) {
//a1512<
        if (__begin&&__YY__.S("a1512", arguments)) {if(__E){eval(__YY__.gE("a1512"));}else{debugger;}}
        var c = this;
        this.initDefer = b.Deferred(), this.initStyle(a), this.getAppInfo(a).done(function () {
//a1513<
          if (__begin&&__YY__.S("a1513", arguments)) {if(__E){eval(__YY__.gE("a1513"));}else{debugger;}}
          c.initRoles(a), c.fixTextAndUrl(a)
        }), this.op.t.$video.on("tvp:player:videochange", function () {
//a1514<
          if (__begin&&__YY__.S("a1514", arguments)) {if(__E){eval(__YY__.gE("a1514"));}else{debugger;}}
          a.vid = a.t.curVideo.getVid(), c.fixResult().done(function () {
//a1515<
            if (__begin&&__YY__.S("a1515", arguments)) {if(__E){eval(__YY__.gE("a1515"));}else{debugger;}}
            c.info.hasApp ? c.stepReport(6, a) : (b.os.ios || !b.browser.WeChat && !b.browser.MQQClient) && c.stepReport(1, a)
          })
        })
      }, initStyle: function (a) {
//a1516<
        if (__begin&&__YY__.S("a1516", arguments)) {if(__E){eval(__YY__.gE("a1516"));}else{debugger;}}
        "none" != a.style && b("head").append(a.style)
      }, initRoles: function (a) {
//a1517<
        if (__begin&&__YY__.S("a1517", arguments)) {if(__E){eval(__YY__.gE("a1517"));}else{debugger;}}
        var c = a.modId ? b("#" + a.modId) : a.mod;
        this.$mod = c, this.fixTpl(), this.$box = c, this.$text1 = c.find("[data-role=appbannertext1]"), this.$text2 = c.find("[data-role=appbannertext2]"), this.$btn = c.find("[data-role=appbannerlink]"), this.$btnText = c.find("[data-role=appbannerbtntext]"), this.$progress = c.find("[data-role=appbannerbtnprogress]"), this.$logo = c.find('[data-role="appbanner_logo"]'), this.$btn.attr("data-promotionId", a.promotionId || 140), this.fixStyle(), this.$box.show(), this.op.logo && this.$logo.css({"background-image": "url(" + this.op.logo + ")"})
      }, getAppInfo: function (c) {
//a1518<
        if (__begin&&__YY__.S("a1518", arguments)) {if(__E){eval(__YY__.gE("a1518"));}else{debugger;}}
        function d(d) {
//a1519<
          if (__begin&&__YY__.S("a1519", arguments)) {if(__E){eval(__YY__.gE("a1519"));}else{debugger;}}
          d = d || a.app.config.defaultName;
          var e = a.app.getPackageInfo();
          c = b.extend(c, {appName: d, logoClass: e[d].logoClass, text1: e[d].text1, text2: e[d].text2})
        }

        if (c.loadAppInfoDefer)return c.loadAppInfoDefer;
        var e = b.Deferred();
        return c.loadAppInfoDefer = e, c.pay && c.cid ? (d(c.appName), e.resolve()) : c.appName && c.extraApp ? (d(c.appName), e.resolve()) : c.lid ? (d(c.appName), e.resolve()) : c.vid && (c.appName = "", d(c.appName), e.resolve()), e
      }, fixResult: function () {
//a1520<
        if (__begin&&__YY__.S("a1520", arguments)) {if(__E){eval(__YY__.gE("a1520"));}else{debugger;}}
        var c = this.op, d = this, e = [], f = b.Deferred();
        return this.getAppInfo(c).done(function () {
//a1521<
          if (__begin&&__YY__.S("a1521", arguments)) {if(__E){eval(__YY__.gE("a1521"));}else{debugger;}}
          e[0] = (new Date).getTime(), c.openUrl = null, a.app.check(c).done(function (b) {
//a1522<
            if (__begin&&__YY__.S("a1522", arguments)) {if(__E){eval(__YY__.gE("a1522"));}else{debugger;}}
            e[1] = (new Date).getTime(), d.info = b, d.info.speed = e.length > 1 ? e[1] - e[0] : 0, d.initDefer && d.initDefer.done(function (b) {
//a1523<
              if (__begin&&__YY__.S("a1523", arguments)) {if(__E){eval(__YY__.gE("a1523"));}else{debugger;}}
              var e = {}, g = function () {
//a1524<
                if (__begin&&__YY__.S("a1524", arguments)) {if(__E){eval(__YY__.gE("a1524"));}else{debugger;}}
                d.showtips(), d.bindTap(), f.resolve(), e.rmdword && e.alginfo && e.tab_id && (d.rcmd_show_report = function (b) {
//a1525<
                  if (__begin&&__YY__.S("a1525", arguments)) {if(__E){eval(__YY__.gE("a1525"));}else{debugger;}}
                  d.rcmd_show_report_done || (d.rcmd_show_report_done = !0, a.bossReport.rcmdTextReport(1, e.tab_id, e.alginfo, b))
                }), d.$text2 && 0 !== d.$text2.length || d.rcmd_show_report && d.rcmd_show_report(2)
              };
              if (c.lid)return c.recmdText = d.op.text, void g();
              if (b || d.op.noRecmd)return void g();
              var h = a.common.recomdTextById(c.vid);
              return "object" == typeof h && h.rmdword && "string" == typeof h.rmdword ? (d.op.recmdText = h.rmdword, e = h, void g()) : void(h && h.done && h.done(function () {
//a1526<
                if (__begin&&__YY__.S("a1526", arguments)) {if(__E){eval(__YY__.gE("a1526"));}else{debugger;}}
                var b = a.common.recomdText[c.vid];
                b && b.rmdword && (d.op.recmdText = b.rmdword, e = b), g()
              }))
            })
          })
        }), f
...
//a1527<
        if (__begin&&__YY__.S("a1527", arguments)) {if(__E){eval(__YY__.gE("a1527"));}else{debugger;}}
        var a = this.op;
        ...
        this.$mod.find(".tvp_app_banner").remove(), this.$mod.append(c)
      }, fixStyle: function () {
//a1528<
        if (__begin&&__YY__.S("a1528", arguments)) {if(__E){eval(__YY__.gE("a1528"));}else{debugger;}}
        (b.os.android && window.screen.width > 480 || b.os.iphone && window.screen.width <= 320) && this.$box.addClass("tvp_fixRight"), this.op.appName && this.op.logoClass && this.$box.addClass(this.op.logoClass), 0 === this.$text1.length && this.$mod.width() === window.innerWidth && this.$mod.css({width: this.$btn.width() - 30 + "px"})
      }, report: function (c) {
//a1529<
        if (__begin&&__YY__.S("a1529", arguments)) {if(__E){eval(__YY__.gE("a1529"));}else{debugger;}}
        var d = this, e = this.op, f = e.reportParams ? e.reportParams.int5 : 0, g = {
          cmd: 0 == c ? 3534 : 3535,
          vid: e.vid,
          appId: e.appId,
...
//a1530<
        if (__begin&&__YY__.S("a1530", arguments)) {if(__E){eval(__YY__.gE("a1530"));}else{debugger;}}
        var d = this, e = c.t, f = {vid: e.curVideo.getVid(), appCase: d.info.hasApp ? 3 : 1, reportStep: b};
        f.promotionId = this.getCurPromotionId(c), e.config.reportFrom && e.config.reportFrom.page && (f.xinwenTpl = e.config.reportFrom.page + ""), a.bossReport.appLunchShowClickReport(f)
      }, getCurPromotionId: function (b) {
//a1531<
        if (__begin&&__YY__.S("a1531", arguments)) {if(__E){eval(__YY__.gE("a1531"));}else{debugger;}}
        var c, d = b.t;
        return !c && b.downloadBtn && (c = b.downloadBtn.attr("data-promotionId")), !c && b.downloadUrl && (c = a.$.getUrlParam("confid", b.downloadUrl)), !c && b.promotionId && (c = b.promotionId), !c && d && d.AppBanner && d.AppBanner.op && (c = d.AppBanner.op.promotionId), c || 140
      }, canCheckApp: function () {
//a1532<
        if (__begin&&__YY__.S("a1532", arguments)) {if(__E){eval(__YY__.gE("a1532"));}else{debugger;}}
        var b = a.app.pageType;
        return 1 !== b && 2 !== b ? !1 : top === window || top.location.href ? !0 : !1
      }, showtips: function () {
//a1533<
        if (__begin&&__YY__.S("a1533", arguments)) {if(__E){eval(__YY__.gE("a1533"));}else{debugger;}}
        var c, d, e = this.op, f = this.info;
        f.hasApp > 0 ? e.btnText = e.btnTexts[f.hasApp] : "", e.recmdText && e.btnText.indexOf("\uff0c") > -1 ? e.btnText = e.btnText.split("\uff0c")[0] + "\uff0c" + e.recmdText : e.recmdText && this.$text2 && this.$text2.text(e.recmdText), this.canCheckApp() ? (c = e.btnText, d = e.btnText) : (c = "\u5230", d = this.$text2 && this.$text2.length ? "\u53bbApp\u770b" : e.btnText.replace(/^\u4e0b\u8f7d/, "\u5230")), e.text1 = c + e.text1, this.$text1.text(e.text1), this.$text2 && this.$text2.length ? this.$btnText.text(d) : this.$btnText.attr("data-text", d), b.os.ios || !a.$.browser.WeChat && !a.$.browser.MQQClient ? this.$btn.attr("href", e.downloadPage || f.url) : this.$btn.attr("data-downloadurl", f.url), e.downloadPage && this.$btn.attr("href", e.downloadPage), this.$btn.attr("data-url", f.openUrl), e.isAutoReport && this.report(0), 1 == f.hasApp && this.fixDownloadStatus(5)
      }, rewriteText: function (a) {
//a1534<
        if (__begin&&__YY__.S("a1534", arguments)) {if(__E){eval(__YY__.gE("a1534"));}else{debugger;}}
        var b = this.op, c = a ? b.btnTexts[1] : b.btnTexts[0], d = this.$text1, e = this.$btnText;
        d.html(c + b.text1), e.html(c)
      }, fixDownloadStatus: function (c) {
//a1535<
        if (__begin&&__YY__.S("a1535", arguments)) {if(__E){eval(__YY__.gE("a1535"));}else{debugger;}}
        var e, f = "\u4e0b\u8f7d", g = this.op, h = d.appTextName[g.appName];
        switch (h || (h = d.appTextName[a.app.config.defaultName]), e = "weishi" === g.appName ? "\u53d1\u73b0\u66f4\u591a\u7cbe\u5f69" : g.recmdText ? g.recmdText : "\u89c2\u770b\u66f4\u591a", c) {
          case 1:
            f = "\u4e0b\u8f7d", this.$btn.attr("data-status", "down");
            break;
          case 2:
            f = "\u6b63\u5728\u4e0b\u8f7d", this.$btn.attr("data-status", "downloading"), b.browser.MQQClient && this.$box.addClass("tvp_promote_banner_noauto");
            break;
          case 3:
            f = "\u7ee7\u7eed\u4e0b\u8f7d", this.$btn.attr("data-status", "pause");
            break;
          case 4:
            f = "\u5b89\u88c5", this.$btn.attr("data-status", "install");
            break;
          case 5:
            f = "\u6253\u5f00", this.$btn.attr("data-status", "open"), this.$btn.attr("href", this.$btn.attr("data-url")), this.$progress.css("width", "100%")
        }
        f += h + "\uff0c" + e, c > 1 && this.op.isResetWords ? this.$btnText.attr("data-text", f) : 1 === c && this.$btnText.attr("data-text", this.op.btnText)
      }, bindTap: function () {
//a1536<
        if (__begin&&__YY__.S("a1536", arguments)) {if(__E){eval(__YY__.gE("a1536"));}else{debugger;}}
        function c() {
//a1537<
          if (__begin&&__YY__.S("a1537", arguments)) {if(__E){eval(__YY__.gE("a1537"));}else{debugger;}}
...
//a1538<
            if (__begin&&__YY__.S("a1538", arguments)) {if(__E){eval(__YY__.gE("a1538"));}else{debugger;}}
            d.$btn && b.isFunction(d.$btn.on) && d.$btn.on(c, function () {
//a1539<
              if (__begin&&__YY__.S("a1539", arguments)) {if(__E){eval(__YY__.gE("a1539"));}else{debugger;}}
              e.t.$video && b.isFunction(e.t.$video.trigger) && e.t.$video.trigger(c)
            })
          })
        }

        var d = this, e = this.op;
        this.$btn.on(b.os.hasTouch ? "touchend" : "click", function () {
//a1540<
          if (__begin&&__YY__.S("a1540", arguments)) {if(__E){eval(__YY__.gE("a1540"));}else{debugger;}}
          d.report(1), d.info.hasApp ? d.stepReport(7, e) : b.os.ios && d.stepReport(2, e);
          var c, f = a.common.recomdText[d.op.vid];
          c = d.$text2 && 0 !== d.$text2.length ? 4 : 2, "object" == typeof f && f.rmdword && f.alginfo && f.tab_id && a.bossReport.rcmdTextReport(2, f.tab_id, f.alginfo, c)
        }), 1 != d.info.hasApp && (a.app.bindTryOpenAppBanner && d.op && !d.op.noTryOpenApp && a.app.bindTryOpenAppBanner(d), b.os.android && !e.downloadUrl && (e.downloadUrl = a.app.getDownloadUrl(!1, e.appName)), b.os.android && !e.downloadPage && a.app.getAppMd5(e.promotionId, e.appName).done(function (a) {
//a1541<
          if (__begin&&__YY__.S("a1541", arguments)) {if(__E){eval(__YY__.gE("a1541"));}else{debugger;}}
          a && a.md5 && (e.md5 = a.md5, a.url ? e.downloadUrl = a.url : "", a.url && d.$btn.attr("data-downloadurl", a.url), c())
        }))
      }, checkDoQQliveConfig: function (b) {
//a1542<
        if (__begin&&__YY__.S("a1542", arguments)) {if(__E){eval(__YY__.gE("a1542"));}else{debugger;}}
        var c = [a.APPID.wechatPublic];
        return c.indexOf(b) > -1 ? !0 : !1
      }, fixTextAndUrl: function (c) {
//a1543<
        if (__begin&&__YY__.S("a1543", arguments)) {if(__E){eval(__YY__.gE("a1543"));}else{debugger;}}
        var e = this, f = this.checkDoQQliveConfig(c.appId);
        if (!f)return void e.initDefer.resolve();
        if (c.appName !== a.app.config.defaultName)return void e.initDefer.resolve();
        if (c.lid || !c.vid)return void e.initDefer.resolve();
        var g = "//192.168.1.199/json/tvp/appbanner/index/" + c.vid.substr(0, 1) + ".js";
        g += "?time=" + (new Date).valueOf();
        var h = "//192.168.1.199/json/tvp/appbanner/" + c.vid + ".js";
        h += "?time=" + (new Date).valueOf();
        var i = b.Deferred();
        b.ajax({url: g, dataType: "jsonp", jsonpCallback: "appbannerCallback"}).done(function (a) {
//a1544<
          if (__begin&&__YY__.S("a1544", arguments)) {if(__E){eval(__YY__.gE("a1544"));}else{debugger;}}
          var d = !1;
          b.isArray(a) && a.indexOf && a.indexOf(c.vid) > -1 && (d = !0), i.resolve(d)
        }).fail(function () {
//a1545<
          if (__begin&&__YY__.S("a1545", arguments)) {if(__E){eval(__YY__.gE("a1545"));}else{debugger;}}
          i.resolve(!1)
        }), setTimeout(function () {
//a1546<
          if (__begin&&__YY__.S("a1546", arguments)) {if(__E){eval(__YY__.gE("a1546"));}else{debugger;}}
          i.resolve(!1)
        }, 5e3), i.done(function (f) {
//a1547<
          if (__begin&&__YY__.S("a1547", arguments)) {if(__E){eval(__YY__.gE("a1547"));}else{debugger;}}
...
//a1548<
            if (__begin&&__YY__.S("a1548", arguments)) {if(__E){eval(__YY__.gE("a1548"));}else{debugger;}}
            if (!f)return void e.initDefer.resolve();
            if (e.initDefer.resolve(f.text2), !c.pageText2 && f.text2 && (e.op.text2 = f.text2, e.$text2.html(f.text2)), f.text1 && f.text1.substr(0, 2) !== d.btnTexts[0] && f.text1.substr(0, 2) !== d.btnTexts[1] && (e.op.text1 = f.text1, e.$text1.html(f.text1)), f.type && (!c.pay || !c.cid)) {
              var g = {appName: c.appName, openType: parseInt(f.type)};
              switch (g.openType) {
                case 6:
                  g.cid = f.jumpid, g.vid2 = f.vid2;
                  break;
                case 5:
                  g.openUrl = f.url;
                  break;
                case 4:
                  g.cid = f.jumpid, g.pay = !0;
                  break;
                case 3:
                  g.tid = f.tid;
                  break;
...
//a1549<
                if (__begin&&__YY__.S("a1549", arguments)) {if(__E){eval(__YY__.gE("a1549"));}else{debugger;}}
                g.version = c.version;
                var d = a.app.getOpenUrl(g);
                d && (e.$btn.attr("data-url", d), 1 == c.hasApp ? e.$btn.attr("href", d) : b.os.iphone && g.pay && g.cid && e.$btn.attr("href", d))
              })
            }
...
//a1550<
        if (__begin&&__YY__.S("a1550", arguments)) {if(__E){eval(__YY__.gE("a1550"));}else{debugger;}}
        a.appId = a.appId || a.appid, !a.appId && a.t && a.t.config && (a.appId = a.t.config.appid || a.t.config.appId), a.promotionId = a.promotionId || 140, a.promotionId && (a.openUrl && (a.openUrl = a.openUrl.replace(/from=\d+/, "from=" + a.promotionId)), a.downloadUrl && (a.downloadUrl = a.downloadUrl.replace(/confid=\d+/, "confid=" + a.promotionId)));
        var d = b.Deferred(), e = new c(a);
        return a.t && 1 == a.appBannerType && (a.t.AppBanner = e), e.fixResult().done(function () {
//a1551<
          if (__begin&&__YY__.S("a1551", arguments)) {if(__E){eval(__YY__.gE("a1551"));}else{debugger;}}
          e.info.hasApp ? e.stepReport(6, a) : ((b.os.ios || !b.browser.WeChat && !b.browser.MQQClient || a.downloadPage) && e.stepReport(1, a), b.os.android && b.browser.MQQClient && e.stepReport(1, a)), d.resolve(e)
        }), d
      }
    })
  }(tvp, tvp.$), function (a, b) {
//a1552<
    if (__begin&&__YY__.S("a1552", arguments)) {if(__E){eval(__YY__.gE("a1552"));}else{debugger;}}
    b.extend(a.Player.fn, {
      buildAppBanner: function (c) {
//a1553<
        if (__begin&&__YY__.S("a1553", arguments)) {if(__E){eval(__YY__.gE("a1553"));}else{debugger;}}
        if (!a.$.browser.IEMobile && a.app && a.app.isSupportApp && (!this.config.plugins || !this.config.plugins.AppFollow)) {
          var d = this, e = d.$mod, f = b(d.videomod), g = "mod_down_" + d.playerid;
          d.AppBanner || (e.append('<div id="' + g + '" class="tenvideo_button" data-role="appbannerbox"></div>'), f.bind("tvp:resize", function () {
//a1554<
            if (__begin&&__YY__.S("a1554", arguments)) {if(__E){eval(__YY__.gE("a1554"));}else{debugger;}}
            e.find("#" + g).width(b.formatSize(c.width || d.config.width))
          }), f.trigger && f.trigger("tvp:resize"), c.btnText && (c.noRecmd = !0), c = b.extend(c, {
            t: d,
            appBannerType: 1,
            modId: g,
...
//a1555<
    if (__begin&&__YY__.S("a1555", arguments)) {if(__E){eval(__YY__.gE("a1555"));}else{debugger;}}
    function c(a) {
//a1556<
      if (__begin&&__YY__.S("a1556", arguments)) {if(__E){eval(__YY__.gE("a1556"));}else{debugger;}}
      this.userop = a;
      var c = b.extend({}, d, a);
    ...
    b.extend(c.prototype, {
      init: function (a) {
//a1557<
        if (__begin&&__YY__.S("a1557", arguments)) {if(__E){eval(__YY__.gE("a1557"));}else{debugger;}}
        var c = a.t, d = this;
        this.op = b.extend(a, {
          $mod: c.$UILayer,
          eventType: "pause",
...
//a1558<
          if (__begin&&__YY__.S("a1558", arguments)) {if(__E){eval(__YY__.gE("a1558"));}else{debugger;}}
          d.fillBanner()
        })
      }, fixUI: function () {
//a1559<
        if (__begin&&__YY__.S("a1559", arguments)) {if(__E){eval(__YY__.gE("a1559"));}else{debugger;}}
      }, checkShow: function () {
//a1560<
        if (__begin&&__YY__.S("a1560", arguments)) {if(__E){eval(__YY__.gE("a1560"));}else{debugger;}}
        var b = this.op, c = b.t, d = c.$video, e = d[0], f = parseInt(c.getDuration(), 10), g = parseInt(Math.max(b.currentTime, e.currentTime), 10);
        return a.debug("curTime:" + g), a.debug("duration:" + f), a.debug("op.pausetime:" + b.pausetime), g > b.pausetime && f - g > 5 ? !0 : !1
      }, initEvent: function () {
//a1561<
        if (__begin&&__YY__.S("a1561", arguments)) {if(__E){eval(__YY__.gE("a1561"));}else{debugger;}}
        function c() {
//a1562<
          if (__begin&&__YY__.S("a1562", arguments)) {if(__E){eval(__YY__.gE("a1562"));}else{debugger;}}
          var c = b.os.ios ? 400 : 30;
          setTimeout(function () {
//a1563<
            if (__begin&&__YY__.S("a1563", arguments)) {if(__E){eval(__YY__.gE("a1563"));}else{debugger;}}
            h.paused && d.checkShow() && (d.fixShow(1), a.$.isFunction(d.AppBanner.rcmd_show_report) && d.AppBanner.rcmd_show_report(4));
          }, c)
        }

        var d = this, e = this.op, f = e.t, g = f.$video, h = g[0], i = null;
        this.AppBanner.$btn.on("click", function () {
//a1564<
          if (__begin&&__YY__.S("a1564", arguments)) {if(__E){eval(__YY__.gE("a1564"));}else{debugger;}}
          clearTimeout(i)
        }), g.on("pause paused", function () {
//a1565<
          if (__begin&&__YY__.S("a1565", arguments)) {if(__E){eval(__YY__.gE("a1565"));}else{debugger;}}
          var a = f.instance && f.instance.control && f.instance.control.isTouching;
          a || c()
        }), g.on("timeupdate", function () {
//a1566<
          if (__begin&&__YY__.S("a1566", arguments)) {if(__E){eval(__YY__.gE("a1566"));}else{debugger;}}
          h.currentTime && (e.currentTime = h.currentTime)
        }), g.on("play playing", function () {
//a1567<
          if (__begin&&__YY__.S("a1567", arguments)) {if(__E){eval(__YY__.gE("a1567"));}else{debugger;}}
          clearTimeout(i), d.fixShow(0)
        })
      }, fixShow: function (c) {
//a1568<
        if (__begin&&__YY__.S("a1568", arguments)) {if(__E){eval(__YY__.gE("a1568"));}else{debugger;}}
        a.debug("call fixShow:" + c);
        var d = this, e = this.op, f = e.$mod;
        if ("function" != typeof e.t.hasDurationLimit || !e.t.hasDurationLimit())if (c) {
          if (f.addClass(e.pauseClass), d.AppBanner && d.AppBanner.report(0), b.os.android && this.AppBanner && this.AppBanner.$btn) {
            var g = this.AppBanner.$btn, h = g.attr("href");
            g.attr("href", "javascript:;"), setTimeout(function () {
//a1569<
              if (__begin&&__YY__.S("a1569", arguments)) {if(__E){eval(__YY__.gE("a1569"));}else{debugger;}}
              g.attr("href", h)
            }, 500)
          }
...
//a1570<
        if (__begin&&__YY__.S("a1570", arguments)) {if(__E){eval(__YY__.gE("a1570"));}else{debugger;}}
        var a = b.Deferred();
        return b.loadPluginCss(d.pluginName).done(function () {
//a1571<
          if (__begin&&__YY__.S("a1571", arguments)) {if(__E){eval(__YY__.gE("a1571"));}else{debugger;}}
          a.resolve()
        }), a
      }, getAppBanner: function () {
//a1572<
        if (__begin&&__YY__.S("a1572", arguments)) {if(__E){eval(__YY__.gE("a1572"));}else{debugger;}}
        var a = this.op.t, c = a.config.libpath + a.config.pluginUrl.AppBanner, d = b.Deferred();
        return b.createAppBanner ? d.resolve() : b.getScript(c, function () {
//a1573<
          if (__begin&&__YY__.S("a1573", arguments)) {if(__E){eval(__YY__.gE("a1573"));}else{debugger;}}
          d.resolve()
        }), d
      }, fillBanner: function () {
//a1574<
        if (__begin&&__YY__.S("a1574", arguments)) {if(__E){eval(__YY__.gE("a1574"));}else{debugger;}}
        var a = this, c = this.op, d = b.extend({}, a.userop, {
          style: "none",
          isAutoReport: !1,
          reportParams: {int5: 2},
          t: c.t,
...
//a1575<
          if (__begin&&__YY__.S("a1575", arguments)) {if(__E){eval(__YY__.gE("a1575"));}else{debugger;}}
...
//a1576<
        if (__begin&&__YY__.S("a1576", arguments)) {if(__E){eval(__YY__.gE("a1576"));}else{debugger;}}
        var d = b.Deferred(), e = new c(a);
...
//a1577<
    if (__begin&&__YY__.S("a1577", arguments)) {if(__E){eval(__YY__.gE("a1577"));}else{debugger;}}
    b.extend(a.Player.fn, {
      buildAppBannerOnPause: function (c) {
//a1578<
        if (__begin&&__YY__.S("a1578", arguments)) {if(__E){eval(__YY__.gE("a1578"));}else{debugger;}}
        if (!a.$.browser.IEMobile && !this.flashobj && (!a.app || a.app.isSupportApp) && this.$videomod && this.config.isHtml5UseUI) {
          var d = this, e = b.extend({}, c || {}, {t: d, vid: d.curVideo.getVid(), lid: d.curVideo.getChannelId()});
...
//a1579<
    if (__begin&&__YY__.S("a1579", arguments)) {if(__E){eval(__YY__.gE("a1579"));}else{debugger;}}
    tvp.modeHide = function (b, c) {
//a1580<
      if (__begin&&__YY__.S("a1580", arguments)) {if(__E){eval(__YY__.gE("a1580"));}else{debugger;}}
      function d() {
//a1581<
        if (__begin&&__YY__.S("a1581", arguments)) {if(__E){eval(__YY__.gE("a1581"));}else{debugger;}}
        o.off("click.tvp_mode_hide").on("click.tvp_mode_hide", function () {
//a1582<
          if (__begin&&__YY__.S("a1582", arguments)) {if(__E){eval(__YY__.gE("a1582"));}else{debugger;}}
          var b;
...
//a1583<
              if (__begin&&__YY__.S("a1583", arguments)) {if(__E){eval(__YY__.gE("a1583"));}else{debugger;}}
              m.isend ? (m.isend = !1, n.play()) : i.play(), f(), setTimeout(function () {
//a1584<
                if (__begin&&__YY__.S("a1584", arguments)) {if(__E){eval(__YY__.gE("a1584"));}else{debugger;}}
                i.play()
              }, 100), e()
            }, 5)
          }
      ...
      function e() {
//a1585<
        if (__begin&&__YY__.S("a1585", arguments)) {if(__E){eval(__YY__.gE("a1585"));}else{debugger;}}
        m.isInit || (m.isInit = !0, a(i).on("ended", function () {
//a1586<
          if (__begin&&__YY__.S("a1586", arguments)) {if(__E){eval(__YY__.gE("a1586"));}else{debugger;}}
          n.cancelFullScreen()
        }).on("playing", function () {
//a1587<
          if (__begin&&__YY__.S("a1587", arguments)) {if(__E){eval(__YY__.gE("a1587"));}else{debugger;}}
          document.webkitIsFullScreen || i.webkitDisplayingFullscreen || k
        }).on("webkitendfullscreen", function () {
//a1588<
          if (__begin&&__YY__.S("a1588", arguments)) {if(__E){eval(__YY__.gE("a1588"));}else{debugger;}}
          g()
        }), a(document).on("webkitfullscreenchange fullscreenchange", function () {
//a1589<
          if (__begin&&__YY__.S("a1589", arguments)) {if(__E){eval(__YY__.gE("a1589"));}else{debugger;}}
          g()
        }))
      }
      ...
      function f() {
//a1590<
        if (__begin&&__YY__.S("a1590", arguments)) {if(__E){eval(__YY__.gE("a1590"));}else{debugger;}}
        h() ? n.enterFullScreen() : i.webkitEnterFullscreen()
      }

      function g() {
//a1591<
        if (__begin&&__YY__.S("a1591", arguments)) {if(__E){eval(__YY__.gE("a1591"));}else{debugger;}}
        i && (document.webkitIsFullScreen || i.webkitDisplayingFullscreen || k || n.isFakeFullscreen && n.isFakeFullscreen() || (i.pause(), l.hide()))
      }

      function h() {
//a1592<
        if (__begin&&__YY__.S("a1592", arguments)) {if(__E){eval(__YY__.gE("a1592"));}else{debugger;}}
      ...
      j = {
        ...
        onwrite: function () {
//a1593<
          if (__begin&&__YY__.S("a1593", arguments)) {if(__E){eval(__YY__.gE("a1593"));}else{debugger;}}
          d()
        },
        onfullscreen: function (a) {
//a1594<
          if (__begin&&__YY__.S("a1594", arguments)) {if(__E){eval(__YY__.gE("a1594"));}else{debugger;}}
          a = k, k || g()
        }
      }, a.extend(j, c), c.type = c.type || 2, 1 === c.type ? (j.type = 1, m.setChannelId(c.lid)) : (j.type = 2, m.setVid(c.vid)), n.create(j)
    }
  }(tvp.$), tvp.filename = "tvp.player_v2_mobile.js", "function" == typeof define && define("tvp", [], function () {
//a1595<
    if (__begin&&__YY__.S("a1595", arguments)) {if(__E){eval(__YY__.gE("a1595"));}else{debugger;}}
    return tvp
