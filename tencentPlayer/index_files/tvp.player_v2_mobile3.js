...
//a658<
      ...
      return {getinfo: "//bkh5vv.video.qq.com/getinfo?callback=?&", getkey: "//bkh5vv.video.qq.com/getkey?callback=?&"}
    }(), a.h5Helper = {
...
//a931<
              ...
              var d = "http://live.mobile.video.qq.com/fcgi-bin/live_poll?otype=json&callback=?", f = {
...
//a944<
          ...
          var u = {
            ...
            sbiz: "",
            livepid: t
          }, v = new Image, w = "http://btrace.video.qq.com/kvcollect?BossId=2727&Pwd=1424084450&_dc=" + Math.random();
          w += "&" + b.param(u), v.src = w
        }, isPlayingLoadingAd: function () {
//a945<
...
//a980<
      ...
      var f = b.isFunction(e.getPlayerType) ? e.getPlayerType().toUpperCase() : "", g = "http://rcgi.video.qq.com/report/play?", h = this.getplatform(), i = ["TenPlayer", f, "V2.0"].join(""), j = {
        version: i,
        vid: this.vid,
        rid: this.rid,
        pid: this.pid,
...
//a1406<
          ...
          if (e) {
            var b = {
              ...
              vurl: document.URL
            }, c = new Image(1, 1), g = "//btrace.video.qq.com/kvcollect?BossId=3353&Pwd=1856399576&_dc=";
...
//a1429<
      ...
      this.config = b.extend({}, this.config), e = this, this.flashVarsKeyMapToCfg = {
        ...
        autoplay: "autoplay"
      }, this.swfPathRoot = "http://imgcache.qq.com/tencentvideo_v1/player/", this.swfPathRoot = a.common.get_request_url("swf_root"), a.BaseFlash.maxId++, this.isStartPlay = !1, this.getPlayerType = function () {
//a1430<
...
//a1457<
          ...
          var c = b.now(), f = "http://info.zb.qq.com/";
          "https:" === location.protocol && (f = "https://sec.video.qq.com/p/info.zb/"), b.ajax({
            url: f,
