  ...
  e.ha = function (a) {
    ...
    a.BaseHtml5 || (a.BaseHtml5 = function () {
      ...
      getPlayer: function () {
        ...
        alert(this.config.isHtml5UseUI+','+this.config.isiPhoneShowPlaysinline+'999');
